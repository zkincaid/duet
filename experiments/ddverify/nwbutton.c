...
#line 1 "cdev.o"
#pragma merger("0","/tmp/cil-RjFswfps.i","")
...
#line 1 "char_dev.o"
#pragma merger("0","/tmp/cil-xSCwC0zK.i","")
...
#line 1 "ddverify.o"
#pragma merger("0","/tmp/cil-NgIYYZiO.i","")
...
#line 1 "genhd.o"
#pragma merger("0","/tmp/cil-Mp6A5mmY.i","")
...
#line 1 "interrupt.o"
#pragma merger("0","/tmp/cil-v1EhLcsO.i","")
...
#line 1 "ioctl.o"
#pragma merger("0","/tmp/cil-yJ7VFQ39.i","")
#line 1 "ll_rw_blk.o"
#pragma merger("0","/tmp/cil-bILGHYyi.i","")
...
#line 1 "__main.o"
#pragma merger("0","/tmp/cil-C4fDpi74.i","")
...
#line 29 "nwbutton.c"
wait_queue_head_t button_wait_queue  =    {0, 0, 1};
#line 30 "nwbutton.c"
char button_output_buffer[32]  ;
#line 31 "nwbutton.c"
int bcount  ;
#line 32 "nwbutton.c"
int bdelay  =    30;
#line 33 "nwbutton.c"
struct button_callback button_callback_list[32]  ;
#line 34 "nwbutton.c"
int callback_count  ;
#line 35 "nwbutton.c"
int reboot_count  =    2;
...
#line 63
  callback_count ++;
#line 64
  while (button_callback_list[lp].callback) {
#line 64
    lp ++;
  }
#line 65
...
#line 88
  while (lp >= 0) {
#line 89
    if ((unsigned long )button_callback_list[lp].callback == (unsigned long )callback) {
#line 90
      button_callback_list[lp].callback = (void (*)(void))((void *)0);
#line 91
...
#line 156
  button_timer.expires = jiffies + (unsigned long )bdelay;
#line 157
...
#line 172 "nwbutton.c"
int button_read(struct file *filp , char *buffer , size_t count , loff_t *ppos ) 
{ 
  int tmp___0 ;
...
#line 176
  tmp___1 = copy_to_user((void *)buffer, (void const   *)(& button_output_buffer),
...
#line 186 "nwbutton.c"
struct file_operations  const  button_fops  = 
#line 186
     {(struct module *)0, (loff_t (*)(struct file * , loff_t  , int  ))0, & button_read,
...
#line 197 "nwbutton.c"
struct miscdevice button_misc_device  =    {158, "nwbutton", (struct file_operations *)(& button_fops)};
#line 214
extern int ( /* missing proto */  machine_is_netwinder)() ;
#line 212 "nwbutton.c"
int nwbutton_init(void) 
{ 
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
#line 217
  printk("<6>NetWinder Button Driver Version %s (C) Alex Holden <alex@linuxhacker.org> 1998.\n",
         "0.3");
#line 220
  tmp___0 = misc_register(& button_misc_device);
#line 220
  if (tmp___0) {
#line 221
    printk("<4>nwbutton: Couldn\'t register device 10, %d.\n", 158);
#line 223
    return (-16);
  }
#line 226
  tmp___1 = request_irq(10U, (irqreturn_t (*)(int  , void * , struct pt_regs * ))(& button_handler),
                        32UL, "nwbutton", (void *)0);
#line 226
  if (tmp___1) {
#line 228
    printk("<4>nwbutton: IRQ %d is not free.\n", 10);
#line 230
...
#line 243 "nwbutton.c"
char _ddv_module_author[12]  = 
#line 243
  {      (char )'A',      (char )'l',      (char )'e',      (char )'x', 
        (char )' ',      (char )'H',      (char )'o',      (char )'l', 
        (char )'d',      (char )'e',      (char )'n',      (char )'\000'};
#line 244 "nwbutton.c"
char _ddv_module_license[4]  = {      (char )'G',      (char )'P',      (char )'L',      (char )'\000'};
#line 246 "nwbutton.c"
int (*_ddv_tmp_init)(void)  =    & nwbutton_init;
#line 247 "nwbutton.c"
void (*_ddv_tmp_exit)(void)  =    & nwbutton_exit;
#line 4 "__main.c"
int main(void) 
{ 
...
#line 1 "manage.o"
#pragma merger("0","/tmp/cil-LsAX9uI8.i","")
...
#line 1 "misc.o"
#pragma merger("0","/tmp/cil-jxP4iK6C.i","")
...
#line 1 "mutex.o"
#pragma merger("0","/tmp/cil-71b94AKI.i","")
...
#line 1 "page_alloc.o"
#pragma merger("0","/tmp/cil-kbqTmHAF.i","")
...
#line 1 "pci.o"
#pragma merger("0","/tmp/cil-nNW1fsxu.i","")
...
#line 1 "resource.o"
#pragma merger("0","/tmp/cil-Id3qulvn.i","")
...
#line 1 "sched.o"
#pragma merger("0","/tmp/cil-6C9X8IJG.i","")
...
#line 1 "semaphore.o"
#pragma merger("0","/tmp/cil-dpHtFhzc.i","")
...
#line 1 "slab.o"
#pragma merger("0","/tmp/cil-CmifVEG6.i","")
...
#line 1 "softirq.o"
#pragma merger("0","/tmp/cil-irzycIMU.i","")
...
#line 1 "spinlock.o"
#pragma merger("0","/tmp/cil-EpTP8Q7y.i","")
...
#line 1 "tasklet.o"
#pragma merger("0","/tmp/cil-vGgmnTWb.i","")
...
#line 1 "timer.o"
#pragma merger("0","/tmp/cil-1TkjaD1O.i","")
...
#line 1 "tty_io.o"
#pragma merger("0","/tmp/cil-vCr7lUOi.i","")
...
#line 1 "usercopy.o"
#pragma merger("0","/tmp/cil-8iyO8whJ.i","")
...
#line 1 "vmalloc.o"
#pragma merger("0","/tmp/cil-3Xpv7OBk.i","")
...
#line 1 "wait.o"
#pragma merger("0","/tmp/cil-FmOrZBh0.i","")
...
#line 1 "workqueue.o"
#pragma merger("0","/tmp/cil-JOlRIeBw.i","")
