...
#line 1 "cdev.o"
#pragma merger("0","/tmp/cil-0UFU2Ms2.i","")
...
#line 1 "char_dev.o"
#pragma merger("0","/tmp/cil-o0l1vLG7.i","")
...
#line 1 "ddverify.o"
#pragma merger("0","/tmp/cil-At4iTjz0.i","")
...
#line 1 "genhd.o"
#pragma merger("0","/tmp/cil-ePtEuUVd.i","")
...
#line 1 "interrupt.o"
#pragma merger("0","/tmp/cil-6VJanl9T.i","")
...
#line 1 "ioctl.o"
#pragma merger("0","/tmp/cil-crZJ_ud2.i","")
#line 1 "ll_rw_blk.o"
#pragma merger("0","/tmp/cil-SsB0nxaZ.i","")
...
#line 1 "__main.o"
#pragma merger("0","/tmp/cil-smidehrr.i","")
...
#line 80 "smsc37b787_wdt.c"
static int unit  =    0;
#line 81 "smsc37b787_wdt.c"
static int timeout  =    60;
#line 82 "smsc37b787_wdt.c"
static unsigned long timer_enabled  =    0UL;
#line 84 "smsc37b787_wdt.c"
static char expect_close  ;
#line 86 "smsc37b787_wdt.c"
static spinlock_t io_lock  ;
#line 88 "smsc37b787_wdt.c"
static int nowayout  =    0;
#line 94 "smsc37b787_wdt.c"
...
{ 
  ...
  {
#line 104
  outb((unsigned char)170, 1008U);
#line 105
  return;
}
}
#line 108 "smsc37b787_wdt.c"
...
{ 
  ...
  {
#line 140
  write_io_cr((unsigned char)226, reg);
#line 141
  return;
}
}
#line 143 "smsc37b787_wdt.c"
...
{ 
  ...
  {
#line 152
  write_io_cr((unsigned char)227, reg);
#line 153
  return;
}
}
#line 155 "smsc37b787_wdt.c"
...
{ 
  ...
  {
#line 161
  write_io_cr((unsigned char)241, new_units);
#line 162
  return;
}
}
#line 164 "smsc37b787_wdt.c"
...
{ 
  ...
  {
#line 168
  write_io_cr((unsigned char)242, new_timeout);
#line 169
  return;
}
}
#line 171 "smsc37b787_wdt.c"
...
{ 
  ...
  {
#line 181
  write_io_cr((unsigned char)243, conf);
#line 182
  return;
}
}
#line 184 "smsc37b787_wdt.c"
...
{ 
  ...
  {
#line 203
  write_io_cr((unsigned char)244, reg);
#line 204
  return;
}
}
#line 210 "smsc37b787_wdt.c"
...
#line 232
  old = (unsigned char )((int )tmp & 127);
#line 233
  if (unit == 0) {
#line 233
    old = (unsigned char )((int )old | 128);
  }
#line 236
  wdt_timer_units(old);
#line 238
...
#line 276
  wdt_timer_ctrl((unsigned char )tmp);
#line 279
...
{ 
  ...
  {
#line 314
  wb_smsc_wdt_set_timeout((unsigned char )timeout);
#line 315
  return;
}
}
#line 319 "smsc37b787_wdt.c"
...
#line 323
  select_io_device((unsigned char)8);
#line 326
  wdt_timeout_value((unsigned char )timeout);
#line 327
...
{ 
  ...
  {
#line 349
  tmp = test_and_set_bit(0, & timer_enabled);
#line 349
  if (tmp) {
#line 350
    return (-16);
...
#line 377
  clear_bit(0, (unsigned long volatile   *)(& timer_enabled));
#line 378
  expect_close = (char)0;
#line 379
  return (0);
...
#line 423
static int wb_smsc_wdt_ioctl(struct inode *inode , struct file *file , unsigned int cmd ,
                             unsigned long arg ) ;
#line 423 "smsc37b787_wdt.c"
static struct watchdog_info ident  =    {(__u32 )33152, (__u32 )0, {(__u8 )'S', (__u8 )'M', (__u8 )'s', (__u8 )'C', (__u8 )' ',
                               (__u8 )'3', (__u8 )'7', (__u8 )'B', (__u8 )'7', (__u8 )'8',
                               (__u8 )'7', (__u8 )' ', (__u8 )'W', (__u8 )'a', (__u8 )'t',
                               (__u8 )'c', (__u8 )'h', (__u8 )'d', (__u8 )'o', (__u8 )'g',
                               (__u8 )'\000'}};
#line 413 "smsc37b787_wdt.c"
static int wb_smsc_wdt_ioctl(struct inode *inode , struct file *file , unsigned int cmd ,
                             unsigned long arg ) 
{ 
  int new_timeout ;
...
#line 442
  tmp___2 = wb_smsc_wdt_status();
#line 442
  tmp___3 = put_user(tmp___2, (void *)uarg.i);
#line 442
  return (tmp___3);
  case (unsigned int )((unsigned long )(((2U << 30) | (unsigned int )(87 << 8)) | 2U) | (sizeof(int ) << 16)): 
#line 445
  tmp___4 = put_user(0, (void *)uarg.i);
#line 445
  return (tmp___4);
...
#line 474
  tmp___6 = put_user(new_timeout, (void *)uarg.i);
#line 474
  return (tmp___6);
...
#line 478
  retval = -22;
#line 480
  tmp___7 = get_user(options, (void *)uarg.i);
#line 480
  if (tmp___7) {
#line 481
    return (-14);
...
#line 513
    ...
    & wb_smsc_wdt_open, (int (*)(struct file * ))0, & wb_smsc_wdt_release, (int (*)(struct file * ,
                                                                                    struct dentry * ,
                                                                                    int datasync ))0,
...
#line 523 "smsc37b787_wdt.c"
static struct notifier_block wb_smsc_wdt_notifier  =    {& wb_smsc_wdt_notify_sys, (struct notifier_block *)0, 0};
#line 528 "smsc37b787_wdt.c"
static struct miscdevice wb_smsc_wdt_miscdev  =    {130, "watchdog", & wb_smsc_wdt_fops};
#line 539 "smsc37b787_wdt.c"
...
#line 545
  printk("SMsC 37B787 watchdog component driver 1.1 initialising...\n");
#line 547
  tmp = request_region(1008UL, 2UL, "SMsC 37B787 watchdog");
#line 547
  if (! tmp) {
#line 548
...
#line 609 "smsc37b787_wdt.c"
int (*_ddv_tmp_init)(void)  =    & wb_smsc_wdt_init;
#line 610 "smsc37b787_wdt.c"
void (*_ddv_tmp_exit)(void)  =    & wb_smsc_wdt_exit;
#line 612 "smsc37b787_wdt.c"
char _ddv_module_author[32]  = 
#line 612
  {      (char )'S',      (char )'v',      (char )'e',      (char )'n', 
        (char )' ',      (char )'A',      (char )'n',      (char )'d', 
        (char )'e',      (char )'r',      (char )'s',      (char )' ', 
        (char )'<',      (char )'a',      (char )'n',      (char )'d', 
        (char )'e',      (char )'r',      (char )'s',      (char )'@', 
        (char )'a',      (char )'n',      (char )'d',      (char )'u', 
        (char )'r',      (char )'a',      (char )'s',      (char )'.', 
        (char )'d',      (char )'e',      (char )'>',      (char )'\000'};
#line 613 "smsc37b787_wdt.c"
char _ddv_module_description[56]  = 
#line 613
  {      (char )'D',      (char )'r',      (char )'i',      (char )'v', 
        (char )'e',      (char )'r',      (char )' ',      (char )'f', 
        (char )'o',      (char )'r',      (char )' ',      (char )'S', 
        (char )'M',      (char )'s',      (char )'C',      (char )' ', 
        (char )'3',      (char )'7',      (char )'B',      (char )'7', 
        (char )'8',      (char )'7',      (char )' ',      (char )'w', 
        (char )'a',      (char )'t',      (char )'c',      (char )'h', 
        (char )'d',      (char )'o',      (char )'g',      (char )' ', 
        (char )'c',      (char )'o',      (char )'m',      (char )'p', 
        (char )'o',      (char )'n',      (char )'e',      (char )'n', 
        (char )'t',      (char )' ',      (char )'(',      (char )'V', 
        (char )'e',      (char )'r',      (char )'s',      (char )'i', 
        (char )'o',      (char )'n',      (char )' ',      (char )'1', 
        (char )'.',      (char )'1',      (char )')',      (char )'\000'};
#line 614 "smsc37b787_wdt.c"
char _ddv_module_license[4]  = {      (char )'G',      (char )'P',      (char )'L',      (char )'\000'};
#line 624 "smsc37b787_wdt.c"
char _ddv_module_param_timeout[36]  = 
#line 624
  {      (char )'r',      (char )'a',      (char )'n',      (char )'g', 
        (char )'e',      (char )' ',      (char )'i',      (char )'s', 
        (char )' ',      (char )'1',      (char )'-',      (char )'2', 
        (char )'5',      (char )'5',      (char )' ',      (char )'u', 
        (char )'n',      (char )'i',      (char )'t',      (char )'s', 
        (char )',',      (char )' ',      (char )'d',      (char )'e', 
        (char )'f',      (char )'a',      (char )'u',      (char )'l', 
        (char )'t',      (char )' ',      (char )'i',      (char )'s', 
        (char )' ',      (char )'6',      (char )'0',      (char )'\000'};
#line 627 "smsc37b787_wdt.c"
...
#line 1 "manage.o"
#pragma merger("0","/tmp/cil-pAZev5a1.i","")
...
#line 1 "misc.o"
#pragma merger("0","/tmp/cil-JrimzhOs.i","")
...
#line 1 "mutex.o"
#pragma merger("0","/tmp/cil-0J4ViMcp.i","")
...
#line 1 "page_alloc.o"
#pragma merger("0","/tmp/cil-uz66sMGx.i","")
...
#line 1 "pci.o"
#pragma merger("0","/tmp/cil-YY3pTqgN.i","")
...
#line 1 "resource.o"
#pragma merger("0","/tmp/cil-kkY5fd_c.i","")
...
#line 1 "sched.o"
#pragma merger("0","/tmp/cil-AIB0RCtZ.i","")
...
#line 1 "semaphore.o"
#pragma merger("0","/tmp/cil-mR7IXnk1.i","")
...
#line 1 "slab.o"
#pragma merger("0","/tmp/cil-0OOxY5VS.i","")
...
#line 1 "softirq.o"
#pragma merger("0","/tmp/cil-3vLhzlki.i","")
...
#line 1 "spinlock.o"
#pragma merger("0","/tmp/cil-fZZVhmpN.i","")
...
#line 1 "tasklet.o"
#pragma merger("0","/tmp/cil-fNrz4cXX.i","")
...
#line 1 "timer.o"
#pragma merger("0","/tmp/cil-QlzyO7Rh.i","")
...
#line 1 "tty_io.o"
#pragma merger("0","/tmp/cil-CbD1_36_.i","")
...
#line 1 "usercopy.o"
#pragma merger("0","/tmp/cil-643merxs.i","")
...
#line 1 "vmalloc.o"
#pragma merger("0","/tmp/cil-A83sxL6V.i","")
...
#line 1 "wait.o"
#pragma merger("0","/tmp/cil-wqbEIiCQ.i","")
...
#line 1 "workqueue.o"
#pragma merger("0","/tmp/cil-yJ26Kal_.i","")
