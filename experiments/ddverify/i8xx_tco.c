...
#line 1 "cdev.o"
#pragma merger("0","/tmp/cil-tDg0rTjb.i","")
...
#line 1 "char_dev.o"
#pragma merger("0","/tmp/cil-yVYmJ_b7.i","")
...
#line 1 "ddverify.o"
#pragma merger("0","/tmp/cil-w0LGu2x5.i","")
...
#line 1 "genhd.o"
#pragma merger("0","/tmp/cil-bPfBzS6y.i","")
...
#line 1 "interrupt.o"
#pragma merger("0","/tmp/cil-bVDR8ghq.i","")
...
#line 1 "ioctl.o"
#pragma merger("0","/tmp/cil-snPZEo90.i","")
#line 1 "ll_rw_blk.o"
#pragma merger("0","/tmp/cil-3vGVpGCj.i","")
...
#line 1 "__main.o"
#pragma merger("0","/tmp/cil-43d7Z5fg.i","")
...
#line 104 "/usr/local/ddv/models/con2/include/linux/pci.h"
...
extern int pci_bus_write_config_byte(struct pci_bus *bus , unsigned int devfn , int where ,
                                     u8 val ) ;
#line 111 "/usr/local/ddv/models/con2/include/linux/pci.h"
...
#line 108 "i8xx_tco.c"
char _ddv_module_param_heartbeat[76]  = 
#line 108
...
#line 118 "i8xx_tco.c"
__inline static unsigned char seconds_to_ticks(int seconds ) 
{ 
...
#line 133
  val = (unsigned char )((int )val & 253);
#line 134
  pci_write_config_byte(i8xx_tco_pci, 212, val);
#line 137
  val = inb(((ACPIBASE + 96U) + 8U) + 1U);
#line 138
  val = (unsigned char )((int )val & 247);
#line 139
  outb(val, ((ACPIBASE + 96U) + 8U) + 1U);
#line 140
  val = inb(((ACPIBASE + 96U) + 8U) + 1U);
#line 142
...
#line 174
  spin_lock(& tco_lock);
#line 176
  outb((unsigned char)1, ACPIBASE + 96U);
#line 177
  spin_unlock(& tco_lock);
#line 178
  return (0);
...
#line 193
  spin_lock(& tco_lock);
#line 194
  val = inb((ACPIBASE + 96U) + 1U);
#line 195
  val = (unsigned char )((int )val & 192);
#line 196
  val = (unsigned char )((int )val | (int )tmrval);
#line 197
  outb(val, (ACPIBASE + 96U) + 1U);
#line 198
  val = inb((ACPIBASE + 96U) + 1U);
#line 199
  spin_unlock(& tco_lock);
#line 201
  if (((int )val & 63) != (int )tmrval) {
#line 202
    return (-22);
  }
#line 204
...
#line 212
  spin_lock(& tco_lock);
#line 215
  val = inb(ACPIBASE + 96U);
#line 216
  val = (unsigned char )((int )val & 63);
#line 218
  spin_unlock(& tco_lock);
#line 220
...
#line 259 "i8xx_tco.c"
static ssize_t i8xx_tco_write(struct file *file , char const   *data , size_t len ,
                              loff_t *ppos ) 
{ 
  size_t i ;
  char c ;
...
#line 295
static int i8xx_tco_ioctl(struct inode *inode , struct file *file , unsigned int cmd ,
                          unsigned long arg ) ;
#line 295 "i8xx_tco.c"
static struct watchdog_info ident  =    {(__u32 )33152, (__u32 )0, {(__u8 )'i', (__u8 )'8', (__u8 )'x', (__u8 )'x', (__u8 )' ',
                               (__u8 )'T', (__u8 )'C', (__u8 )'O', (__u8 )' ', (__u8 )'t',
                               (__u8 )'i', (__u8 )'m', (__u8 )'e', (__u8 )'r', (__u8 )'\000'}};
#line 287 "i8xx_tco.c"
static int i8xx_tco_ioctl(struct inode *inode , struct file *file , unsigned int cmd ,
                          unsigned long arg ) 
{ 
...
#line 318
  tmp___3 = get_user(new_options, (void *)p);
#line 318
  if (tmp___3) {
#line 319
    return (-14);
...
#line 337
  tmp___4 = get_user(new_heartbeat, (void *)p);
#line 337
  if (tmp___4) {
#line 338
    return (-14);
...
#line 340
  tmp___5 = tco_timer_set_heartbeat(new_heartbeat);
#line 340
  if (tmp___5) {
#line 341
    return (-22);
...
#line 348
  tmp___6 = put_user(heartbeat, (void *)p);
#line 348
  return (tmp___6);
  case (unsigned int )((unsigned long )(((2U << 30) | (unsigned int )(87 << 8)) | 10U) | (sizeof(int ) << 16)): 
#line 352
  tmp___7 = tco_timer_get_timeleft(& time_left);
#line 352
  if (tmp___7) {
#line 353
    return (-22);
...
#line 355
  tmp___8 = put_user(time_left, (void *)p);
#line 355
  return (tmp___8);
  default: 
#line 359
...
#line 367 "i8xx_tco.c"
static int i8xx_tco_notify_sys(struct notifier_block *this , unsigned long code ,
                               void *unused ) 
{ 
...
#line 390 "i8xx_tco.c"
static struct miscdevice i8xx_tco_miscdev  =    {130, "watchdog", (struct file_operations *)(& i8xx_tco_fops)};
#line 396 "i8xx_tco.c"
static struct notifier_block i8xx_tco_notifier  =    {& i8xx_tco_notify_sys, (struct notifier_block *)0, 0};
#line 408 "i8xx_tco.c"
static struct pci_device_id i8xx_tco_pci_tbl[12]  = 
#line 408
  {      {(__u32 )32902, (__u32 )9232, (__u32 )(~ 0), (__u32 )(~ 0), 0U, 0U, 0UL}, 
        {(__u32 )32902, (__u32 )9248, (__u32 )(~ 0), (__u32 )(~ 0), 0U, 0U, 0UL}, 
        {(__u32 )32902, (__u32 )9280, (__u32 )(~ 0), (__u32 )(~ 0), 0U, 0U, 0UL}, 
        {(__u32 )32902, (__u32 )9292, (__u32 )(~ 0), (__u32 )(~ 0), 0U, 0U, 0UL}, 
        {(__u32 )32902, (__u32 )9344, (__u32 )(~ 0), (__u32 )(~ 0), 0U, 0U, 0UL}, 
        {(__u32 )32902, (__u32 )9356, (__u32 )(~ 0), (__u32 )(~ 0), 0U, 0U, 0UL}, 
        {(__u32 )32902, (__u32 )9408, (__u32 )(~ 0), (__u32 )(~ 0), 0U, 0U, 0UL}, 
        {(__u32 )32902, (__u32 )9420, (__u32 )(~ 0), (__u32 )(~ 0), 0U, 0U, 0UL}, 
        {(__u32 )32902, (__u32 )9296, (__u32 )(~ 0), (__u32 )(~ 0), 0U, 0U, 0UL}, 
        {(__u32 )32902, (__u32 )9424, (__u32 )(~ 0), (__u32 )(~ 0), 0U, 0U, 0UL}, 
        {(__u32 )32902, (__u32 )9633, (__u32 )(~ 0), (__u32 )(~ 0), 0U, 0U, 0UL}, 
        {(__u32 )0, 0U, 0U, 0U, 0U, 0U, 0UL}};
#line 438
extern int ( /* missing proto */  pci_match_id)() ;
#line 437
extern int ( /* missing proto */  pci_get_device)() ;
#line 456
extern int ( /* missing proto */  pci_dev_put)() ;
#line 428 "i8xx_tco.c"
...
#line 437
  while (1) {
#line 437
    tmp___0 = pci_get_device(~ 0, ~ 0, dev);
#line 437
    dev = (struct pci_dev *)tmp___0;
#line 437
...
#line 438
    tmp = pci_match_id(i8xx_tco_pci_tbl, dev);
#line 438
    if (tmp) {
#line 439
      i8xx_tco_pci = dev;
...
#line 451
    badr = (u16 )((((int )val2 << 1) | ((int )val1 >> 7)) << 7);
#line 452
...
#line 474
    pci_write_config_byte(i8xx_tco_pci, 212, val1);
#line 477
    tmp___1 = request_region((unsigned long )((ACPIBASE + 48U) + 1U), 1UL, "i8xx TCO");
#line 477
    if (! tmp___1) {
#line 478
...
#line 483
    val1 = inb((ACPIBASE + 48U) + 1U);
#line 484
    val1 = (u8 )((int )val1 & 223);
#line 485
    outb(val1, (ACPIBASE + 48U) + 1U);
#line 486
    release_region((unsigned long )((ACPIBASE + 48U) + 1U), 1UL);
#line 487
...
#line 499
  tmp = i8xx_tco_getdevice();
#line 499
  if (tmp) {
#line 499
    if ((unsigned long )i8xx_tco_pci == (unsigned long )((void *)0)) {
#line 500
      return (-19);
    }
  } else {
...
#line 502
  tmp___0 = request_region((unsigned long )(ACPIBASE + 96U), 16UL, "i8xx TCO");
#line 502
  if (! tmp___0) {
#line 503
    printk("<3>i8xx TCO timer: I/O address 0x%04x already in use\n", ACPIBASE + 96U);
...
#line 510
  outb((unsigned char)0, (ACPIBASE + 96U) + 4U);
#line 511
  outb((unsigned char)3, (ACPIBASE + 96U) + 6U);
#line 514
  tmp___1 = tco_timer_set_heartbeat(heartbeat);
#line 514
  if (tmp___1) {
#line 515
    heartbeat = 30;
...
#line 537
  printk("<6>i8xx TCO timer: initialized (0x%04x). heartbeat=%d sec (nowayout=%d)\n",
         ACPIBASE + 96U, heartbeat, nowayout);
#line 540
  return (0);
  unreg_notifier: 
#line 543
  ...
  unreg_region: 
#line 545
  release_region((unsigned long )(ACPIBASE + 96U), 16UL);
  out: 
#line 547
  pci_dev_put(i8xx_tco_pci);
#line 548
...
#line 565 "i8xx_tco.c"
int (*_ddv_tmp_init)(void)  =    & watchdog_init;
#line 566 "i8xx_tco.c"
void (*_ddv_tmp_exit)(void)  =    & watchdog_cleanup;
#line 568 "i8xx_tco.c"
char _ddv_module_author[13]  = 
#line 568
  {      (char )'N',      (char )'i',      (char )'l',      (char )'s', 
        (char )' ',      (char )'F',      (char )'a',      (char )'e', 
        (char )'r',      (char )'b',      (char )'e',      (char )'r', 
        (char )'\000'};
#line 569 "i8xx_tco.c"
char _ddv_module_description[35]  = 
#line 569
  {      (char )'T',      (char )'C',      (char )'O',      (char )' ', 
        (char )'t',      (char )'i',      (char )'m',      (char )'e', 
        (char )'r',      (char )' ',      (char )'d',      (char )'r', 
        (char )'i',      (char )'v',      (char )'e',      (char )'r', 
        (char )' ',      (char )'f',      (char )'o',      (char )'r', 
        (char )' ',      (char )'i',      (char )'8',      (char )'x', 
        (char )'x',      (char )' ',      (char )'c',      (char )'h', 
        (char )'i',      (char )'p',      (char )'s',      (char )'e', 
...
#line 1 "manage.o"
#pragma merger("0","/tmp/cil-dC4lX2N6.i","")
...
#line 1 "misc.o"
#pragma merger("0","/tmp/cil-1cmulF5V.i","")
...
#line 1 "mutex.o"
#pragma merger("0","/tmp/cil-YKNbIQQW.i","")
...
#line 1 "page_alloc.o"
#pragma merger("0","/tmp/cil-h9J7fyqg.i","")
...
#line 1 "pci.o"
#pragma merger("0","/tmp/cil-Blq75A_s.i","")
...
#line 1 "resource.o"
#pragma merger("0","/tmp/cil-G8TAQ5Un.i","")
...
#line 1 "sched.o"
#pragma merger("0","/tmp/cil-cbJVDR4b.i","")
...
#line 1 "semaphore.o"
#pragma merger("0","/tmp/cil-0ZmUwSoa.i","")
...
#line 1 "slab.o"
#pragma merger("0","/tmp/cil-xAJI87MC.i","")
...
#line 1 "softirq.o"
#pragma merger("0","/tmp/cil-Z6yZMf3l.i","")
...
#line 1 "spinlock.o"
#pragma merger("0","/tmp/cil-GCcumUtA.i","")
...
#line 1 "tasklet.o"
#pragma merger("0","/tmp/cil-RJ3ya1wo.i","")
...
#line 1 "timer.o"
#pragma merger("0","/tmp/cil-1eDRjgoO.i","")
...
#line 1 "tty_io.o"
#pragma merger("0","/tmp/cil-rXUKzf18.i","")
...
#line 1 "usercopy.o"
#pragma merger("0","/tmp/cil-yGRkGHsQ.i","")
...
#line 1 "vmalloc.o"
#pragma merger("0","/tmp/cil-8BeDOZ_l.i","")
...
#line 1 "wait.o"
#pragma merger("0","/tmp/cil-FEv8YxjZ.i","")
...
#line 1 "workqueue.o"
#pragma merger("0","/tmp/cil-UNTJMXjd.i","")
