...
#line 1 "cdev.o"
#pragma merger("0","/tmp/cil-1Lx01uVP.i","")
...
#line 1 "char_dev.o"
#pragma merger("0","/tmp/cil-zbvswdDY.i","")
...
#line 1 "ddverify.o"
#pragma merger("0","/tmp/cil-SxbIX8Y6.i","")
...
#line 1 "genhd.o"
#pragma merger("0","/tmp/cil-zzIGzdeJ.i","")
...
#line 1 "interrupt.o"
#pragma merger("0","/tmp/cil-9pcwN0wr.i","")
...
#line 1 "ioctl.o"
#pragma merger("0","/tmp/cil-S5jeyeJg.i","")
#line 1 "ll_rw_blk.o"
#pragma merger("0","/tmp/cil-AWZqsalo.i","")
...
#line 1 "__main.o"
#pragma merger("0","/tmp/cil-tPrQ9EjV.i","")
#line 26 "/usr/local/ddv/models/con2/include/linux/timer.h"
void init_timer(struct timer_list *timer___0 ) ;
#line 28
void add_timer(struct timer_list *timer___0 ) ;
#line 29
int del_timer(struct timer_list *timer___0 ) ;
...
#line 71 "sbc60xxwdt.c"
static int wdt_stop  =    69;
#line 73 "sbc60xxwdt.c"
char _ddv_module_param_wdt_stop[42]  = 
#line 73
  {      (char )'S',      (char )'B',      (char )'C',      (char )'6', 
        (char )'0',      (char )'x',      (char )'x',      (char )' ', 
        (char )'W',      (char )'D',      (char )'T',      (char )' ', 
        (char )'\'',      (char )'s',      (char )'t',      (char )'o', 
        (char )'p',      (char )'\'',      (char )' ',      (char )'i', 
        (char )'o',      (char )' ',      (char )'p',      (char )'o', 
        (char )'r',      (char )'t',      (char )' ',      (char )'(', 
        (char )'d',      (char )'e',      (char )'f',      (char )'a', 
        (char )'u',      (char )'l',      (char )'t',      (char )' ', 
        (char )'0',      (char )'x',      (char )'4',      (char )'5', 
        (char )')',      (char )'\000'};
#line 75 "sbc60xxwdt.c"
static int wdt_start  =    1091;
#line 77 "sbc60xxwdt.c"
char _ddv_module_param_wdt_start[44]  = 
#line 77
  {      (char )'S',      (char )'B',      (char )'C',      (char )'6', 
        (char )'0',      (char )'x',      (char )'x',      (char )' ', 
        (char )'W',      (char )'D',      (char )'T',      (char )' ', 
        ...
        (char )' ',      (char )'0',      (char )'x',      (char )'4', 
        (char )'4',      (char )'3',      (char )')',      (char )'\000'};
#line 97 "sbc60xxwdt.c"
static int timeout  =    30;
#line 99 "sbc60xxwdt.c"
...
#line 99
  {      (char )'W',      (char )'a',      (char )'t',      (char )'c', 
        ...
        (char )'E',      (char )'O',      (char )'U',      (char )'T', 
        (char )')',      (char )'\000'};
#line 101 "sbc60xxwdt.c"
static int nowayout  =    0;
#line 103 "sbc60xxwdt.c"
...
#line 106 "sbc60xxwdt.c"
static struct timer_list timer  ;
#line 107 "sbc60xxwdt.c"
static unsigned long next_heartbeat  ;
#line 108 "sbc60xxwdt.c"
static unsigned long wdt_is_open  ;
#line 109 "sbc60xxwdt.c"
static char wdt_expect_close  ;
#line 115 "sbc60xxwdt.c"
static void wdt_timer_ping(unsigned long data ) 
{ 
  ...
  {
#line 120
  if ((long )jiffies - (long )next_heartbeat < 0L) {
#line 123
    inb_p((unsigned int )wdt_start);
#line 125
    timer.expires = jiffies + 26UL;
#line 126
    add_timer(& timer);
  } else {
#line 128
...
{ 
  ...
  {
#line 138
  next_heartbeat = jiffies + (unsigned long )(timeout * 100);
#line 141
  timer.expires = jiffies + 26UL;
#line 142
  add_timer(& timer);
...
#line 199
  tmp = test_and_set_bit(0, & wdt_is_open);
#line 199
  if (tmp) {
#line 200
    return (-16);
...
#line 218
  clear_bit(0, (unsigned long volatile   *)(& wdt_is_open));
#line 219
  wdt_expect_close = (char)0;
#line 220
  return (0);
...
static int fop_ioctl(struct inode *inode , struct file *file , unsigned int cmd ,
                     unsigned long arg ) ;
#line 228 "sbc60xxwdt.c"
static struct watchdog_info ident  =    {(__u32 )33152, (__u32 )1, {(__u8 )'S', (__u8 )'B', (__u8 )'C', (__u8 )'6', (__u8 )'0',
                               (__u8 )'x', (__u8 )'x', (__u8 )'\000'}};
#line 223 "sbc60xxwdt.c"
static int fop_ioctl(struct inode *inode , struct file *file , unsigned int cmd ,
                     unsigned long arg ) 
{ 
  void *argp ;
...
#line 270
  tmp___4 = get_user(new_timeout, (void *)p);
#line 270
  if (tmp___4) {
#line 271
    return (-14);
     ...
     {(struct module *)0, & no_llseek, (ssize_t (*)(struct file * , char * , size_t  ,
                                                  loff_t * ))0, & fop_write, (int (*)(struct file * ,
                                                                                      ...
                                                                                      int (*)(void * ,
                                                                                              ...
                                                                                              ino_t  ,
                                                                                              unsigned int  ) ))0,
    (unsigned int (*)(struct file * , struct poll_table_struct * ))0, & fop_ioctl,
    (long (*)(struct file * , unsigned int  , unsigned long  ))0, (long (*)(struct file * ,
                                                                            unsigned int  ,
                                                                            unsigned long  ))0,
    (int (*)(struct file * , struct vm_area_struct * ))0, & fop_open, (int (*)(struct file * ))0,
    & fop_close, (int (*)(struct file * , struct dentry * , int datasync ))0, (int (*)(int  ,
                                                                                       struct file * ,
                                                                                       int  ))0,
...
#line 331
      release_region((unsigned long )wdt_stop, 1UL);
    }
  }
#line 332
  release_region((unsigned long )wdt_start, 1UL);
#line 333
  return;
}
}
#line 335 "sbc60xxwdt.c"
...
#line 346
  tmp = request_region((unsigned long )wdt_start, 1UL, "SBC 60XX WDT");
#line 346
  if (! tmp) {
#line 348
...
#line 355
    if (wdt_stop != wdt_start) {
#line 357
      tmp___0 = request_region((unsigned long )wdt_stop, 1UL, "SBC 60XX WDT");
#line 357
      if (! tmp___0) {
#line 359
        printk("<3>sbc60xxwdt: I/O address 0x%04x already in use\n", wdt_stop);
...
#line 402 "sbc60xxwdt.c"
int (*_ddv_tmp_init)(void)  =    & sbc60xxwdt_init;
#line 403 "sbc60xxwdt.c"
void (*_ddv_tmp_exit)(void)  =    & sbc60xxwdt_unload;
#line 405 "sbc60xxwdt.c"
char _ddv_module_author[40]  = 
#line 405
  {      (char )'J',      (char )'a',      (char )'k',      (char )'o', 
        (char )'b',      (char )' ',      (char )'O',      (char )'e', 
        (char )'s',      (char )'t',      (char )'e',      (char )'r', 
        (char )'g',      (char )'a',      (char )'a',      (char )'r', 
        (char )'d',      (char )' ',      (char )'<',      (char )'j', 
        (char )'a',      (char )'k',      (char )'o',      (char )'b', 
        (char )'@',      (char )'u',      (char )'n',      (char )'t', 
        (char )'h',      (char )'o',      (char )'u',      (char )'g', 
        (char )'h',      (char )'t',      (char )'.',      (char )'n', 
        (char )'e',      (char )'t',      (char )'>',      (char )'\000'};
#line 406 "sbc60xxwdt.c"
char _ddv_module_description[49]  = 
#line 406
  {      (char )'6',      (char )'0',      (char )'x',      (char )'x', 
        (char )' ',      (char )'S',      (char )'i',      (char )'n', 
...
#line 1 "manage.o"
#pragma merger("0","/tmp/cil-vnxyrilj.i","")
...
#line 1 "misc.o"
#pragma merger("0","/tmp/cil-BPid8vfr.i","")
...
#line 1 "mutex.o"
#pragma merger("0","/tmp/cil-4PO838Mg.i","")
...
#line 1 "page_alloc.o"
#pragma merger("0","/tmp/cil-Nc9UaHu3.i","")
...
#line 1 "pci.o"
#pragma merger("0","/tmp/cil-AWE8i17c.i","")
...
#line 1 "resource.o"
#pragma merger("0","/tmp/cil-3W1qRfG7.i","")
...
#line 1 "sched.o"
#pragma merger("0","/tmp/cil-l2xuHTQO.i","")
...
#line 1 "semaphore.o"
#pragma merger("0","/tmp/cil-21nBavCj.i","")
...
#line 1 "slab.o"
#pragma merger("0","/tmp/cil-UGWCWrH_.i","")
...
#line 1 "softirq.o"
#pragma merger("0","/tmp/cil-mfNCahFo.i","")
...
#line 1 "spinlock.o"
#pragma merger("0","/tmp/cil-nRXpevGE.i","")
...
#line 1 "tasklet.o"
#pragma merger("0","/tmp/cil-PqBIj0L6.i","")
...
#line 1 "timer.o"
#pragma merger("0","/tmp/cil-Gl6TgcjN.i","")
#line 27 "/usr/local/ddv/models/con2/include/linux/timer.h"
__inline void add_timer_on(struct timer_list *timer___0 , int cpu ) ;
#line 30
__inline int mod_timer(struct timer_list *timer___0 , unsigned long expires ) ;
...
#line 7
    timer___0->__ddv_active = (short)0;
#line 8
    timer___0->__ddv_init = (short)1;
#line 9
    timer_registered[number_timer_registered].timer = timer___0;
#line 11
...
{ 
  ...
  {
#line 21
  timer___0->__ddv_active = (short)1;
#line 22
  return;
}
}
...
#line 1 "tty_io.o"
#pragma merger("0","/tmp/cil-51DC6aPP.i","")
...
#line 1 "usercopy.o"
#pragma merger("0","/tmp/cil-SFMCKu06.i","")
...
#line 1 "vmalloc.o"
#pragma merger("0","/tmp/cil-2sLdN_QI.i","")
...
#line 1 "wait.o"
#pragma merger("0","/tmp/cil-zpEvTEXF.i","")
...
#line 1 "workqueue.o"
#pragma merger("0","/tmp/cil-F4JlPD23.i","")
