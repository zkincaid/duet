...
#line 27 "toshiba.h"
struct __anonstruct_SMMRegisters_5 {
   unsigned int eax ;
   unsigned int ebx  __attribute__((__packed__)) ;
   unsigned int ecx  __attribute__((__packed__)) ;
   unsigned int edx  __attribute__((__packed__)) ;
   unsigned int esi  __attribute__((__packed__)) ;
   unsigned int edi  __attribute__((__packed__)) ;
};
#line 27 "toshiba.h"
typedef struct __anonstruct_SMMRegisters_5 SMMRegisters;
...
#line 1 "cdev.o"
#pragma merger("0","/tmp/cil-PtHCAQ5U.i","")
...
#line 1 "char_dev.o"
#pragma merger("0","/tmp/cil-xKnIt8e9.i","")
...
#line 1 "ddverify.o"
#pragma merger("0","/tmp/cil-QOxv2IcE.i","")
...
#line 1 "genhd.o"
#pragma merger("0","/tmp/cil-KrBMIluc.i","")
...
#line 1 "interrupt.o"
#pragma merger("0","/tmp/cil-0XgxXo8F.i","")
...
#line 1 "ioctl.o"
#pragma merger("0","/tmp/cil-WXq81vmk.i","")
#line 1 "ll_rw_blk.o"
#pragma merger("0","/tmp/cil-xQ6vy3zY.i","")
...
#line 1 "__main.o"
#pragma merger("0","/tmp/cil-qTQ9MTIo.i","")
#line 33 "/usr/local/ddv/models/con2/include/ddverify/satabs.h"
extern void noop() ;
...
#line 77 "toshiba.c"
char _ddv_module_author[43]  = 
#line 77
  {      (char )'J',      (char )'o',      (char )'n',      (char )'a', 
        (char )'t',      (char )'h',      (char )'a',      (char )'n', 
        (char )' ',      (char )'B',      (char )'u',      (char )'z', 
        (char )'z',      (char )'a',      (char )'r',      (char )'d', 
        (char )' ',      (char )'<',      (char )'j',      (char )'o', 
        (char )'n',      (char )'a',      (char )'t',      (char )'h', 
        (char )'a',      (char )'n',      (char )'@',      (char )'b', 
        (char )'u',      (char )'z',      (char )'z',      (char )'a', 
        (char )'r',      (char )'d',      (char )'.',      (char )'o', 
        (char )'r',      (char )'g',      (char )'.',      (char )'u', 
        (char )'k',      (char )'>',      (char )'\000'};
#line 78 "toshiba.c"
char _ddv_module_description[26]  = 
#line 78
  {      (char )'T',      (char )'o',      (char )'s',      (char )'h', 
        (char )'i',      (char )'b',      (char )'a',      (char )' ', 
        (char )'l',      (char )'a',      (char )'p',      (char )'t', 
        (char )'o',      (char )'p',      (char )' ',      (char )'S', 
        (char )'M',      (char )'M',      (char )' ',      (char )'d', 
        (char )'r',      (char )'i',      (char )'v',      (char )'e', 
        (char )'r',      (char )'\000'};
#line 79 "toshiba.c"
char _ddv_module_supported_device[8]  = 
#line 79
  {      (char )'t',      (char )'o',      (char )'s',      (char )'h', 
        (char )'i',      (char )'b',      (char )'a',      (char )'\000'};
#line 81 "toshiba.c"
int tosh_fn  ;
#line 83 "toshiba.c"
char _ddv_module_param_fn[37]  = 
#line 83
  {      (char )'U',      (char )'s',      (char )'e',      (char )'r', 
        (char )' ',      (char )'s',      (char )'p',      (char )'e', 
        (char )'c',      (char )'i',      (char )'f',      (char )'i', 
        (char )'e',      (char )'d',      (char )' ',      (char )'F', 
        (char )'n',      (char )' ',      (char )'k',      (char )'e', 
        (char )'y',      (char )' ',      (char )'d',      (char )'e', 
        (char )'t',      (char )'e',      (char )'c',      (char )'t', 
...
int tosh_fan  ;
#line 91
int tosh_ioctl(struct inode *ip , struct file *fp , unsigned int cmd , unsigned long arg ) ;
#line 95 "toshiba.c"
struct file_operations  const  tosh_fops  = 
#line 95
    ...
    (ssize_t (*)(struct file * , char const   * , size_t  , loff_t * ))0, (int (*)(struct file * ,
                                                                                   ...
                                                                                   int (*)(void * ,
                                                                                           ...
                                                                                           ino_t  ,
                                                                                           unsigned int  ) ))0,
    (unsigned int (*)(struct file * , struct poll_table_struct * ))0, & tosh_ioctl,
...
#line 100 "toshiba.c"
struct miscdevice tosh_device  =    {181, "toshiba", (struct file_operations *)(& tosh_fops)};
#line 145
extern int ( /* missing proto */  local_irq_save)() ;
#line 148
extern int ( /* missing proto */  local_irq_restore)() ;
#line 132 "toshiba.c"
...
{ 
  ...
  {
#line 137
  eax = (unsigned long )(regs->eax & 65280U);
#line 138
  ecx = (unsigned long )(regs->ecx & 65535U);
#line 142
  if (tosh_id == 64715) {
#line 143
    if (eax == 65024UL) {
...
#line 149
      regs->eax = 0U;
#line 150
      regs->ecx = (unsigned int )((int )al & 1);
    }
#line 152
    if (eax == 65280UL) {
#line 152
...
#line 157
        outb((unsigned char)190, 228U);
#line 158
        outb((unsigned char )((int )al | 1), 229U);
#line 159
        local_irq_restore(flags);
#line 160
        regs->eax = 0U;
...
#line 168
        outb((unsigned char)190, 228U);
#line 169
        outb((unsigned char )((int )al & 254), 229U);
#line 170
        local_irq_restore(flags);
#line 171
        regs->eax = 0U;
...
#line 192
        al = inb(229U);
#line 193
        outw((unsigned short )(224 | (((int )al & 254) << 8)), 228U);
#line 194
        local_irq_restore(flags);
#line 195
        regs->eax = 0U;
...
#line 202
        al = inb(229U);
#line 203
        outw((unsigned short )(224 | (((int )al | 1) << 8)), 228U);
#line 204
        local_irq_restore(flags);
#line 205
        regs->eax = 0U;
...
#line 265
  tmp = copy_from_user((void *)(& regs), (void *)argp, sizeof(SMMRegisters ));
#line 265
  if (tmp) {
#line 266
    return (-14);
...
#line 268
  switch (cmd) {
  case (unsigned int )((unsigned long )(((3U << 30) | (unsigned int )(116 << 8)) | 144U) | (sizeof(int ) << 16)): 
#line 270
  ax = (unsigned short )(regs.eax & 65280U);
#line 271
  bx = (unsigned short )(regs.ebx & 65535U);
#line 273
  if ((int )ax == 65280) {
#line 273
    goto _L;
...
#line 289
  tmp___0 = copy_to_user((void *)argp, (void const   *)(& regs), sizeof(SMMRegisters ));
#line 289
  if (tmp___0) {
#line 290
    return (-14);
...
#line 358 "toshiba.c"
int tosh_get_machine_id(void *bios ) 
{ 
  int id ;
  SMMRegisters regs ;
  unsigned short bx ;
  ...
  {
#line 365
  tmp = readb((void const   *)(bios + 65534));
#line 365
  tmp___0 = readb((void const   *)(bios + 65530));
#line 365
  id = 256 * (int )tmp + (int )tmp___0;
#line 369
  if (id == 64559) {
#line 373
    regs.eax = 49152U;
...
#line 377
    bx = (unsigned short )(regs.ebx & 65535U);
#line 387
    bx = (unsigned short)59125;
#line 391
    address = (unsigned long )bx;
#line 392
    cx = readw((void const   *)(bios + address));
#line 393
    address = (unsigned long )((9 + (int )bx) + (int )cx);
#line 394
    cx = readw((void const   *)(bios + address));
#line 395
    address = (unsigned long )(10 + (int )cx);
#line 396
    cx = readw((void const   *)(bios + address));
#line 400
    id = (((int )cx & 255) << 8) + (((int )cx & 65280) >> 8);
  }
#line 403
  return (id);
}
...
{ 
  ...
  {
#line 417
  signature[0] = (unsigned char)84;
#line 417
  signature[1] = (unsigned char)79;
#line 417
  signature[2] = (unsigned char)83;
#line 417
  signature[3] = (unsigned char)72;
#line 417
  signature[4] = (unsigned char)73;
#line 417
  signature[5] = (unsigned char)66;
#line 417
  signature[6] = (unsigned char)65;
#line 419
  tmp = ioremap(983040UL, 65536UL);
#line 419
  bios = tmp;
#line 421
  if (! bios) {
...
#line 427
  while (i < 7) {
#line 428
    tmp___0 = readb((void const   *)((bios + 57360) + i));
#line 428
    if ((int )tmp___0 != (int )signature[i]) {
#line 429
...
#line 452
  tosh_sci = (int )(regs.edx & 65535U);
#line 456
  tosh_id = tosh_get_machine_id(bios);
#line 460
  tmp___1 = readb((void const   *)(bios + 57353));
#line 460
  major = (int )tmp___1 - 48;
#line 461
  tmp___2 = readb((void const   *)(bios + 57355));
#line 461
  tmp___3 = readb((void const   *)(bios + 57356));
#line 461
  minor = ((int )tmp___2 - 48) * 10 + ((int )tmp___3 - 48);
#line 462
  tosh_bios = major * 256 + minor;
#line 466
  tmp___4 = readb((void const   *)(bios + 65525));
#line 466
  tmp___5 = readb((void const   *)(bios + 65526));
#line 466
  day = ((int )tmp___4 - 48) * 10 + ((int )tmp___5 - 48);
#line 467
  tmp___6 = readb((void const   *)(bios + 65528));
#line 467
  tmp___7 = readb((void const   *)(bios + 65529));
#line 467
  month = ((int )tmp___6 - 48) * 10 + ((int )tmp___7 - 48);
#line 468
  tmp___8 = readb((void const   *)(bios + 65531));
#line 468
  tmp___9 = readb((void const   *)(bios + 65532));
#line 468
  year = ((int )tmp___8 - 48) * 10 + ((int )tmp___9 - 48);
#line 469
  tosh_date = ((((year - 90) & 31) << 10) | ((month & 15) << 6)) | ((day & 31) << 1);
#line 482
  if (tosh_id == 64715) {
#line 483
    tosh_fan = 1;
...
#line 498
  printk("<6>Toshiba System Managment Mode driver v1.11 26/9/2001\n");
#line 501
  if (tosh_fn == 0) {
#line 502
    tosh_set_fn_port();
...
#line 520 "toshiba.c"
void toshiba_exit(void) 
{ 


  {
#line 522
  remove_proc_entry("toshiba", (struct proc_dir_entry *)((void *)0));
#line 523
...
#line 526 "toshiba.c"
int (*_ddv_tmp_init)(void)  =    & toshiba_init;
#line 527 "toshiba.c"
void (*_ddv_tmp_exit)(void)  =    & toshiba_exit;
#line 4 "__main.c"
int main(void) 
{ 
...
#line 1 "manage.o"
#pragma merger("0","/tmp/cil-lNYdzEVM.i","")
...
#line 1 "misc.o"
#pragma merger("0","/tmp/cil-9_XKHP4v.i","")
...
#line 1 "mutex.o"
#pragma merger("0","/tmp/cil-fePMRLKE.i","")
...
#line 1 "page_alloc.o"
#pragma merger("0","/tmp/cil-SwBoQLPc.i","")
...
#line 1 "pci.o"
#pragma merger("0","/tmp/cil-rKbhgUzr.i","")
...
#line 1 "resource.o"
#pragma merger("0","/tmp/cil-AbL85GYe.i","")
...
#line 1 "sched.o"
#pragma merger("0","/tmp/cil-BFBFco1U.i","")
...
#line 1 "semaphore.o"
#pragma merger("0","/tmp/cil-5RSydFKO.i","")
...
#line 1 "slab.o"
#pragma merger("0","/tmp/cil-wQOs71Fg.i","")
...
#line 1 "softirq.o"
#pragma merger("0","/tmp/cil-XFc1epp2.i","")
...
#line 1 "spinlock.o"
#pragma merger("0","/tmp/cil-OmQCBgAY.i","")
...
#line 1 "tasklet.o"
#pragma merger("0","/tmp/cil-mWwsIef2.i","")
...
#line 1 "timer.o"
#pragma merger("0","/tmp/cil-b4Ay1yaz.i","")
...
#line 1 "tty_io.o"
#pragma merger("0","/tmp/cil-Aqc0MP5J.i","")
...
#line 1 "usercopy.o"
#pragma merger("0","/tmp/cil-aktY48Ac.i","")
...
#line 1 "vmalloc.o"
#pragma merger("0","/tmp/cil-7jYWsgpS.i","")
...
#line 1 "wait.o"
#pragma merger("0","/tmp/cil-UaVxoAKC.i","")
...
#line 1 "workqueue.o"
#pragma merger("0","/tmp/cil-D1XoTG3_.i","")
