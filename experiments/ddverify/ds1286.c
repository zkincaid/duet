...
#line 1 "cdev.o"
#pragma merger("0","/tmp/cil-0d4NxjYJ.i","")
...
#line 1 "char_dev.o"
#pragma merger("0","/tmp/cil-jPjOCHZx.i","")
...
#line 1 "ddverify.o"
#pragma merger("0","/tmp/cil-Jrroh4Go.i","")
...
#line 1 "genhd.o"
#pragma merger("0","/tmp/cil-f1tNhI6F.i","")
...
#line 1 "interrupt.o"
#pragma merger("0","/tmp/cil-lYUPbohm.i","")
...
#line 1 "ioctl.o"
#pragma merger("0","/tmp/cil-CuUGQrp1.i","")
#line 1 "ll_rw_blk.o"
#pragma merger("0","/tmp/cil-gfrd99cB.i","")
...
#line 1 "__main.o"
#pragma merger("0","/tmp/cil-YvEEDKxe.i","")
...
#line 217 "/usr/local/ddv/models/con2/include/linux/rtc.h"
...
#line 55 "ds1286.c"
wait_queue_head_t ds1286_wait  =    {0, 0, 1};
#line 57
ssize_t ds1286_read(struct file *file , char *buf , size_t count , loff_t *ppos ) ;
#line 60
int ds1286_ioctl(struct inode *inode , struct file *file , unsigned int cmd , unsigned long arg ) ;
#line 63
...
#line 69
__inline unsigned char ds1286_is_updating(void) ;
#line 71 "ds1286.c"
spinlock_t ds1286_lock  =    {1, 0};
#line 73
int ds1286_read_proc(char *page , char **start , off_t off , int count , int *eof ,
                     void *data ) ;
#line 83 "ds1286.c"
unsigned char ds1286_status  ;
#line 85 "ds1286.c"
unsigned char days_in_mo[13]  = 
#line 85
...
{ 
  ...
  unsigned char val___0 ;
  int tmp___0 ;
  unsigned long flags___1 ;
  unsigned char val___1 ;
  int tmp___1 ;
  unsigned long flags___2 ;
  unsigned char val___2 ;
  int tmp___2 ;
  unsigned char hrs ;
  unsigned char min ;
  unsigned char sec ;
...
#line 114
  val = rtc_read((unsigned char)11);
#line 115
  val = (unsigned char )((int )val | 4);
#line 116
  rtc_write(val, (unsigned char)11);
#line 117
...
#line 129
  spin_lock_irqsave(& ds1286_lock, flags___0);
#line 130
  val___0 = rtc_read((unsigned char)11);
#line 131
  val___0 = (unsigned char )((int )val___0 & -5);
#line 132
  rtc_write(val___0, (unsigned char)11);
#line 133
  spin_unlock_irqrestore(& ds1286_lock, flags___0);
#line 135
  return (0);
  case (unsigned int )(112 << 8) | 16U: 
#line 142
  tmp___1 = capable(25);
#line 142
  if (! tmp___1) {
...
#line 145
  spin_lock_irqsave(& ds1286_lock, flags___1);
#line 146
  val___1 = rtc_read((unsigned char)11);
#line 147
  val___1 = (unsigned char )((int )val___1 | 8);
#line 148
  rtc_write(val___1, (unsigned char)11);
#line 149
  spin_unlock_irqrestore(& ds1286_lock, flags___1);
#line 151
  return (0);
  case (unsigned int )(112 << 8) | 15U: 
#line 158
  tmp___2 = capable(25);
#line 158
  if (! tmp___2) {
...
#line 161
  spin_lock_irqsave(& ds1286_lock, flags___2);
#line 162
  val___2 = rtc_read((unsigned char)11);
#line 163
  val___2 = (unsigned char )((int )val___2 & -9);
#line 164
  rtc_write(val___2, (unsigned char)11);
#line 165
  spin_unlock_irqrestore(& ds1286_lock, flags___2);
#line 167
  return (0);
...
#line 194
  tmp___4 = copy_from_user((void *)(& alm_tm), (void *)((struct rtc_time *)arg), sizeof(struct rtc_time ));
#line 194
  if (tmp___4) {
#line 196
    return (-14);
...
#line 198
  hrs = (unsigned char )alm_tm.tm_hour;
#line 199
  min = (unsigned char )alm_tm.tm_min;
#line 201
  if ((int )hrs >= 24) {
#line 202
    hrs = (unsigned char)255;
  }
#line 204
  if ((int )min >= 60) {
#line 205
...
#line 212
  rtc_write(hrs, (unsigned char)5);
#line 213
  rtc_write(min, (unsigned char)3);
#line 214
...
#line 231
  tmp___6 = copy_from_user((void *)(& rtc_tm), (void *)((struct rtc_time *)arg), sizeof(struct rtc_time ));
#line 231
  if (tmp___6) {
#line 233
    return (-14);
...
#line 235
  tmp___7 = ds1286_set_time(& rtc_tm);
#line 235
  return (tmp___7);
  default: 
#line 238
...
#line 240
  tmp___10 = copy_to_user((void *)arg, (void const   *)(& wtime), sizeof(wtime));
#line 240
  if (tmp___10) {
#line 240
    tmp___9 = -14;
...
#line 253
  if ((int )ds1286_status & 1) {
#line 254
    goto out_busy;
  }
#line 256
  ds1286_status = (unsigned char )((int )ds1286_status | 1);
#line 258
...
{ 
  ...
  {
#line 268
  ds1286_status = (unsigned char )((int )ds1286_status & -2);
#line 270
  return (0);
}
}
...
#line 284 "ds1286.c"
struct file_operations  const  ds1286_fops  = 
#line 284
     {(struct module *)0, & no_llseek, & ds1286_read, (ssize_t (*)(struct file * , char const   * ,
                                                                 size_t  , loff_t * ))0,
    (int (*)(struct file * , void * , int (*)(void * , char const   * , int  , loff_t  ,
                                              ino_t  , unsigned int  ) ))0, & ds1286_poll,
    & ds1286_ioctl, (long (*)(struct file * , unsigned int  , unsigned long  ))0,
    (long (*)(struct file * , unsigned int  , unsigned long  ))0, (int (*)(struct file * ,
                                                                           struct vm_area_struct * ))0,
    & ds1286_open, (int (*)(struct file * ))0, & ds1286_release, (int (*)(struct file * ,
                                                                          struct dentry * ,
                                                                          int datasync ))0,
...
#line 293 "ds1286.c"
struct miscdevice ds1286_dev  =    {135, "rtc", (struct file_operations *)(& ds1286_fops)};
#line 300 "ds1286.c"
int ds1286_init(void) 
{ 
  int err ;
  ...
  {
#line 304
  printk("<6>DS1286 Real Time Clock Driver v%s\n", "1.0");
#line 306
...
#line 310
  tmp = create_proc_read_entry("driver/rtc", (mode_t )0, (struct proc_dir_entry *)0,
                               & ds1286_read_proc, (void *)0);
#line 310
  if (! tmp) {
#line 311
    err = -12;
...
#line 325 "ds1286.c"
void ds1286_exit(void) 
{ 


  {
#line 327
  remove_proc_entry("driver/rtc", (struct proc_dir_entry *)((void *)0));
#line 328
  misc_deregister(& ds1286_dev);
#line 329
  return;
...
char *days[8]  = 
#line 331
  {      (char *)"***",      (char *)"Sun",      (char *)"Mon",      (char *)"Tue", 
...
#line 346
  ds1286_get_time(& tm);
#line 347
  hundredth = rtc_read((unsigned char)0);
#line 348
  hundredth = (unsigned char )(((int )hundredth & 15) + ((int )hundredth >> 4) * 10);
#line 350
  tmp = sprintf(p, "rtc_time\t: %02d:%02d:%02d.%02d\nrtc_date\t: %04d-%02d-%02d\n",
                tm.tm_hour, tm.tm_min, tm.tm_sec, (int )hundredth, tm.tm_year + 1900,
...
#line 362
  tmp___0 = sprintf(p, "alarm\t\t: %s ", days[tm.tm_wday]);
#line 362
  p += tmp___0;
#line 363
  if (tm.tm_hour <= 24) {
#line 364
    tmp___1 = sprintf(p, "%02d:", tm.tm_hour);
#line 364
    p += tmp___1;
  } else {
#line 366
...
#line 373
  month = rtc_read((unsigned char)9);
#line 374
  if ((int )month & 64) {
#line 374
    tmp___5 = "disabled";
...
#line 374
  tmp___7 = sprintf(p, "oscillator\t: %s\nsquare_wave\t: %s\n", tmp___6, tmp___5);
#line 374
  p += tmp___7;
#line 380
  tmp___8 = rtc_read((unsigned char)3);
#line 380
  tmp___9 = rtc_read((unsigned char)5);
#line 380
  tmp___10 = rtc_read((unsigned char)7);
#line 380
  amode = (unsigned char )(((((int )tmp___8 & 128) >> 5) | (((int )tmp___9 & 128) >> 6)) | (((int )tmp___10 & 128) >> 7));
#line 383
  if ((int )amode == 7) {
#line 383
    s = (char *)"each minute";
...
#line 384
  if ((int )amode == 3) {
#line 384
    s = (char *)"minutes match";
  } else
#line 385
  if ((int )amode == 1) {
#line 385
    s = (char *)"hours and minutes match";
  } else
#line 386
  if ((int )amode == 0) {
#line 386
    s = (char *)"days, hours and minutes match";
  } else {
#line 387
    s = (char *)"invalid";
  }
#line 388
  tmp___11 = sprintf(p, "alarm_mode\t: %s\n", s);
#line 388
  p += tmp___11;
#line 390
  cmd = rtc_read((unsigned char)11);
#line 391
  if ((int )cmd & 64) {
#line 391
    tmp___12 = "unswapped";
...
#line 391
  tmp___19 = sprintf(p, "alarm_enable\t: %s\nwdog_alarm\t: %s\nalarm_mask\t: %s\nwdog_alarm_mask\t: %s\ninterrupt_mode\t: %s\nINTB_mode\t: %s_active\ninterrupt_pins\t: %s\n",
                     tmp___18, tmp___17, tmp___16, tmp___15, tmp___14, tmp___13, tmp___12);
#line 391
  p += tmp___19;
#line 407
  return ((int )(p - buf));
...
{ 
  ...
  {
#line 430
  tmp = rtc_read((unsigned char)11);
#line 430
  return ((unsigned char )((int )tmp & 128));
}
}
#line 434 "ds1286.c"
void ds1286_get_time(struct rtc_time *rtc_tm ) 
...
#line 450
  tmp = ds1286_is_updating();
#line 450
  if ((int )tmp != 0) {
#line 451
    while (jiffies - uip_watchdog < 2UL) {
#line 452
      barrier();
    }
  }
#line 460
  spin_lock_irqsave(& ds1286_lock, flags);
#line 461
  save_control = rtc_read((unsigned char)11);
#line 462
  rtc_write((unsigned char )((int )save_control | 128), (unsigned char)11);
#line 464
  tmp___0 = rtc_read((unsigned char)1);
#line 464
  rtc_tm->tm_sec = (int )tmp___0;
#line 465
  tmp___1 = rtc_read((unsigned char)2);
#line 465
  rtc_tm->tm_min = (int )tmp___1;
#line 466
  tmp___2 = rtc_read((unsigned char)4);
#line 466
  rtc_tm->tm_hour = (int )tmp___2 & 63;
#line 467
  tmp___3 = rtc_read((unsigned char)8);
#line 467
  rtc_tm->tm_mday = (int )tmp___3;
#line 468
  tmp___4 = rtc_read((unsigned char)9);
#line 468
  rtc_tm->tm_mon = (int )tmp___4 & 31;
#line 469
  tmp___5 = rtc_read((unsigned char)10);
#line 469
  rtc_tm->tm_year = (int )tmp___5;
#line 471
  rtc_write(save_control, (unsigned char)11);
#line 472
  spin_unlock_irqrestore(& ds1286_lock, flags);
#line 474
  rtc_tm->tm_sec = (rtc_tm->tm_sec & 15) + (rtc_tm->tm_sec >> 4) * 10;
#line 475
  rtc_tm->tm_min = (rtc_tm->tm_min & 15) + (rtc_tm->tm_min >> 4) * 10;
#line 476
  rtc_tm->tm_hour = (rtc_tm->tm_hour & 15) + (rtc_tm->tm_hour >> 4) * 10;
#line 477
  rtc_tm->tm_mday = (rtc_tm->tm_mday & 15) + (rtc_tm->tm_mday >> 4) * 10;
#line 478
  rtc_tm->tm_mon = (rtc_tm->tm_mon & 15) + (rtc_tm->tm_mon >> 4) * 10;
#line 479
  rtc_tm->tm_year = (rtc_tm->tm_year & 15) + (rtc_tm->tm_year >> 4) * 10;
#line 485
...
#line 487
  tmp___6 = rtc_tm->tm_year + 40;
#line 487
  rtc_tm->tm_year = tmp___6;
#line 487
  if (tmp___6 < 70) {
#line 488
    rtc_tm->tm_year += 100;
...
{ 
  ...
  {
#line 501
  yrs = (unsigned int )(rtc_tm->tm_year + 1900);
#line 502
  mon = (unsigned char )(rtc_tm->tm_mon + 1);
#line 503
  day = (unsigned char )rtc_tm->tm_mday;
#line 504
  hrs = (unsigned char )rtc_tm->tm_hour;
#line 505
  min = (unsigned char )rtc_tm->tm_min;
#line 506
  sec = (unsigned char )rtc_tm->tm_sec;
#line 508
  if (yrs < 1970U) {
#line 509
    return (-22);
...
#line 516
  if ((int )day > (int )days_in_mo[mon] + tmp___0) {
#line 517
    return (-22);
  }
#line 519
...
#line 537
  rtc_write((unsigned char )((int )save_control | 128), (unsigned char)11);
#line 539
  rtc_write((unsigned char )yrs, (unsigned char)10);
#line 540
  rtc_write(mon, (unsigned char)9);
#line 541
  rtc_write(day, (unsigned char)8);
#line 542
  rtc_write(hrs, (unsigned char)4);
#line 543
  rtc_write(min, (unsigned char)2);
#line 544
  rtc_write(sec, (unsigned char)1);
#line 545
  rtc_write((unsigned char)0, (unsigned char)0);
#line 547
  rtc_write(save_control, (unsigned char)11);
#line 548
  spin_unlock_irqrestore(& ds1286_lock, flags);
...
#line 562
  spin_lock_irqsave(& ds1286_lock, flags);
#line 563
  tmp = rtc_read((unsigned char)3);
#line 563
  alm_tm->tm_min = (int )tmp & 127;
#line 564
  tmp___0 = rtc_read((unsigned char)5);
#line 564
  alm_tm->tm_hour = (int )tmp___0 & 31;
#line 565
  tmp___1 = rtc_read((unsigned char)7);
#line 565
  alm_tm->tm_wday = (int )tmp___1 & 7;
#line 566
  cmd = rtc_read((unsigned char)11);
#line 567
  spin_unlock_irqrestore(& ds1286_lock, flags);
#line 569
  alm_tm->tm_min = (alm_tm->tm_min & 15) + (alm_tm->tm_min >> 4) * 10;
#line 570
  alm_tm->tm_hour = (alm_tm->tm_hour & 15) + (alm_tm->tm_hour >> 4) * 10;
#line 571
  alm_tm->tm_sec = 0;
#line 572
  return;
...
#line 574 "ds1286.c"
int (*_ddv_tmp_init)(void)  =    & ds1286_init;
#line 575 "ds1286.c"
void (*_ddv_tmp_exit)(void)  =    & ds1286_exit;
#line 577 "ds1286.c"
char _ddv_module_author[13]  = 
#line 577
  {      (char )'R',      (char )'a',      (char )'l',      (char )'f', 
        (char )' ',      (char )'B',      (char )'a',      (char )'e', 
        (char )'c',      (char )'h',      (char )'l',      (char )'e', 
        (char )'\000'};
#line 578 "ds1286.c"
...
#line 1 "manage.o"
#pragma merger("0","/tmp/cil-JqEYpZVT.i","")
...
#line 1 "misc.o"
#pragma merger("0","/tmp/cil-IQjK_PDj.i","")
...
#line 1 "mutex.o"
#pragma merger("0","/tmp/cil-29wFWGAp.i","")
...
#line 1 "page_alloc.o"
#pragma merger("0","/tmp/cil-msR9EeUL.i","")
...
#line 1 "pci.o"
#pragma merger("0","/tmp/cil-bHRPa7lh.i","")
...
#line 1 "resource.o"
#pragma merger("0","/tmp/cil-D2gU7Y1J.i","")
...
#line 1 "sched.o"
#pragma merger("0","/tmp/cil-5jPJTnOW.i","")
...
#line 1 "semaphore.o"
#pragma merger("0","/tmp/cil-Af7KHvwN.i","")
...
#line 1 "slab.o"
#pragma merger("0","/tmp/cil-kuhje4D_.i","")
...
#line 1 "softirq.o"
#pragma merger("0","/tmp/cil-6Xzb813U.i","")
...
#line 1 "spinlock.o"
#pragma merger("0","/tmp/cil-sENPIL_U.i","")
...
#line 1 "tasklet.o"
#pragma merger("0","/tmp/cil-xQl40kGW.i","")
...
#line 1 "timer.o"
#pragma merger("0","/tmp/cil-bxcsYUVl.i","")
...
#line 1 "tty_io.o"
#pragma merger("0","/tmp/cil-oDGDBdy3.i","")
...
#line 1 "usercopy.o"
#pragma merger("0","/tmp/cil-V0jGWx8h.i","")
...
#line 1 "vmalloc.o"
#pragma merger("0","/tmp/cil-_QWdfZTU.i","")
...
#line 1 "wait.o"
#pragma merger("0","/tmp/cil-PkZaSuMQ.i","")
...
#line 1 "workqueue.o"
#pragma merger("0","/tmp/cil-OPFlN9rg.i","")
