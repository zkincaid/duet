...
#line 1 "cdev.o"
#pragma merger("0","/tmp/cil-ZQTIaka5.i","")
...
#line 1 "char_dev.o"
#pragma merger("0","/tmp/cil-qt3dbIbT.i","")
...
#line 1 "ddverify.o"
#pragma merger("0","/tmp/cil-gazadhDa.i","")
...
#line 1 "genhd.o"
#pragma merger("0","/tmp/cil-UUvasctU.i","")
...
#line 1 "interrupt.o"
#pragma merger("0","/tmp/cil-6C2R1OiC.i","")
...
#line 1 "ioctl.o"
#pragma merger("0","/tmp/cil-zhNwQbpC.i","")
#line 1 "ll_rw_blk.o"
#pragma merger("0","/tmp/cil-TuKSOQe4.i","")
...
#line 1 "__main.o"
#pragma merger("0","/tmp/cil-zH4FAnxF.i","")
...
#line 89 "wdt_pci.c"
char _ddv_module_param_heartbeat[68]  = 
#line 89
  {      (char )'W',      (char )'a',      (char )'t',      (char )'c', 
        ...
        (char )'D',      (char )'_',      (char )'T',      (char )'I', 
        (char )'M',      (char )'O',      (char )')',      (char )'\000'};
#line 91 "wdt_pci.c"
...
#line 111
  ctr |= mode << 1;
#line 112
  outb_p((unsigned char )ctr, (unsigned int )(io + 3));
#line 113
  return;
}
}
...
{ 
  ...
  {
#line 117
  outb_p((unsigned char )(val & 255), (unsigned int )(io + ctr));
#line 118
  outb_p((unsigned char )(val >> 8), (unsigned int )(io + ctr));
#line 119
  return;
}
}
...
#line 137
  inb_p((unsigned int )(io + 7));
#line 138
  wdtpci_ctr_mode(2, 0);
#line 139
  outb_p((unsigned char)0, (unsigned int )(io + 7));
#line 141
  inb_p((unsigned int )(io + 7));
#line 142
  outb_p((unsigned char)0, (unsigned int )(io + 12));
#line 143
  inb_p((unsigned int )(io + 6));
#line 144
  inb_p((unsigned int )(io + 13));
#line 145
  inb_p((unsigned int )(io + 14));
#line 146
  inb_p((unsigned int )(io + 15));
#line 147
  wdtpci_ctr_mode(0, 3);
#line 148
  wdtpci_ctr_mode(1, 2);
...
static int wdtpci_ioctl(struct inode *inode , struct file *file , unsigned int cmd ,
                        unsigned long arg ) ;
#line 369 "wdt_pci.c"
static struct watchdog_info ident  =    {(__u32 )33152, (__u32 )1, {(__u8 )'P', (__u8 )'C', (__u8 )'I', (__u8 )'-', (__u8 )'W',
                               (__u8 )'D', (__u8 )'T', (__u8 )'5', (__u8 )'0', (__u8 )'0',
                               (__u8 )'/', (__u8 )'5', (__u8 )'0', (__u8 )'1', (__u8 )'\000'}};
#line 361 "wdt_pci.c"
static int wdtpci_ioctl(struct inode *inode , struct file *file , unsigned int cmd ,
                        unsigned long arg ) 
{ 
...
#line 404
  tmp___5 = wdtpci_set_heartbeat(new_heartbeat);
#line 404
  if (tmp___5) {
#line 405
    return (-22);
...
#line 545
     {(struct module *)0, & no_llseek, (ssize_t (*)(struct file * , char * , size_t  ,
                                                  loff_t * ))0, & wdtpci_write, (int (*)(struct file * ,
                                                                                         void * ,
                                                                                         int (*)(void * ,
                                                                                                 char const   * ,
                                                                                                 int  ,
                                                                                                 ...
                                                                                                 ino_t  ,
                                                                                                 unsigned int  ) ))0,
    (unsigned int (*)(struct file * , struct poll_table_struct * ))0, & wdtpci_ioctl,
    (long (*)(struct file * , unsigned int  , unsigned long  ))0, (long (*)(struct file * ,
                                                                            unsigned int  ,
                                                                            unsigned long  ))0,
    (int (*)(struct file * , struct vm_area_struct * ))0, & wdtpci_open, (int (*)(struct file * ))0,
    & wdtpci_release, (int (*)(struct file * , struct dentry * , int datasync ))0,
...
#line 554 "wdt_pci.c"
static struct miscdevice wdtpci_miscdev  =    {130, "watchdog", (struct file_operations *)(& wdtpci_fops)};
#line 581 "wdt_pci.c"
...
#line 592
  if (dev_count > 1) {
#line 593
    printk("<3>wdt_pci: this driver only supports 1 device\n");
#line 594
    return (-19);
  }
#line 597
...
#line 611
  irq = (int )dev->irq;
#line 612
  io = (int )dev->resource[2].start;
#line 614
  tmp___0 = request_region((unsigned long )io, 16UL, "wdt_pci");
#line 614
  if ((unsigned long )tmp___0 == (unsigned long )((void *)0)) {
#line 615
    printk("<3>wdt_pci: I/O address 0x%04x already in use\n", io);
#line 616
    goto out_pci;
  }
#line 619
  tmp___1 = request_irq((unsigned int )irq, (irqreturn_t (*)(int  , void * , struct pt_regs * ))(& wdtpci_interrupt),
                        160UL, "wdt_pci", (void *)(& wdtpci_miscdev));
#line 619
  if (tmp___1) {
#line 621
...
#line 625
  printk("PCI-WDT500/501 (PCI-WDG-CSM) driver 0.10 at 0x%04x (Interrupt %d)\n", io,
         irq);
#line 629
  tmp___2 = wdtpci_set_heartbeat(heartbeat);
#line 629
  if (tmp___2) {
#line 630
...
#line 672
  ...
  out_irq: 
#line 674
  free_irq((unsigned int )irq, (void *)(& wdtpci_miscdev));
  out_reg: 
#line 676
  release_region((unsigned long )io, 16UL);
  out_pci: 
#line 678
...
#line 699 "wdt_pci.c"
static struct pci_device_id wdtpci_pci_tbl[2]  = {      {(__u32 )18767, (__u32 )8896, (__u32 )(~ 0), (__u32 )(~ 0), 0U, 0U, 0UL}, 
        {(__u32 )0, 0U, 0U, 0U, 0U, 0U, 0UL}};
#line 711 "wdt_pci.c"
static struct pci_driver wdtpci_driver  = 
#line 711
     {(char *)"wdt_pci", (struct pci_device_id  const  *)(wdtpci_pci_tbl), & wdtpci_init_one,
    & wdtpci_remove_one, (int (*)(struct pci_dev *dev , pm_message_t state ))0, (int (*)(struct pci_dev *dev ))0,
...
{ 
  ...
  {
#line 745
  tmp = pci_register_driver(& wdtpci_driver);
#line 745
  return (tmp);
}
}
#line 749 "wdt_pci.c"
int (*_ddv_tmp_init)(void)  =    & wdtpci_init;
#line 750 "wdt_pci.c"
void (*_ddv_tmp_exit)(void)  =    & wdtpci_cleanup;
#line 752 "wdt_pci.c"
char _ddv_module_author[22]  = 
#line 752
  {      (char )'J',      (char )'P',      (char )' ',      (char )'N', 
        (char )'o',      (char )'l',      (char )'l',      (char )'m', 
        (char )'a',      (char )'n',      (char )'n',      (char )',', 
        (char )' ',      (char )'A',      (char )'l',      (char )'a', 
...
#line 753
  {      (char )'D',      (char )'r',      (char )'i',      (char )'v', 
        ...
        (char )'C',      (char )'S',      (char )' ',      (char )'P', 
        (char )'C',      (char )'I',      (char )'-',      (char )'W', 
        (char )'D',      (char )'T',      (char )'5',      (char )'0', 
        (char )'0',      (char )'/',      (char )'5',      (char )'0', 
        (char )'1',      (char )' ',      (char )'w',      (char )'a', 
        (char )'t',      (char )'c',      (char )'h',      (char )'d', 
        (char )'o',      (char )'g',      (char )' ',      (char )'c', 
        (char )'a',      (char )'r',      (char )'d',      (char )'s', 
        (char )'\000'};
#line 754 "wdt_pci.c"
...
#line 1 "manage.o"
#pragma merger("0","/tmp/cil-cn3oTMhy.i","")
...
#line 1 "misc.o"
#pragma merger("0","/tmp/cil-Gn3daMwN.i","")
...
#line 1 "mutex.o"
#pragma merger("0","/tmp/cil-Xk31cx6s.i","")
...
#line 1 "page_alloc.o"
#pragma merger("0","/tmp/cil-NqVD4RMY.i","")
...
#line 1 "pci.o"
#pragma merger("0","/tmp/cil-3u2akroW.i","")
...
#line 1 "resource.o"
#pragma merger("0","/tmp/cil-2lEjoiw6.i","")
...
#line 1 "sched.o"
#pragma merger("0","/tmp/cil-i1lAAU5D.i","")
...
#line 1 "semaphore.o"
#pragma merger("0","/tmp/cil-OpQZWdaW.i","")
...
#line 1 "slab.o"
#pragma merger("0","/tmp/cil-AB4vQX3K.i","")
...
#line 1 "softirq.o"
#pragma merger("0","/tmp/cil-QDzsgxX_.i","")
...
#line 1 "spinlock.o"
#pragma merger("0","/tmp/cil-6DOXu83o.i","")
...
#line 1 "tasklet.o"
#pragma merger("0","/tmp/cil-Ub8blm7j.i","")
...
#line 1 "timer.o"
#pragma merger("0","/tmp/cil-XIqXZWzm.i","")
...
#line 1 "tty_io.o"
#pragma merger("0","/tmp/cil-wn5Yqp8p.i","")
...
#line 1 "usercopy.o"
#pragma merger("0","/tmp/cil-FZ0C3Pwa.i","")
...
#line 1 "vmalloc.o"
#pragma merger("0","/tmp/cil-mhLgwRLY.i","")
...
#line 1 "wait.o"
#pragma merger("0","/tmp/cil-EozYhWMi.i","")
...
#line 1 "workqueue.o"
#pragma merger("0","/tmp/cil-opOrI1pr.i","")
