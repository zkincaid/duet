...
#line 1 "cdev.o"
#pragma merger("0","/tmp/cil-64P46AV4.i","")
...
#line 1 "char_dev.o"
#pragma merger("0","/tmp/cil-NcyCinkA.i","")
...
#line 1 "ddverify.o"
#pragma merger("0","/tmp/cil-5FVRTXUa.i","")
...
#line 1 "genhd.o"
#pragma merger("0","/tmp/cil-TKtMKaFr.i","")
...
#line 1 "interrupt.o"
#pragma merger("0","/tmp/cil-WoR7Rx29.i","")
...
#line 1 "ioctl.o"
#pragma merger("0","/tmp/cil-vnKea70H.i","")
#line 1 "ll_rw_blk.o"
#pragma merger("0","/tmp/cil-YedPLTbY.i","")
...
#line 1 "__main.o"
#pragma merger("0","/tmp/cil-DRjnoD5j.i","")
...
#line 24 "/usr/local/ddv/models/con2/include/asm/io.h"
...
{ 
  ...
  {
#line 132
  outb_p((unsigned char )wd_margin, 1091U);
#line 133
  return;
}
}
...
#line 166
static int ibwdt_ioctl(struct inode *inode , struct file *file , unsigned int cmd ,
                       unsigned long arg ) ;
#line 166 "ib700wdt.c"
static struct watchdog_info ident  =    {(__u32 )33152, (__u32 )1, {(__u8 )'I', (__u8 )'B', (__u8 )'7', (__u8 )'0', (__u8 )'0',
                               (__u8 )' ', (__u8 )'W', (__u8 )'D', (__u8 )'T', (__u8 )'\000'}};
#line 158 "ib700wdt.c"
static int ibwdt_ioctl(struct inode *inode , struct file *file , unsigned int cmd ,
                       unsigned long arg ) 
{ 
...
#line 186
  tmp___1 = get_user(new_margin, (void *)p);
#line 186
  if (tmp___1) {
#line 187
    return (-14);
...
#line 198
  tmp___2 = put_user(wd_times[wd_margin], (void *)p);
#line 198
  return (tmp___2);
#line 199
  break;
...
#line 211
  tmp = test_and_set_bit(0, & ibwdt_is_open);
#line 211
  if (tmp) {
#line 212
...
#line 229
    outb_p((unsigned char)0, 1089U);
  } else {
#line 231
    printk("<2>ib700wdt: WDT device closed unexpectedly.  WDT will not stop!\n");
  }
#line 233
  clear_bit(0, (unsigned long volatile   *)(& ibwdt_is_open));
#line 234
  expect_close = (char)0;
#line 235
  spin_unlock(& ibwdt_lock);
...
#line 243 "ib700wdt.c"
static int ibwdt_notify_sys(struct notifier_block *this , unsigned long code , void *unused ) 
{ 
...
#line 258
     {(struct module *)0, & no_llseek, (ssize_t (*)(struct file * , char * , size_t  ,
                                                  loff_t * ))0, & ibwdt_write, (int (*)(struct file * ,
                                                                                        void * ,
                                                                                        int (*)(void * ,
                                                                                                char const   * ,
                                                                                                int  ,
                                                                                                ...
                                                                                                ino_t  ,
                                                                                                unsigned int  ) ))0,
    (unsigned int (*)(struct file * , struct poll_table_struct * ))0, & ibwdt_ioctl,
    (long (*)(struct file * , unsigned int  , unsigned long  ))0, (long (*)(struct file * ,
                                                                            unsigned int  ,
                                                                            unsigned long  ))0,
    (int (*)(struct file * , struct vm_area_struct * ))0, & ibwdt_open, (int (*)(struct file * ))0,
    & ibwdt_close, (int (*)(struct file * , struct dentry * , int datasync ))0, (int (*)(int  ,
                                                                                         struct file * ,
                                                                                         int  ))0,
...
#line 267 "ib700wdt.c"
static struct miscdevice ibwdt_miscdev  =    {130, "watchdog", (struct file_operations *)(& ibwdt_fops)};
#line 278 "ib700wdt.c"
static struct notifier_block ibwdt_notifier  =    {& ibwdt_notify_sys, (struct notifier_block *)0, 0};
#line 282 "ib700wdt.c"
...
#line 296
  tmp = request_region(1089UL, 1UL, "IB700 WDT");
#line 296
  if (! tmp) {
#line 297
...
#line 303
  tmp___0 = request_region(1091UL, 1UL, "IB700 WDT");
#line 303
  if (! tmp___0) {
#line 304
...
#line 338 "ib700wdt.c"
int (*_ddv_tmp_init)(void)  =    & ibwdt_init;
#line 339 "ib700wdt.c"
...
#line 341
  {      (char )'C',      (char )'h',      (char )'a',      (char )'r', 
        ...
        (char )'h',      (char )'o',      (char )'w',      (char )'e', 
        (char )'s',      (char )'@',      (char )'v',      (char )'s', 
        (char )'o',      (char )'l',      (char )'.',      (char )'n', 
        (char )'e',      (char )'t',      (char )'>',      (char )'\000'};
#line 342 "ib700wdt.c"
char _ddv_module_description[26]  = 
#line 342
  {      (char )'I',      (char )'B',      (char )'7',      (char )'0', 
        (char )'0',      (char )' ',      (char )'S',      (char )'B', 
        (char )'C',      (char )' ',      (char )'w',      (char )'a', 
        (char )'t',      (char )'c',      (char )'h',      (char )'d', 
        (char )'o',      (char )'g',      (char )' ',      (char )'d', 
...
#line 1 "manage.o"
#pragma merger("0","/tmp/cil-IZ6p7IXv.i","")
...
#line 1 "misc.o"
#pragma merger("0","/tmp/cil-DQW6vNXE.i","")
...
#line 1 "mutex.o"
#pragma merger("0","/tmp/cil-jQAoHgzf.i","")
...
#line 1 "page_alloc.o"
#pragma merger("0","/tmp/cil-EUOuMDoc.i","")
...
#line 1 "pci.o"
#pragma merger("0","/tmp/cil-zT8kgjds.i","")
...
#line 1 "resource.o"
#pragma merger("0","/tmp/cil-is7tZ29y.i","")
...
#line 1 "sched.o"
#pragma merger("0","/tmp/cil-03rTYC1H.i","")
...
#line 1 "semaphore.o"
#pragma merger("0","/tmp/cil-rcffFK8p.i","")
...
#line 1 "slab.o"
#pragma merger("0","/tmp/cil-Gcw8hjnb.i","")
...
#line 1 "softirq.o"
#pragma merger("0","/tmp/cil-PKjoRbVA.i","")
...
#line 1 "spinlock.o"
#pragma merger("0","/tmp/cil-HGhYoSbm.i","")
...
#line 1 "tasklet.o"
#pragma merger("0","/tmp/cil-sl6fTO2c.i","")
...
#line 1 "timer.o"
#pragma merger("0","/tmp/cil-ZOD7Ilyn.i","")
...
#line 1 "tty_io.o"
#pragma merger("0","/tmp/cil-WLULOdxC.i","")
...
#line 1 "usercopy.o"
#pragma merger("0","/tmp/cil-Hb1PnmMv.i","")
...
#line 1 "vmalloc.o"
#pragma merger("0","/tmp/cil-TRnuZ6gy.i","")
...
#line 1 "wait.o"
#pragma merger("0","/tmp/cil-a1apInVZ.i","")
...
#line 1 "workqueue.o"
#pragma merger("0","/tmp/cil-jdVCa8uk.i","")
