...
#line 150 "pcwd.c"
struct __anonstruct_pcwd_private_5 {
   char fw_ver_str[6] ;
   int revision ;
   int supports_temp ;
   int command_mode ;
...
#line 1 "cdev.o"
#pragma merger("0","/tmp/cil-dKZd4wkl.i","")
...
#line 1 "char_dev.o"
#pragma merger("0","/tmp/cil-lyJ2eY2f.i","")
...
#line 1 "ddverify.o"
#pragma merger("0","/tmp/cil-UQKNvpe0.i","")
...
#line 1 "genhd.o"
#pragma merger("0","/tmp/cil-DQoXJ7sT.i","")
...
#line 1 "interrupt.o"
#pragma merger("0","/tmp/cil-yACa_wl9.i","")
...
#line 1 "ioctl.o"
#pragma merger("0","/tmp/cil-hdLcMKot.i","")
#line 1 "ll_rw_blk.o"
#pragma merger("0","/tmp/cil-LPudsMVC.i","")
...
#line 1 "__main.o"
#pragma merger("0","/tmp/cil-kpYOcNHG.i","")
...
#line 57 "/usr/local/ddv/models/con2/include/asm/atomic.h"
...
#line 81 "/usr/local/ddv/models/con2/include/asm/atomic.h"
...
#line 8 "/usr/local/ddv/models/con2/include/linux/string.h"
...
#line 196
  udelay(1000);
#line 198
  tmp = inb_p((unsigned int )pcwd_private.io_addr);
#line 198
  port0 = (int )tmp;
#line 199
  i = 0;
...
#line 200
    last_port0 = port0;
#line 201
    tmp___0 = inb_p((unsigned int )pcwd_private.io_addr);
#line 201
    port0 = (int )tmp___0;
#line 203
    if (port0 == last_port0) {
...
#line 261 "pcwd.c"
__inline static void pcwd_check_temperature_support(void) 
{ 
  unsigned char tmp ;

  {
#line 263
  tmp = inb((unsigned int )pcwd_private.io_addr);
#line 263
  if ((int )tmp != 240) {
#line 264
...
#line 267 "pcwd.c"
__inline static void pcwd_get_firmware(void) 
{ 
  int one ;
  int ten ;
  int hund ;
...
#line 285 "pcwd.c"
__inline static int pcwd_get_option_switches(void) 
{ 
  int option_switches ;
  int tmp ;
...
#line 310
    printk("<6>pcwd: Option switches (0x%02x): Temperature Reset Enable=%s, Power On Delay=%s\n",
           option_switches, tmp___0, tmp);
#line 316
    tmp___1 = set_command_mode();
#line 316
    if (tmp___1) {
#line 317
      send_isa_command(10);
...
#line 325
  if (pcwd_private.boot_status & 32) {
#line 326
    printk("<6>pcwd: Previous reboot was caused by the card\n");
  }
#line 328
  if (pcwd_private.boot_status & 1) {
#line 329
...
{ 
  ...
  {
#line 343
  if ((long )jiffies - (long )pcwd_private.next_heartbeat < 0L) {
#line 345
    spin_lock(& pcwd_private.io_lock);
#line 346
    if (pcwd_private.revision == 1) {
...
#line 359
    mod_timer(& pcwd_private.timer, jiffies + 51UL);
#line 361
    spin_unlock(& pcwd_private.io_lock);
  } else {
#line 363
...
{ 
  ...
  {
#line 371
  pcwd_private.next_heartbeat = jiffies + (unsigned long )(heartbeat * 100);
#line 374
  mod_timer(& pcwd_private.timer, jiffies + 51UL);
#line 377
  if (pcwd_private.revision == 2) {
...
#line 380
    udelay(1000);
#line 381
    tmp = inb_p((unsigned int )(pcwd_private.io_addr + 2));
#line 381
    stat_reg = (int )tmp;
#line 382
    spin_unlock(& pcwd_private.io_lock);
...
#line 458
    tmp = inb((unsigned int )pcwd_private.io_addr);
#line 458
    control_status = (int )tmp;
  } else {
#line 465
    tmp___0 = inb((unsigned int )(pcwd_private.io_addr + 1));
#line 465
    control_status = (int )tmp___0;
  }
#line 467
  spin_unlock(& pcwd_private.io_lock);
#line 469
...
#line 508
    tmp = inb_p((unsigned int )(pcwd_private.io_addr + 1));
#line 508
    control_status = (int )tmp;
#line 510
    if (debug >= 2) {
...
#line 562
static int pcwd_ioctl(struct inode *inode , struct file *file , unsigned int cmd ,
                      unsigned long arg ) ;
#line 562 "pcwd.c"
static struct watchdog_info ident  =    {(__u32 )33185, (__u32 )1, {(__u8 )'P', (__u8 )'C', (__u8 )'W', (__u8 )'D', (__u8 )'\000'}};
#line 554 "pcwd.c"
static int pcwd_ioctl(struct inode *inode , struct file *file , unsigned int cmd ,
                      unsigned long arg ) 
{ 
...
#line 577
  tmp = copy_to_user((void *)argp, (void const   *)(& ident), sizeof(ident));
#line 577
  if (tmp) {
#line 578
    return (-14);
...
#line 583
  tmp___0 = put_user(status, (void *)argp);
#line 583
  return (tmp___0);
  case (unsigned int )((unsigned long )(((2U << 30) | (unsigned int )(87 << 8)) | 2U) | (sizeof(int ) << 16)): 
#line 586
  tmp___1 = put_user(pcwd_private.boot_status, (void *)argp);
#line 586
  return (tmp___1);
  case (unsigned int )((unsigned long )(((2U << 30) | (unsigned int )(87 << 8)) | 3U) | (sizeof(int ) << 16)): 
#line 589
  tmp___2 = pcwd_get_temperature(& temperature);
#line 589
  if (tmp___2) {
#line 590
    return (-14);
...
#line 592
  tmp___3 = put_user(temperature, (void *)argp);
#line 592
  return (tmp___3);
...
#line 595
  if (pcwd_private.revision == 2) {
#line 597
    tmp___4 = copy_from_user((void *)(& rv), (void *)argp, sizeof(int ));
#line 597
    if (tmp___4) {
#line 598
      return (-14);
...
#line 622
  tmp___7 = get_user(new_heartbeat, (void *)argp);
#line 622
  if (tmp___7) {
#line 623
    return (-14);
...
#line 625
  tmp___8 = pcwd_set_heartbeat(new_heartbeat);
#line 625
  if (tmp___8) {
#line 626
    return (-22);
...
#line 632
  tmp___9 = put_user(heartbeat, (void *)argp);
#line 632
  return (tmp___9);
  }
#line 635
...
#line 638 "pcwd.c"
static ssize_t pcwd_write(struct file *file , char const   *buf , size_t len , loff_t *ppos ) 
{ 
  size_t i ;
  char c ;
  int tmp ;
...
{ 
  ...
  {
#line 664
  tmp = atomic_dec_and_test(& open_allowed);
#line 664
  if (! tmp) {
#line 665
    if (debug >= 1) {
...
#line 697 "pcwd.c"
static ssize_t pcwd_temp_read(struct file *file , char *buf , size_t count , loff_t *ppos ) 
{ 
  int temperature ;
  int tmp ;
  ...
  {
#line 702
  tmp = pcwd_get_temperature(& temperature);
#line 702
  if (tmp) {
#line 703
    return (-14);
...
#line 705
  tmp___0 = copy_to_user((void *)buf, (void const   *)(& temperature), 1UL);
#line 705
  if (tmp___0) {
#line 706
    return (-14);
...
#line 742 "pcwd.c"
static struct file_operations  const  pcwd_fops  = 
#line 742
     {(struct module *)0, & no_llseek, (ssize_t (*)(struct file * , char * , size_t  ,
                                                  loff_t * ))0, & pcwd_write, (int (*)(struct file * ,
                                                                                       void * ,
                                                                                       int (*)(void * ,
                                                                                               char const   * ,
                                                                                               int  ,
                                                                                               ...
                                                                                               ino_t  ,
                                                                                               unsigned int  ) ))0,
    (unsigned int (*)(struct file * , struct poll_table_struct * ))0, & pcwd_ioctl,
    (long (*)(struct file * , unsigned int  , unsigned long  ))0, (long (*)(struct file * ,
                                                                            unsigned int  ,
                                                                            unsigned long  ))0,
    (int (*)(struct file * , struct vm_area_struct * ))0, & pcwd_open, (int (*)(struct file * ))0,
    & pcwd_close, (int (*)(struct file * , struct dentry * , int datasync ))0, (int (*)(int  ,
                                                                                        struct file * ,
                                                                                        int  ))0,
...
#line 751 "pcwd.c"
static struct miscdevice pcwd_miscdev  =    {130, "watchdog", (struct file_operations *)(& pcwd_fops)};
#line 757 "pcwd.c"
static struct file_operations  const  pcwd_temp_fops  = 
#line 757
     {(struct module *)0, & no_llseek, & pcwd_temp_read, (ssize_t (*)(struct file * ,
                                                                    char const   * ,
                                                                    size_t  , loff_t * ))0,
    ...
    (long (*)(struct file * , unsigned int  , unsigned long  ))0, (long (*)(struct file * ,
                                                                            unsigned int  ,
                                                                            unsigned long  ))0,
    (int (*)(struct file * , struct vm_area_struct * ))0, & pcwd_temp_open, (int (*)(struct file * ))0,
    & pcwd_temp_close, (int (*)(struct file * , struct dentry * , int datasync ))0,
    ...
    (int (*)(struct file * , int  , struct file_lock * ))0, (int (*)(struct inode * ))0};
#line 765 "pcwd.c"
static struct miscdevice temp_miscdev  =    {131, "temperature", (struct file_operations *)(& pcwd_temp_fops)};
#line 771 "pcwd.c"
static struct notifier_block pcwd_notifier  =    {& pcwd_notify_sys, (struct notifier_block *)0, 0};
#line 779 "pcwd.c"
__inline static int get_revision(void) 
{ 
  int r ;
  unsigned char tmp ;
  unsigned char tmp___0 ;
...
#line 783
  spin_lock(& pcwd_private.io_lock);
#line 786
  tmp = inb((unsigned int )(pcwd_private.io_addr + 2));
#line 786
  if ((int )tmp == 255) {
#line 788
    r = 1;
...
#line 786
    tmp___0 = inb((unsigned int )(pcwd_private.io_addr + 3));
#line 786
    if ((int )tmp___0 == 255) {
#line 788
      r = 1;
...
#line 794 "pcwd.c"
static int pcwatchdog_init(int base_addr ) 
{ 
  int ret ;
  int tmp ;
...
#line 816
  tmp___0 = request_region((unsigned long )pcwd_private.io_addr, (unsigned long )tmp,
                           "PCWD");
#line 816
  if (! tmp___0) {
#line 817
...
#line 845
  pcwd_show_card_info();
#line 848
  tmp___1 = pcwd_set_heartbeat(heartbeat);
#line 848
  if (tmp___1) {
#line 849
...
#line 858
    release_region((unsigned long )pcwd_private.io_addr, (unsigned long )tmp___2);
#line 859
    pcwd_private.io_addr = 0;
#line 860
    return (ret);
...
#line 869
      release_region((unsigned long )pcwd_private.io_addr, (unsigned long )tmp___3);
#line 870
      pcwd_private.io_addr = 0;
#line 871
      return (ret);
...
#line 882
    release_region((unsigned long )pcwd_private.io_addr, (unsigned long )tmp___4);
#line 883
    pcwd_private.io_addr = 0;
#line 884
    return (ret);
...
#line 904
  release_region((unsigned long )pcwd_private.io_addr, (unsigned long )tmp);
#line 905
  pcwd_private.io_addr = 0;
#line 906
  cards_found --;
...
#line 916 "pcwd.c"
static int pcwd_checkcard(int base_addr ) 
{ 
  int port0 ;
  int last_port0 ;
  int port1 ;
  ...
  {
#line 923
  tmp = request_region((unsigned long )base_addr, 4UL, "PCWD");
#line 923
  if (! tmp) {
#line 924
...
#line 928
  retval = 0;
#line 930
  tmp___0 = inb_p((unsigned int )base_addr);
#line 930
  port0 = (int )tmp___0;
#line 931
  tmp___1 = inb_p((unsigned int )(base_addr + 1));
#line 931
  port1 = (int )tmp___1;
#line 932
  if (port0 != 255) {
...
#line 939
      last_port1 = port1;
#line 941
      tmp___2 = inb_p((unsigned int )base_addr);
#line 941
      port0 = (int )tmp___2;
#line 942
      tmp___3 = inb_p((unsigned int )(base_addr + 1));
#line 942
      port1 = (int )tmp___3;
#line 945
      if ((port0 ^ last_port0) & 4) {
#line 947
        retval = 1;
#line 948
        break;
...
#line 952
  release_region((unsigned long )base_addr, 4UL);
#line 954
  return (retval);
}
}
#line 963 "pcwd.c"
static int pcwd_ioports[4]  = {      624,      848,      880,      0};
#line 965 "pcwd.c"
static int pcwd_init_module(void) 
{ 
  int i ;
  int found ;
  int tmp ;
...
#line 971
  i = 0;
#line 971
  while (pcwd_ioports[i] != 0) {
#line 972
    tmp___0 = pcwd_checkcard(pcwd_ioports[i]);
#line 972
    if (tmp___0) {
#line 973
      tmp = pcwatchdog_init(pcwd_ioports[i]);
#line 973
      if (! tmp) {
#line 974
        found ++;
...
#line 994 "pcwd.c"
int (*_ddv_tmp_init)(void)  =    & pcwd_init_module;
#line 995 "pcwd.c"
void (*_ddv_tmp_exit)(void)  =    & pcwd_cleanup_module;
#line 997 "pcwd.c"
char _ddv_module_author[31]  = 
#line 997
  {      (char )'K',      (char )'e',      (char )'n',      (char )' ', 
        (char )'H',      (char )'o',      (char )'l',      (char )'l', 
        (char )'i',      (char )'s',      (char )' ',      (char )'<', 
        (char )'k',      (char )'e',      (char )'n',      (char )'j', 
        (char )'i',      (char )'@',      (char )'b',      (char )'i', 
        (char )'t',      (char )'g',      (char )'a',      (char )'t', 
        (char )'e',      (char )'.',      (char )'c',      (char )'o', 
        (char )'m',      (char )'>',      (char )'\000'};
#line 998 "pcwd.c"
char _ddv_module_description[33]  = 
#line 998
  {      (char )'B',      (char )'e',      (char )'r',      (char )'k', 
        (char )'s',      (char )'h',      (char )'i',      (char )'r', 
        (char )'e',      (char )' ',      (char )'I',      (char )'S', 
        (char )'A',      (char )'-',      (char )'P',      (char )'C', 
        (char )' ',      (char )'W',      (char )'a',      (char )'t', 
        (char )'c',      (char )'h',      (char )'d',      (char )'o', 
        (char )'g',      (char )' ',      (char )'d',      (char )'r', 
        (char )'i',      (char )'v',      (char )'e',      (char )'r', 
        (char )'\000'};
#line 999 "pcwd.c"
...
#line 1 "manage.o"
#pragma merger("0","/tmp/cil-mn0dMmsD.i","")
...
#line 1 "misc.o"
#pragma merger("0","/tmp/cil-MLVZrEG6.i","")
...
#line 1 "mutex.o"
#pragma merger("0","/tmp/cil-JcXT6k0a.i","")
...
#line 1 "page_alloc.o"
#pragma merger("0","/tmp/cil-Pb6ivQ1H.i","")
...
#line 1 "pci.o"
#pragma merger("0","/tmp/cil-lYMvRhPe.i","")
...
#line 1 "resource.o"
#pragma merger("0","/tmp/cil-5B1869iA.i","")
...
#line 1 "sched.o"
#pragma merger("0","/tmp/cil-AIK4nxMF.i","")
...
#line 1 "semaphore.o"
#pragma merger("0","/tmp/cil-AK2RW35x.i","")
...
#line 1 "slab.o"
#pragma merger("0","/tmp/cil-0o2FX9uf.i","")
...
#line 1 "softirq.o"
#pragma merger("0","/tmp/cil-bKQmEdy6.i","")
...
#line 1 "spinlock.o"
#pragma merger("0","/tmp/cil-oPZpDPyO.i","")
...
#line 1 "tasklet.o"
#pragma merger("0","/tmp/cil-VJPvsCXz.i","")
...
#line 1 "timer.o"
#pragma merger("0","/tmp/cil-nKDWjYCt.i","")
...
#line 1 "tty_io.o"
#pragma merger("0","/tmp/cil-o6la8Iff.i","")
...
#line 1 "usercopy.o"
#pragma merger("0","/tmp/cil-pem78v54.i","")
...
#line 1 "vmalloc.o"
#pragma merger("0","/tmp/cil-ZR0ukswx.i","")
...
#line 1 "wait.o"
#pragma merger("0","/tmp/cil-daUs3MnY.i","")
...
#line 1 "workqueue.o"
#pragma merger("0","/tmp/cil-jcVASHJU.i","")
