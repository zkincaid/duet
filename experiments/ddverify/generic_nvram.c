...
#line 1 "cdev.o"
#pragma merger("0","/tmp/cil-Tifzl9Nu.i","")
...
#line 1 "char_dev.o"
#pragma merger("0","/tmp/cil-ohdPev3h.i","")
...
#line 1 "ddverify.o"
#pragma merger("0","/tmp/cil-Lbhh2uyU.i","")
...
#line 1 "genhd.o"
#pragma merger("0","/tmp/cil-ZExL4G5Q.i","")
...
#line 1 "interrupt.o"
#pragma merger("0","/tmp/cil-pPBA5wpj.i","")
...
#line 1 "ioctl.o"
#pragma merger("0","/tmp/cil-n89vrk91.i","")
#line 1 "ll_rw_blk.o"
#pragma merger("0","/tmp/cil-gnU1bqN5.i","")
...
#line 1 "__main.o"
#pragma merger("0","/tmp/cil-8OMWAtyU.i","")
...
#line 64
extern int ( /* missing proto */  nvram_read_byte)() ;
#line 53 "generic_nvram.c"
ssize_t read_nvram(struct file *file , char *buf , size_t count , loff_t *ppos ) 
{ 
  unsigned int i ;
  char *p ;
  int tmp ;
...
#line 57
  p = buf;
#line 59
  tmp = access_ok(1, (void const   *)buf, (unsigned long )count);
#line 59
  if (! tmp) {
#line 60
    return (-14);
...
#line 64
    tmp___0 = nvram_read_byte(i);
#line 64
    tmp___1 = __put_user(tmp___0, (void *)p);
#line 64
    if (tmp___1) {
#line 65
      return (-14);
...
#line 84
extern int ( /* missing proto */  nvram_write_byte)() ;
#line 70 "generic_nvram.c"
ssize_t write_nvram(struct file *file , char const   *buf , size_t count , loff_t *ppos ) 
{ 
  unsigned int i ;
  char const   *p ;
  char c ;
...
#line 74
  p = buf;
#line 77
  tmp = access_ok(0, (void const   *)buf, (unsigned long )count);
#line 77
  if (! tmp) {
#line 78
    return (-14);
...
#line 82
    tmp___0 = __get_user((int )c, (void *)p);
#line 82
    if (tmp___0) {
#line 83
      return (-14);
...
#line 113
extern int ( /* missing proto */  nvram_sync)() ;
#line 90 "generic_nvram.c"
int nvram_ioctl(struct inode *inode , struct file *file , unsigned int cmd , unsigned long arg ) 
{ 
...
#line 122 "generic_nvram.c"
struct file_operations nvram_fops  = 
#line 122
     {(struct module *)0, & nvram_llseek, & read_nvram, & write_nvram, (int (*)(struct file * ,
                                                                              void * ,
                                                                              int (*)(void * ,
                                                                                      char const   * ,
                                                                                      int  ,
                                                                                      ...
                                                                                      ino_t  ,
                                                                                      unsigned int  ) ))0,
    (unsigned int (*)(struct file * , struct poll_table_struct * ))0, & nvram_ioctl,
...
#line 130 "generic_nvram.c"
struct miscdevice nvram_dev  =    {144, "nvram", & nvram_fops};
#line 136 "generic_nvram.c"
int nvram_init(void) 
{ 
  int tmp ;
...
#line 140
  tmp = misc_register(& nvram_dev);
#line 140
  return (tmp);
}
}
#line 143 "generic_nvram.c"
...
#line 148 "generic_nvram.c"
int (*_ddv_tmp_init)(void)  =    & nvram_init;
#line 149 "generic_nvram.c"
void (*_ddv_tmp_exit)(void)  =    & nvram_cleanup;
#line 150 "generic_nvram.c"
...
#line 1 "manage.o"
#pragma merger("0","/tmp/cil-So22djNC.i","")
...
#line 1 "misc.o"
#pragma merger("0","/tmp/cil-YzRQfrV5.i","")
...
#line 1 "mutex.o"
#pragma merger("0","/tmp/cil-jaDQphXd.i","")
...
#line 1 "page_alloc.o"
#pragma merger("0","/tmp/cil-SFfjAlYu.i","")
...
#line 1 "pci.o"
#pragma merger("0","/tmp/cil-IXojAoJ2.i","")
...
#line 1 "resource.o"
#pragma merger("0","/tmp/cil-Mlk56fzS.i","")
...
#line 1 "sched.o"
#pragma merger("0","/tmp/cil-Eatd5af0.i","")
...
#line 1 "semaphore.o"
#pragma merger("0","/tmp/cil-2Sirtngq.i","")
...
#line 1 "slab.o"
#pragma merger("0","/tmp/cil-AzUAAlbr.i","")
...
#line 1 "softirq.o"
#pragma merger("0","/tmp/cil-a4DtaKXT.i","")
...
#line 1 "spinlock.o"
#pragma merger("0","/tmp/cil-INd45pnW.i","")
...
#line 1 "tasklet.o"
#pragma merger("0","/tmp/cil-J4FE1lI5.i","")
...
#line 1 "timer.o"
#pragma merger("0","/tmp/cil-rzfyCLQK.i","")
...
#line 1 "tty_io.o"
#pragma merger("0","/tmp/cil-NPuh5Etn.i","")
...
#line 1 "usercopy.o"
#pragma merger("0","/tmp/cil-CEzOCkKw.i","")
...
#line 21 "/usr/local/ddv/models/con2/src/linux/arch/i386/lib/usercopy.c"
int __put_user(int size , void *ptr ) 
{ 
  int tmp ;
...
#line 1 "vmalloc.o"
#pragma merger("0","/tmp/cil-q8KnoX8G.i","")
...
#line 1 "wait.o"
#pragma merger("0","/tmp/cil-gGtecHwG.i","")
...
#line 1 "workqueue.o"
#pragma merger("0","/tmp/cil-c1HZduRQ.i","")
