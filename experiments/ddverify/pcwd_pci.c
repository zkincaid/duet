...
#line 106 "pcwd_pci.c"
struct __anonstruct_pcipcwd_private_5 {
   int supports_temp ;
   int boot_status ;
...
#line 1 "cdev.o"
#pragma merger("0","/tmp/cil-HgNAMDDl.i","")
...
#line 1 "char_dev.o"
#pragma merger("0","/tmp/cil-xxwVYkKG.i","")
...
#line 1 "ddverify.o"
#pragma merger("0","/tmp/cil-JmYLTYc2.i","")
...
#line 1 "genhd.o"
#pragma merger("0","/tmp/cil-eWRtyv9o.i","")
...
#line 1 "interrupt.o"
#pragma merger("0","/tmp/cil-wsUA4k1w.i","")
...
#line 1 "ioctl.o"
#pragma merger("0","/tmp/cil-p0JenNL6.i","")
#line 1 "ll_rw_blk.o"
#pragma merger("0","/tmp/cil-nuGTR4z2.i","")
...
#line 1 "__main.o"
#pragma merger("0","/tmp/cil-rSsYT4Tx.i","")
...
#line 106 "pcwd_pci.c"
static struct __anonstruct_pcipcwd_private_5 pcipcwd_private  ;
#line 118 "pcwd_pci.c"
static int debug  =    0;
#line 120 "pcwd_pci.c"
...
#line 120
  {      (char )'D',      (char )'e',      (char )'b',      (char )'u', 
        ...
        (char )'\000'};
#line 123 "pcwd_pci.c"
static int heartbeat  =    2;
#line 125 "pcwd_pci.c"
char _ddv_module_param_heartbeat[79]  = 
#line 125
  {      (char )'W',      (char )'a',      (char )'t',      (char )'c', 
        ...
        (char )'0',      (char )'<',      (char )'h',      (char )'e', 
        (char )'a',      (char )'r',      (char )'t',      (char )'b', 
        (char )'e',      (char )'a',      (char )'t',      (char )'<', 
        (char )'6',      (char )'5',      (char )'5',      (char )'3', 
        (char )'6',      (char )',',      (char )' ',      (char )'d', 
        (char )'e',      (char )'f',      (char )'a',      (char )'u', 
        (char )'l',      (char )'t',      (char )'=',      (char )'W', 
        (char )'A',      (char )'T',      (char )'C',      (char )'H', 
        (char )'D',      (char )'O',      (char )'G',      (char )'_', 
        (char )'H',      (char )'E',      (char )'A',      (char )'R', 
        (char )'T',      (char )'B',      (char )'E',      (char )'A', 
...
#line 150
  outb_p((unsigned char )*lsb, (unsigned int )(pcipcwd_private.io_addr + 4UL));
#line 151
  outb_p((unsigned char )*msb, (unsigned int )(pcipcwd_private.io_addr + 5UL));
#line 152
  outb_p((unsigned char )cmd, (unsigned int )(pcipcwd_private.io_addr + 6UL));
#line 157
  tmp = inb_p((unsigned int )(pcipcwd_private.io_addr + 2UL));
#line 157
  got_response = (int )tmp & 64;
#line 158
  count = 0;
#line 158
  while (1) {
...
#line 160
    tmp___0 = inb_p((unsigned int )(pcipcwd_private.io_addr + 2UL));
#line 160
    got_response = (int )tmp___0 & 64;
#line 158
    count ++;
  }
#line 163
...
#line 172
  if (got_response) {
#line 174
    tmp___1 = inb_p((unsigned int )(pcipcwd_private.io_addr + 4UL));
#line 174
    *lsb = (int )tmp___1;
#line 175
    tmp___2 = inb_p((unsigned int )(pcipcwd_private.io_addr + 5UL));
#line 175
    *msb = (int )tmp___2;
#line 178
    inb_p((unsigned int )(pcipcwd_private.io_addr + 6UL));
#line 180
    if (debug >= 2) {
#line 181
...
#line 190 "pcwd_pci.c"
__inline static void pcipcwd_check_temperature_support(void) 
{ 
  unsigned char tmp ;

  {
#line 192
  tmp = inb_p((unsigned int )pcipcwd_private.io_addr);
#line 192
  if ((int )tmp != 240) {
#line 193
...
{ 
  ...
  {
#line 200
  tmp = inb_p((unsigned int )(pcipcwd_private.io_addr + 3UL));
#line 200
  option_switches = (int )tmp;
#line 201
...
#line 220
  printk("<6>pcwd_pci: Found card at port 0x%04x (Firmware: %s) %s temp option\n",
         (int )pcipcwd_private.io_addr, fw_ver_str, tmp);
#line 224
...
#line 224
  printk("<6>pcwd_pci: Option switches (0x%02x): Temperature Reset Enable=%s, Power On Delay=%s\n",
         option_switches, tmp___1, tmp___0);
#line 229
  if (pcipcwd_private.boot_status & 32) {
#line 230
    printk("<6>pcwd_pci: Previous reset was caused by the Watchdog card\n");
  }
#line 232
  if (pcipcwd_private.boot_status & 1) {
#line 233
...
#line 243
  spin_lock(& pcipcwd_private.io_lock);
#line 244
  outb_p((unsigned char)0, (unsigned int )(pcipcwd_private.io_addr + 3UL));
#line 245
  udelay(1000);
#line 247
  tmp = inb_p((unsigned int )(pcipcwd_private.io_addr + 2UL));
...
#line 265
  spin_lock(& pcipcwd_private.io_lock);
#line 266
  outb_p((unsigned char)165, (unsigned int )(pcipcwd_private.io_addr + 3UL));
#line 267
  udelay(1000);
#line 269
  outb_p((unsigned char)165, (unsigned int )(pcipcwd_private.io_addr + 3UL));
...
#line 327
extern int ( /* missing proto */  panic)() ;
#line 316 "pcwd_pci.c"
...
#line 320
  *status = 0;
#line 321
  tmp = inb_p((unsigned int )(pcipcwd_private.io_addr + 1UL));
#line 321
...
#line 326
    if (temp_panic) {
#line 327
      panic("pcwd_pci: Temperature overheat trip!\n");
    }
  }
#line 330
  if (debug >= 2) {
...
#line 355
  outb_p((unsigned char )((control_status & 64) | 1), (unsigned int )(pcipcwd_private.io_addr + 1UL));
#line 358
  msb = 0;
#line 359
  reset_counter = 255;
...
#line 414 "pcwd_pci.c"
static ssize_t pcipcwd_write(struct file *file , char const   *data , size_t len ,
                             loff_t *ppos ) 
{ 
  size_t i ;
  char c ;
...
static int pcipcwd_ioctl(struct inode *inode , struct file *file , unsigned int cmd ,
                         unsigned long arg ) ;
#line 447 "pcwd_pci.c"
static struct watchdog_info ident  =    {(__u32 )33185, (__u32 )1, {(__u8 )'P', (__u8 )'C', (__u8 )'I', (__u8 )'-', (__u8 )'P',
                               (__u8 )'C', (__u8 )' ', (__u8 )'W', (__u8 )'a', (__u8 )'t',
...
#line 459
  tmp___1 = copy_to_user(argp, (void const   *)(& ident), sizeof(ident));
#line 459
  if (tmp___1) {
#line 459
    tmp___0 = -14;
...
#line 481
  tmp___5 = put_user(temperature, (void *)p);
#line 481
  return (tmp___5);
...
#line 490
  retval = -22;
#line 492
  tmp___6 = get_user(new_options, (void *)p);
#line 492
  if (tmp___6) {
#line 493
    return (-14);
...
#line 519
  tmp___9 = get_user(new_heartbeat, (void *)p);
#line 519
  if (tmp___9) {
#line 520
    return (-14);
...
#line 522
  tmp___10 = pcipcwd_set_heartbeat(new_heartbeat);
#line 522
  if (tmp___10) {
#line 523
    return (-22);
...
#line 530
  tmp___11 = put_user(heartbeat, (void *)p);
#line 530
  return (tmp___11);
  case (unsigned int )((unsigned long )(((2U << 30) | (unsigned int )(87 << 8)) | 10U) | (sizeof(int ) << 16)): 
#line 536
  tmp___12 = pcipcwd_get_timeleft(& time_left);
#line 536
  if (tmp___12) {
#line 537
    return (-14);
...
#line 539
  tmp___13 = put_user(time_left, (void *)p);
#line 539
  return (tmp___13);
  default: 
#line 543
...
{ 
  ...
  {
#line 550
  tmp = test_and_set_bit(0, & is_active);
#line 550
  if (tmp) {
#line 551
    if (debug >= 1) {
...
#line 573
  expect_release = (char)0;
#line 574
  clear_bit(0, (unsigned long volatile   *)(& is_active));
#line 575
  return (0);
}
}
#line 582 "pcwd_pci.c"
static ssize_t pcipcwd_temp_read(struct file *file , char *data , size_t len , loff_t *ppos ) 
{ 
  int temperature ;
  int tmp ;
  ...
  {
#line 587
  tmp = pcipcwd_get_temperature(& temperature);
#line 587
  if (tmp) {
#line 588
    return (-14);
...
#line 590
  tmp___0 = copy_to_user((void *)data, (void const   *)(& temperature), 1UL);
#line 590
  if (tmp___0) {
#line 591
    return (-14);
...
#line 627 "pcwd_pci.c"
static struct file_operations  const  pcipcwd_fops  = 
#line 627
     {(struct module *)0, & no_llseek, (ssize_t (*)(struct file * , char * , size_t  ,
                                                  loff_t * ))0, & pcipcwd_write, (int (*)(struct file * ,
                                                                                          void * ,
                                                                                          int (*)(void * ,
                                                                                                  char const   * ,
                                                                                                  int  ,
                                                                                                  ...
                                                                                                  ino_t  ,
                                                                                                  unsigned int  ) ))0,
    (unsigned int (*)(struct file * , struct poll_table_struct * ))0, & pcipcwd_ioctl,
    (long (*)(struct file * , unsigned int  , unsigned long  ))0, (long (*)(struct file * ,
                                                                            unsigned int  ,
                                                                            unsigned long  ))0,
    (int (*)(struct file * , struct vm_area_struct * ))0, & pcipcwd_open, (int (*)(struct file * ))0,
    & pcipcwd_release, (int (*)(struct file * , struct dentry * , int datasync ))0,
...
#line 636 "pcwd_pci.c"
static struct miscdevice pcipcwd_miscdev  =    {130, "watchdog", (struct file_operations *)(& pcipcwd_fops)};
#line 642 "pcwd_pci.c"
static struct file_operations  const  pcipcwd_temp_fops  = 
#line 642
     {(struct module *)0, & no_llseek, & pcipcwd_temp_read, (ssize_t (*)(struct file * ,
                                                                       char const   * ,
                                                                       size_t  , loff_t * ))0,
    ...
    (long (*)(struct file * , unsigned int  , unsigned long  ))0, (long (*)(struct file * ,
                                                                            unsigned int  ,
                                                                            unsigned long  ))0,
    (int (*)(struct file * , struct vm_area_struct * ))0, & pcipcwd_temp_open, (int (*)(struct file * ))0,
    & pcipcwd_temp_release, (int (*)(struct file * , struct dentry * , int datasync ))0,
    (int (*)(int  , struct file * , int  ))0, (int (*)(struct file * , int  , struct file_lock * ))0,
    (ssize_t (*)(struct file * , struct iovec  const  * , unsigned long  , loff_t * ))0,
    (ssize_t (*)(struct file * , struct iovec  const  * , unsigned long  , loff_t * ))0,
    (ssize_t (*)(struct file * , loff_t * , size_t  , int (*)(read_descriptor_t * ,
    ...
    (int (*)(struct file * , int  , struct file_lock * ))0, (int (*)(struct inode * ))0};
#line 650 "pcwd_pci.c"
static struct miscdevice pcipcwd_temp_miscdev  =    {131, "temperature", (struct file_operations *)(& pcipcwd_temp_fops)};
#line 656 "pcwd_pci.c"
static struct notifier_block pcipcwd_notifier  =    {& pcipcwd_notify_sys, (struct notifier_block *)0, 0};
#line 664 "pcwd_pci.c"
int pcipcwd_card_init(struct pci_dev *pdev , struct pci_device_id  const  *ent ) 
{ 
  int ret ;
  int tmp ;
  int tmp___0 ;
...
#line 690
  pcipcwd_private.io_addr = pdev->resource[0].start;
#line 692
  tmp___0 = pci_request_regions(pdev, "pcwd_pci");
#line 692
  if (tmp___0) {
#line 693
...
#line 715
  tmp___1 = pcipcwd_set_heartbeat(heartbeat);
#line 715
  if (tmp___1) {
#line 716
...
#line 777 "pcwd_pci.c"
static struct pci_device_id pcipcwd_pci_tbl[2]  = {      {(__u32 )4579, (__u32 )20528, (__u32 )(~ 0), (__u32 )(~ 0), 0U, 0U, 0UL}, 
        {(__u32 )0, 0U, 0U, 0U, 0U, 0U, 0UL}};
#line 784 "pcwd_pci.c"
static struct pci_driver pcipcwd_driver  = 
#line 784
     {(char *)"pcwd_pci", (struct pci_device_id  const  *)(pcipcwd_pci_tbl), & pcipcwd_card_init,
    & pcipcwd_card_exit, (int (*)(struct pci_dev *dev , pm_message_t state ))0, (int (*)(struct pci_dev *dev ))0,
    (int (*)(struct pci_dev *dev , pci_power_t state , int enable ))0, (void (*)(struct pci_dev *dev ))0};
#line 791 "pcwd_pci.c"
static int pcipcwd_init_module(void) 
{ 
  int tmp ;
...
#line 795
  tmp = pci_register_driver(& pcipcwd_driver);
#line 795
  return (tmp);
}
}
...
#line 803 "pcwd_pci.c"
int (*_ddv_tmp_init)(void)  =    & pcipcwd_init_module;
#line 804 "pcwd_pci.c"
void (*_ddv_tmp_exit)(void)  =    & pcipcwd_cleanup_module;
#line 806 "pcwd_pci.c"
char _ddv_module_author[33]  = 
#line 806
  {      (char )'W',      (char )'i',      (char )'m',      (char )' ', 
        (char )'V',      (char )'a',      (char )'n',      (char )' ', 
        (char )'S',      (char )'e',      (char )'b',      (char )'r', 
        (char )'o',      (char )'e',      (char )'c',      (char )'k', 
        (char )' ',      (char )'<',      (char )'w',      (char )'i', 
        (char )'m',      (char )'@',      (char )'i',      (char )'g', 
        (char )'u',      (char )'a',      (char )'n',      (char )'a', 
...
#line 807
  {      (char )'B',      (char )'e',      (char )'r',      (char )'k', 
        ...
        (char )'e',      (char )' ',      (char )'P',      (char )'C', 
        (char )'I',      (char )'-',      (char )'P',      (char )'C', 
...
#line 1 "manage.o"
#pragma merger("0","/tmp/cil-E4zmnRaU.i","")
...
#line 1 "misc.o"
#pragma merger("0","/tmp/cil-7__xYttn.i","")
...
#line 1 "mutex.o"
#pragma merger("0","/tmp/cil-WS1binVq.i","")
...
#line 1 "page_alloc.o"
#pragma merger("0","/tmp/cil-U2grJpgY.i","")
...
#line 1 "pci.o"
#pragma merger("0","/tmp/cil-yUeOOPQT.i","")
...
#line 1 "resource.o"
#pragma merger("0","/tmp/cil-4CffuKFe.i","")
...
#line 1 "sched.o"
#pragma merger("0","/tmp/cil-OcQjWJY4.i","")
...
#line 1 "semaphore.o"
#pragma merger("0","/tmp/cil-wKwAQSep.i","")
...
#line 1 "slab.o"
#pragma merger("0","/tmp/cil-EYzvDmAI.i","")
...
#line 1 "softirq.o"
#pragma merger("0","/tmp/cil-zlBGECo8.i","")
...
#line 1 "spinlock.o"
#pragma merger("0","/tmp/cil-aMRTBI5y.i","")
...
#line 1 "tasklet.o"
#pragma merger("0","/tmp/cil-QwGW73k3.i","")
...
#line 1 "timer.o"
#pragma merger("0","/tmp/cil-eGAz7btl.i","")
...
#line 1 "tty_io.o"
#pragma merger("0","/tmp/cil-iwcjBPj3.i","")
...
#line 1 "usercopy.o"
#pragma merger("0","/tmp/cil-2is7dHKk.i","")
...
#line 1 "vmalloc.o"
#pragma merger("0","/tmp/cil-yVVIeevY.i","")
...
#line 1 "wait.o"
#pragma merger("0","/tmp/cil-rj6YCYDY.i","")
...
#line 1 "workqueue.o"
#pragma merger("0","/tmp/cil-e0Muqdww.i","")
