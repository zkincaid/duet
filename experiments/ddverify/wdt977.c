...
#line 1 "cdev.o"
#pragma merger("0","/tmp/cil-U3t3a2zf.i","")
...
#line 1 "char_dev.o"
#pragma merger("0","/tmp/cil-oH75q3Lu.i","")
...
#line 1 "ddverify.o"
#pragma merger("0","/tmp/cil-YiryeOeH.i","")
...
#line 1 "genhd.o"
#pragma merger("0","/tmp/cil-BfCq0Usw.i","")
...
#line 1 "interrupt.o"
#pragma merger("0","/tmp/cil-GkkCjSA8.i","")
...
#line 1 "ioctl.o"
#pragma merger("0","/tmp/cil-ZPoecYd9.i","")
#line 1 "ll_rw_blk.o"
#pragma merger("0","/tmp/cil-J33rnJUg.i","")
...
#line 1 "__main.o"
#pragma merger("0","/tmp/cil-_8oZpOwP.i","")
...
#line 65 "wdt977.c"
char _ddv_module_param_timeout[66]  = 
#line 65
  {      (char )'W',      (char )'a',      (char )'t',      (char )'c', 
        ...
        (char )'(',      (char )'6',      (char )'0',      (char )'.', 
        (char )'.',      (char )'1',      (char )'5',      (char )'3', 
...
#line 84
  outb_p((unsigned char)135, 880U);
#line 85
  outb_p((unsigned char)135, 880U);
#line 93
  outb_p((unsigned char)7, 880U);
#line 94
  outb_p((unsigned char)8, 881U);
#line 95
  outb_p((unsigned char)242, 880U);
#line 96
  outb_p((unsigned char )timeoutM, 881U);
#line 97
  outb_p((unsigned char)243, 880U);
#line 98
  outb_p((unsigned char)0, 881U);
#line 99
  outb_p((unsigned char)244, 880U);
#line 100
  outb_p((unsigned char)0, 881U);
#line 104
  if (! testmode) {
#line 106
    outb_p((unsigned char)7, 880U);
#line 107
    outb_p((unsigned char)7, 881U);
#line 108
    outb_p((unsigned char)230, 880U);
#line 109
    outb_p((unsigned char)8, 881U);
  }
#line 113
  outb_p((unsigned char)170, 880U);
#line 115
  spin_unlock_irqrestore(& spinlock, flags);
#line 116
  printk("<6>Wdt977: activated.\n");
#line 118
  return (0);
}
}
...
#line 204
extern int ( /* missing proto */  machine_is_netwinder)() ;
#line 197 "wdt977.c"
...
#line 282
    wdt977_keepalive();
#line 283
    printk("<2>Wdt977: Unexpected close, not stopping watchdog!\n");
  }
#line 285
  expect_close = (char)0;
#line 286
...
#line 301 "wdt977.c"
static ssize_t wdt977_write(struct file *file , char const   *buf , size_t count ,
                            loff_t *ppos ) 
{ 
  size_t i ;
  char c ;
...
#line 340 "wdt977.c"
static struct watchdog_info ident  =    {(__u32 )33152, (__u32 )1, {(__u8 )'W', (__u8 )'d', (__u8 )'t', (__u8 )'9', (__u8 )'7',
                               (__u8 )'7', (__u8 )'\000'}};
#line 348 "wdt977.c"
...
#line 401
  tmp___6 = wdt977_set_timeout(new_timeout);
#line 401
  if (tmp___6) {
#line 402
    return (-22);
...
#line 413 "wdt977.c"
static int wdt977_notify_sys(struct notifier_block *this , unsigned long code , void *unused ) 
{ 
...
#line 421 "wdt977.c"
static struct file_operations  const  wdt977_fops  = 
#line 421
     {(struct module *)0, & no_llseek, (ssize_t (*)(struct file * , char * , size_t  ,
                                                  loff_t * ))0, & wdt977_write, (int (*)(struct file * ,
                                                                                         void * ,
                                                                                         int (*)(void * ,
                                                                                                 char const   * ,
                                                                                                 int  ,
                                                                                                 ...
                                                                                                 ino_t  ,
                                                                                                 unsigned int  ) ))0,
    (unsigned int (*)(struct file * , struct poll_table_struct * ))0, & wdt977_ioctl,
    (long (*)(struct file * , unsigned int  , unsigned long  ))0, (long (*)(struct file * ,
                                                                            unsigned int  ,
                                                                            unsigned long  ))0,
    (int (*)(struct file * , struct vm_area_struct * ))0, & wdt977_open, (int (*)(struct file * ))0,
    & wdt977_release, (int (*)(struct file * , struct dentry * , int datasync ))0,
...
#line 431 "wdt977.c"
static struct miscdevice wdt977_miscdev  =    {130, "watchdog", (struct file_operations *)(& wdt977_fops)};
#line 438 "wdt977.c"
static struct notifier_block wdt977_notifier  =    {& wdt977_notify_sys, (struct notifier_block *)0, 0};
#line 442 "wdt977.c"
static int wd977_init(void) 
{ 
  int rc ;
  int tmp ;
  ...
  {
#line 449
  printk("<6>Wdt977: Wdt977 driver, v0.04\n");
#line 451
  spin_lock_init(& spinlock);
#line 454
  tmp = wdt977_set_timeout(timeout);
#line 454
  if (tmp) {
#line 456
    wdt977_set_timeout(60);
#line 457
    printk("<6>Wdt977: timeout value must be 60<timeout<15300, using %d\n", 60);
  }
#line 464
  tmp___1 = machine_is_netwinder();
#line 464
  if (! tmp___1) {
#line 466
    tmp___0 = request_region(880UL, 2UL, "Wdt977");
#line 466
    if (! tmp___0) {
#line 468
      printk("<3>Wdt977: I/O address 0x%04x already in use\n", 880);
#line 470
      rc = -5;
#line 471
      goto err_out;
...
#line 476
  if (rc) {
#line 478
    printk("<3>Wdt977: cannot register miscdev on minor=%d (err=%d)\n", wdt977_miscdev.minor,
           rc);
#line 480
    goto err_out_region;
  }
...
#line 484
  if (rc) {
#line 486
    printk("<3>Wdt977: cannot register reboot notifier (err=%d)\n", rc);
#line 488
    goto err_out_miscdev;
  }
#line 491
  printk("<6>Wdt977: initialized. timeout=%d sec (nowayout=%d, testmode=%i)\n", timeout,
         nowayout, testmode);
#line 494
  return (0);
  err_out_miscdev: 
#line 497
  ...
  err_out_region: 
#line 499
  tmp___2 = machine_is_netwinder();
#line 499
  if (! tmp___2) {
#line 500
    release_region(880UL, 2UL);
  }
  err_out: 
#line 502
  return (rc);
...
#line 513 "wdt977.c"
int (*_ddv_tmp_init)(void)  =    & wd977_init;
#line 514 "wdt977.c"
void (*_ddv_tmp_exit)(void)  =    & wd977_exit;
#line 516 "wdt977.c"
char _ddv_module_author[36]  = 
#line 516
  {      (char )'W',      (char )'o',      (char )'o',      (char )'d', 
        (char )'y',      (char )' ',      (char )'S',      (char )'u', 
        (char )'w',      (char )'a',      (char )'l',      (char )'s', 
        (char )'k',      (char )'i',      (char )' ',      (char )'<', 
        (char )'w',      (char )'o',      (char )'o',      (char )'d', 
        (char )'y',      (char )'s',      (char )'@',      (char )'x', 
        (char )'a',      (char )'n',      (char )'d',      (char )'r', 
        (char )'o',      (char )'s',      (char )'.',      (char )'c', 
        (char )'o',      (char )'m',      (char )'>',      (char )'\000'};
#line 517 "wdt977.c"
char _ddv_module_description[25]  = 
#line 517
  {      (char )'W',      (char )'8',      (char )'3',      (char )'9', 
        (char )'7',      (char )'7',      (char )'A',      (char )'F', 
...
#line 1 "manage.o"
#pragma merger("0","/tmp/cil-EazjiMy0.i","")
...
#line 1 "misc.o"
#pragma merger("0","/tmp/cil-lScZQLWG.i","")
...
#line 1 "mutex.o"
#pragma merger("0","/tmp/cil-ekMJ8scf.i","")
...
#line 1 "page_alloc.o"
#pragma merger("0","/tmp/cil-ctiWgTLK.i","")
...
#line 1 "pci.o"
#pragma merger("0","/tmp/cil-9KoKSuqC.i","")
...
#line 1 "resource.o"
#pragma merger("0","/tmp/cil-np_6XiOG.i","")
...
#line 1 "sched.o"
#pragma merger("0","/tmp/cil-79k9pd7K.i","")
...
#line 1 "semaphore.o"
#pragma merger("0","/tmp/cil-k8AW5GH0.i","")
...
#line 1 "slab.o"
#pragma merger("0","/tmp/cil-_8OAY3LP.i","")
...
#line 1 "softirq.o"
#pragma merger("0","/tmp/cil-Pjkl2MK0.i","")
...
#line 1 "spinlock.o"
#pragma merger("0","/tmp/cil-wfmPPc8g.i","")
...
#line 1 "tasklet.o"
#pragma merger("0","/tmp/cil-4ziXKSMk.i","")
...
#line 1 "timer.o"
#pragma merger("0","/tmp/cil-ycKmNU86.i","")
...
#line 1 "tty_io.o"
#pragma merger("0","/tmp/cil-zj88zUap.i","")
...
#line 1 "usercopy.o"
#pragma merger("0","/tmp/cil-QvX0BFa3.i","")
...
#line 1 "vmalloc.o"
#pragma merger("0","/tmp/cil-lCNiIasA.i","")
...
#line 1 "wait.o"
#pragma merger("0","/tmp/cil-z5aVMWuR.i","")
...
#line 1 "workqueue.o"
#pragma merger("0","/tmp/cil-NSHZkATx.i","")
