...
#line 54 "/usr/local/ddv/models/con2/include/linux/rtc.h"
struct rtc_pll_info {
   int something ;
};
...
#line 1 "cdev.o"
#pragma merger("0","/tmp/cil-IIhjCqth.i","")
...
#line 1 "char_dev.o"
#pragma merger("0","/tmp/cil-H7ZNhsko.i","")
...
#line 1 "ddverify.o"
#pragma merger("0","/tmp/cil-6rO5mMgC.i","")
...
#line 1 "genhd.o"
#pragma merger("0","/tmp/cil-nyWypHvk.i","")
...
#line 1 "interrupt.o"
#pragma merger("0","/tmp/cil-_0DcB9ia.i","")
...
#line 1 "ioctl.o"
#pragma merger("0","/tmp/cil-csE3YUu8.i","")
#line 1 "ll_rw_blk.o"
#pragma merger("0","/tmp/cil-rGg7Q9MP.i","")
...
#line 1 "__main.o"
#pragma merger("0","/tmp/cil-xyiiV0yJ.i","")
...
#line 67 "genrtc.c"
wait_queue_head_t gen_rtc_wait  =    {0, 0, 1};
#line 75 "genrtc.c"
unsigned char gen_rtc_status  ;
#line 76 "genrtc.c"
unsigned long gen_rtc_irq_data  ;
#line 79 "genrtc.c"
unsigned char days_in_mo[12]  = 
#line 79
...
int irq_active  ;
#line 235 "genrtc.c"
__inline void gen_clear_rtc_irq_bit(unsigned char bit ) 
{ 
...
#line 252 "genrtc.c"
__inline int gen_set_rtc_irq_bit(unsigned char bit ) 
{ 
...
#line 287
extern int ( /* missing proto */  get_rtc_pll)() ;
#line 297
extern int ( /* missing proto */  set_rtc_pll)() ;
#line 309
extern int ( /* missing proto */  get_rtc_time)() ;
#line 340
extern int ( /* missing proto */  set_rtc_time)() ;
#line 277 "genrtc.c"
int gen_rtc_ioctl(struct inode *inode , struct file *file , unsigned int cmd , unsigned long arg ) 
{ 
...
#line 284
  switch (cmd) {
  case (unsigned int )((unsigned long )(((2U << 30) | (unsigned int )(112 << 8)) | 17U) | (sizeof(struct rtc_pll_info ) << 16)): 
#line 287
  tmp___2 = get_rtc_pll(& pll);
#line 287
  if (tmp___2) {
#line 288
    return (-22);
...
#line 290
    tmp___1 = copy_to_user(argp, (void const   *)(& pll), sizeof(pll));
#line 290
    if (tmp___1) {
#line 290
      tmp___0 = -14;
...
#line 290
  ...
  case (unsigned int )((unsigned long )(((1U << 30) | (unsigned int )(112 << 8)) | 18U) | (sizeof(struct rtc_pll_info ) << 16)): 
#line 293
  tmp___3 = capable(25);
#line 293
  if (! tmp___3) {
...
#line 295
  tmp___4 = copy_from_user((void *)(& pll), argp, sizeof(pll));
#line 295
  if (tmp___4) {
#line 296
    return (-14);
...
#line 297
  tmp___5 = set_rtc_pll(& pll);
#line 297
  return (tmp___5);
  case (unsigned int )(112 << 8) | 4U: 
#line 300
  gen_clear_rtc_irq_bit((unsigned char)16);
#line 301
  return (0);
  case (unsigned int )(112 << 8) | 3U: 
#line 304
  tmp___6 = gen_set_rtc_irq_bit((unsigned char)16);
#line 304
  return (tmp___6);
...
#line 309
  get_rtc_time(& wtime);
#line 311
  tmp___9 = copy_to_user(argp, (void const   *)(& wtime), sizeof(wtime));
#line 311
  if (tmp___9) {
#line 311
    tmp___8 = -14;
...
#line 321
  tmp___11 = copy_from_user((void *)(& wtime), argp, sizeof(wtime));
#line 321
  if (tmp___11) {
#line 322
    return (-14);
...
#line 325
  leap_yr = (unsigned char )tmp___12;
#line 328
  if (wtime.tm_mon < 0) {
#line 329
    return (-22);
...
#line 331
    if (wtime.tm_mday > (int )days_in_mo[wtime.tm_mon] + tmp___13) {
#line 333
      return (-22);
    }
  }
...
{ 
  ...
  {
#line 355
  if ((int )gen_rtc_status & 1) {
#line 356
    return (-16);
  }
#line 358
  gen_rtc_status = (unsigned char )((int )gen_rtc_status | 1);
#line 359
  gen_rtc_irq_data = 0UL;
#line 360
  irq_active = 0;
#line 362
  return (0);
...
{ 
  ...
  {
#line 372
  gen_clear_rtc_irq_bit((unsigned char)112);
#line 374
  gen_rtc_status = (unsigned char )((int )gen_rtc_status & -2);
#line 375
  return (0);
}
}
#line 479 "genrtc.c"
__inline int gen_rtc_proc_init(void) 
{ 
...
#line 487 "genrtc.c"
struct file_operations  const  gen_rtc_fops  = 
#line 487
    ...
    (ssize_t (*)(struct file * , char const   * , size_t  , loff_t * ))0, (int (*)(struct file * ,
                                                                                   ...
                                                                                   int (*)(void * ,
                                                                                           ...
                                                                                           ino_t  ,
                                                                                           unsigned int  ) ))0,
    (unsigned int (*)(struct file * , struct poll_table_struct * ))0, & gen_rtc_ioctl,
    (long (*)(struct file * , unsigned int  , unsigned long  ))0, (long (*)(struct file * ,
                                                                            unsigned int  ,
                                                                            unsigned long  ))0,
    (int (*)(struct file * , struct vm_area_struct * ))0, & gen_rtc_open, (int (*)(struct file * ))0,
    & gen_rtc_release, (int (*)(struct file * , struct dentry * , int datasync ))0,
...
#line 498 "genrtc.c"
struct miscdevice rtc_gen_dev  =    {135, "rtc", (struct file_operations *)(& gen_rtc_fops)};
#line 505 "genrtc.c"
int rtc_generic_init(void) 
{ 
  int retval ;

  {
#line 509
  printk("<6>Generic RTC Driver v%s\n", "1.07");
#line 511
...
#line 531 "genrtc.c"
int (*_ddv_tmp_init)(void)  =    & rtc_generic_init;
#line 532 "genrtc.c"
void (*_ddv_tmp_exit)(void)  =    & rtc_generic_exit;
#line 534 "genrtc.c"
char _ddv_module_author[17]  = 
#line 534
  {      (char )'R',      (char )'i',      (char )'c',      (char )'h', 
        (char )'a',      (char )'r',      (char )'d',      (char )' ', 
        (char )'Z',      (char )'i',      (char )'d',      (char )'l', 
        (char )'i',      (char )'c',      (char )'k',      (char )'y', 
        (char )'\000'};
#line 535 "genrtc.c"
...
#line 1 "manage.o"
#pragma merger("0","/tmp/cil-R9D2kAl9.i","")
...
#line 1 "misc.o"
#pragma merger("0","/tmp/cil-9VKTLbwa.i","")
...
#line 1 "mutex.o"
#pragma merger("0","/tmp/cil-zkpcjOen.i","")
...
#line 1 "page_alloc.o"
#pragma merger("0","/tmp/cil-NQT6o59a.i","")
...
#line 1 "pci.o"
#pragma merger("0","/tmp/cil-8IWOljHB.i","")
...
#line 1 "resource.o"
#pragma merger("0","/tmp/cil-QmEeQNlT.i","")
...
#line 1 "sched.o"
#pragma merger("0","/tmp/cil-hc7IKyKr.i","")
...
#line 1 "semaphore.o"
#pragma merger("0","/tmp/cil-X0wLyDse.i","")
...
#line 1 "slab.o"
#pragma merger("0","/tmp/cil-BmWlVVAf.i","")
...
#line 1 "softirq.o"
#pragma merger("0","/tmp/cil-cGcdruMz.i","")
...
#line 1 "spinlock.o"
#pragma merger("0","/tmp/cil-TRZz53yV.i","")
...
#line 1 "tasklet.o"
#pragma merger("0","/tmp/cil-dbkEuL2w.i","")
...
#line 1 "timer.o"
#pragma merger("0","/tmp/cil-77AhJ0d9.i","")
...
#line 1 "tty_io.o"
#pragma merger("0","/tmp/cil-ryD2OaD4.i","")
...
#line 1 "usercopy.o"
#pragma merger("0","/tmp/cil-WNjgp1Qb.i","")
...
#line 1 "vmalloc.o"
#pragma merger("0","/tmp/cil-b6Uwg29_.i","")
...
#line 1 "wait.o"
#pragma merger("0","/tmp/cil-W6YdxRkZ.i","")
...
#line 1 "workqueue.o"
#pragma merger("0","/tmp/cil-c4jzIYvk.i","")
