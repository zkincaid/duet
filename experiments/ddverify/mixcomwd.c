...
#line 1 "cdev.o"
#pragma merger("0","/tmp/cil-MJfvFVE4.i","")
...
#line 1 "char_dev.o"
#pragma merger("0","/tmp/cil-VOjkdx3E.i","")
...
#line 1 "ddverify.o"
#pragma merger("0","/tmp/cil-LQ_ImJkn.i","")
...
#line 1 "genhd.o"
#pragma merger("0","/tmp/cil-UapWGr61.i","")
...
#line 1 "interrupt.o"
#pragma merger("0","/tmp/cil-OV6Hh864.i","")
...
#line 1 "ioctl.o"
#pragma merger("0","/tmp/cil-j7PNXKw7.i","")
#line 1 "ll_rw_blk.o"
#pragma merger("0","/tmp/cil-G6INsNcp.i","")
...
#line 1 "__main.o"
#pragma merger("0","/tmp/cil-2b5LGJx6.i","")
...
#line 52 "mixcomwd.c"
static int mixcomwd_ioports[4]  = {      384,      640,      896,      0};
#line 59 "mixcomwd.c"
...
#line 63 "mixcomwd.c"
static struct timer_list mixcomwd_timer  =    {0UL, (void (*)(unsigned long  ))((void *)0), 0UL, (short)0, (short)1};
#line 64 "mixcomwd.c"
...
#line 78
  mixcomwd_ping();
#line 80
  mod_timer(& mixcomwd_timer, jiffies + 500UL);
#line 81
  return;
}
}
...
{ 
  ...
  {
#line 89
  tmp = test_and_set_bit(0, & mixcomwd_opened);
#line 89
  if (tmp) {
#line 90
    return (-16);
...
#line 118
    mixcomwd_timer.expires = jiffies + 500UL;
#line 119
    mixcomwd_timer.function = & mixcomwd_timerfun;
#line 120
    mixcomwd_timer.data = 0UL;
#line 121
...
#line 127
  clear_bit(0, (unsigned long volatile   *)(& mixcomwd_opened));
#line 128
  expect_close = (char)0;
#line 129
  return (0);
...
#line 133 "mixcomwd.c"
static ssize_t mixcomwd_write(struct file *file , char const   *data , size_t len ,
                              loff_t *ppos ) 
{ 
  size_t i ;
  char c ;
...
#line 162
static int mixcomwd_ioctl(struct inode *inode , struct file *file , unsigned int cmd ,
                          unsigned long arg ) ;
#line 162 "mixcomwd.c"
static struct watchdog_info ident  =    {(__u32 )33024, (__u32 )1, {(__u8 )'M', (__u8 )'i', (__u8 )'x', (__u8 )'C', (__u8 )'O',
                               (__u8 )'M', (__u8 )' ', (__u8 )'w', (__u8 )'a', (__u8 )'t',
...
#line 175
  tmp = copy_to_user((void *)p, (void const   *)(& status), sizeof(int ));
#line 175
  if (tmp) {
#line 176
    return (-14);
...
#line 180
  tmp___0 = copy_to_user(argp, (void const   *)(& ident), sizeof(ident));
#line 180
  if (tmp___0) {
#line 181
    return (-14);
...
#line 203 "mixcomwd.c"
static struct miscdevice mixcomwd_miscdev  =    {130, "watchdog", (struct file_operations *)(& mixcomwd_fops)};
#line 210 "mixcomwd.c"
static int mixcomwd_checkcard(int port ) 
{ 
  int id ;
  struct resource *tmp ;
...
#line 214
  port += 3088;
#line 215
  tmp = request_region((unsigned long )port, 1UL, "MixCOM watchdog");
#line 215
  if (! tmp) {
#line 216
    return (0);
...
#line 219
  tmp___0 = inb_p((unsigned int )port);
#line 219
  id = (int )tmp___0 & 63;
#line 220
  if (id != 17) {
#line 221
    release_region((unsigned long )port, 1UL);
#line 222
    return (0);
  }
#line 224
...
#line 227 "mixcomwd.c"
static int flashcom_checkcard(int port ) 
{ 
  int id ;
  struct resource *tmp ;
  unsigned char tmp___0 ;
...
#line 271
  if (ret) {
#line 273
    release_region((unsigned long )watchdog_port, 1UL);
#line 274
    return (ret);
  }
#line 277
...
#line 296 "mixcomwd.c"
int (*_ddv_tmp_init)(void)  =    & mixcomwd_init;
#line 297 "mixcomwd.c"
void (*_ddv_tmp_exit)(void)  =    & mixcomwd_exit;
#line 299 "mixcomwd.c"
char _ddv_module_author[32]  = 
#line 299
  {      (char )'G',      (char )'e',      (char )'r',      (char )'g', 
        (char )'e',      (char )'l',      (char )'y',      (char )' ', 
        (char )'M',      (char )'a',      (char )'d',      (char )'a', 
        (char )'r',      (char )'a',      (char )'s',      (char )'z', 
        (char )' ',      (char )'<',      (char )'g',      (char )'o', 
        (char )'r',      (char )'g',      (char )'o',      (char )'@', 
        (char )'i',      (char )'t',      (char )'c',      (char )'.', 
        (char )'h',      (char )'u',      (char )'>',      (char )'\000'};
#line 300 "mixcomwd.c"
char _ddv_module_description[23]  = 
#line 300
  {      (char )'M',      (char )'i',      (char )'x',      (char )'C', 
        (char )'o',      (char )'m',      (char )' ',      (char )'W', 
...
#line 1 "manage.o"
#pragma merger("0","/tmp/cil-XBZpGF0v.i","")
...
#line 1 "misc.o"
#pragma merger("0","/tmp/cil-K0tRoFOL.i","")
...
#line 1 "mutex.o"
#pragma merger("0","/tmp/cil-Um6jrhjw.i","")
...
#line 1 "page_alloc.o"
#pragma merger("0","/tmp/cil-AhN0Lzeh.i","")
...
#line 1 "pci.o"
#pragma merger("0","/tmp/cil-WGsV8HiY.i","")
...
#line 1 "resource.o"
#pragma merger("0","/tmp/cil-o12mmquT.i","")
...
#line 1 "sched.o"
#pragma merger("0","/tmp/cil-hze9t1vu.i","")
...
#line 1 "semaphore.o"
#pragma merger("0","/tmp/cil-1AgQ8uc0.i","")
...
#line 1 "slab.o"
#pragma merger("0","/tmp/cil-0a14rGzS.i","")
...
#line 1 "softirq.o"
#pragma merger("0","/tmp/cil-DLGg8ogX.i","")
...
#line 1 "spinlock.o"
#pragma merger("0","/tmp/cil-2tSTu2C5.i","")
...
#line 1 "tasklet.o"
#pragma merger("0","/tmp/cil-nz0KdtWb.i","")
...
#line 1 "timer.o"
#pragma merger("0","/tmp/cil-k39VDrL9.i","")
...
#line 1 "tty_io.o"
#pragma merger("0","/tmp/cil-RNthM5PI.i","")
...
#line 1 "usercopy.o"
#pragma merger("0","/tmp/cil-O3sIExn0.i","")
...
#line 1 "vmalloc.o"
#pragma merger("0","/tmp/cil-nYEyoyDs.i","")
...
#line 1 "wait.o"
#pragma merger("0","/tmp/cil-R0HgmIsT.i","")
...
#line 1 "workqueue.o"
#pragma merger("0","/tmp/cil-imb6mDz3.i","")
