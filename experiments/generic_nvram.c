...
// c::tag-address_space$link28
// file /usr/local/ddv/models/con2/include/linux/fs.h line 90
struct address_space$link28;
...
// c::tag-block_device$link20
// file /usr/local/ddv/models/con2/include/linux/fs.h line 105
struct block_device$link20;
...
// c::tag-ddv_pci_driver$link4
// file /usr/local/ddv/models/con2/include/ddverify/pci.h line 6
struct ddv_pci_driver$link4;
...
// c::tag-file_operations$link26
// file /usr/local/ddv/models/con2/include/linux/fs.h line 134
struct file_operations$link26;
...
// c::tag-miscdevice$link19
// file /usr/local/ddv/models/con2/include/linux/miscdevice.h line 34
struct miscdevice$link19;
...
// c::tag-pci_driver$link3
// file /usr/local/ddv/models/con2/include/linux/pci.h line 67
struct pci_driver$link3;
...
// c::tag-request_queue$link1
// file /usr/local/ddv/models/con2/include/linux/blkdev.h line 54
struct request_queue$link1;
...
// c::__get_user
// file /usr/local/ddv/models/con2/include/asm/uaccess.h line 41
signed int __get_user(signed int size, void *ptr);
// c::__put_user
// file /usr/local/ddv/models/con2/include/asm/uaccess.h line 46
...
// c::access_ok
// file /usr/local/ddv/models/con2/include/asm/uaccess.h line 35
signed int access_ok(signed int, const void *, unsigned long int);
// c::add_disk
...
// c::assert_context_process$link12
// file /usr/local/ddv/models/con2/include/ddverify/ddverify.h line 32
static signed int assert_context_process$link12();
...
struct request_queue$link1 * blk_alloc_queue(unsigned int gfp_mask);
// c::blk_cleanup_queue
// file /usr/local/ddv/models/con2/src/linux/block/ll_rw_blk.c line 69
void blk_cleanup_queue(struct request_queue$link1 *q);
// c::blk_init_queue
// file /usr/local/ddv/models/con2/src/linux/block/ll_rw_blk.c line 16
struct request_queue$link1 * blk_init_queue(void (*rfn)(struct request_queue$link1 *), struct anon$0 *lock);
// c::blk_init_queue::rfn$object
// 
void rfn$object(struct request_queue$link1 *);
// c::blk_queue_hardsect_size
// file /usr/local/ddv/models/con2/src/linux/block/ll_rw_blk.c line 64
void blk_queue_hardsect_size(struct request_queue$link1 *q, unsigned short int size);
// c::blk_queue_make_request
// file /usr/local/ddv/models/con2/src/linux/block/ll_rw_blk.c line 51
void blk_queue_make_request(struct request_queue$link1 *q, signed int (*mfn)(struct request_queue$link1 *, struct bio$link7 *));
// c::blk_queue_make_request::mfn$object
// 
signed int mfn$object(struct request_queue$link1 *, struct bio$link7 *);
...
void cdev_init(struct cdev$link9 *cdev, struct file_operations$link4 *fops);
// c::copy_from_user
...
struct request_queue$link1 * get_fixed_request_queue();
// c::get_user
// file /usr/local/ddv/models/con2/src/linux/arch/i386/lib/usercopy.c line 13
...
signed int misc_register(struct miscdevice$link19 *misc);
// c::mod_timer
...
// c::nvram_cleanup
// file generic_nvram.c line 143
void nvram_cleanup(void);
// c::nvram_init
// file generic_nvram.c line 136
signed int nvram_init(void);
// c::nvram_ioctl
// file generic_nvram.c line 90
signed int nvram_ioctl(struct inode$link5 *inode, struct file$link15 *file, unsigned int cmd, unsigned long int arg);
// c::nvram_llseek
// file generic_nvram.c line 33
signed long long int nvram_llseek(struct file$link15 *file, signed long long int offset, signed int origin);
// c::nvram_read_byte
// file generic_nvram.c line 64 function read_nvram
signed int nvram_read_byte(void);
// c::nvram_sync
// file generic_nvram.c line 113 function nvram_ioctl
signed int nvram_sync(void);
// c::nvram_write_byte
// file generic_nvram.c line 84 function write_nvram
signed int nvram_write_byte(void);
// c::outb
...
signed int pci_register_driver(struct pci_driver$link3 *driver);
...
void pci_unregister_driver(struct pci_driver$link3 *driver);
// c::printk
...
// c::pthread_create::__start_routine$link30$object
// 
void * __start_routine$link30$object(void *);
...
// c::read_nvram
// file generic_nvram.c line 53
signed int read_nvram(struct file$link15 *file, char *buf, unsigned int count, signed long long int *ppos);
// c::register_blkdev
...
// c::write_nvram
// file generic_nvram.c line 70
signed int write_nvram(struct file$link15 *file, const char *buf, unsigned int count, signed long long int *ppos);
...
struct bio$link7
{
  ...
  struct bio_vec *bi_io_vec;
  // bi_end_io
  signed int (*bi_end_io)(struct bio$link7 *, unsigned int, signed int);
  // bi_private
  void *bi_private;
};
...
struct block_device$link20
{
  ...
  struct gendisk *bd_disk;
  // bd_contains
  struct block_device$link20 *bd_contains;
  // bd_block_size
  unsigned int bd_block_size;
};
...
{
  // open
  signed int (*open)(struct inode$link3 *, struct file$link8 *);
  // release
  signed int (*release)(struct inode$link3 *, struct file$link8 *);
  // ioctl
  signed int (*ioctl)(struct inode$link3 *, struct file$link8 *, unsigned int, unsigned long int);
  // unlocked_ioctl
...
{
  // open
  signed int (*open)(struct inode$link7 *, struct file$link9 *);
  // release
  signed int (*release)(struct inode$link7 *, struct file$link9 *);
  // ioctl
  signed int (*ioctl)(struct inode$link7 *, struct file$link9 *, unsigned int, unsigned long int);
  // unlocked_ioctl
...
struct cdev$link27
{
  ...
  struct module *owner;
  // ops
  struct file_operations$link26 *ops;
  // dev
  unsigned int dev;
  // count
  unsigned int count;
...
struct inode$link3
{
  ...
  signed long long int i_size;
  // i_cdev
  struct cdev$link10 *i_cdev;
};

struct ddv_cdev$link15
{
  // cdevp
  struct cdev$link10 *cdevp;
  // filp
...
{
  // pci_driver
  struct pci_driver$link3 *pci_driver;
  // pci_dev
...
struct tty_driver
{
  ...
  // open
  signed int (*open)(struct tty_struct *tty, struct file$link22 *filp);
  // close
  void (*close)(struct tty_struct *tty, struct file$link22 *filp);
  // write
  ...
  // ioctl
  signed int (*ioctl)(struct tty_struct *tty, struct file$link22 *file, unsigned int cmd, unsigned long int arg);
  // set_termios
  ...
  // write_proc
  signed int (*write_proc)(struct file$link22 *file, const char *buffer, unsigned long int count, void *data);
  // tiocmget
  signed int (*tiocmget)(struct tty_struct *tty, struct file$link22 *file);
  // tiocmset
  signed int (*tiocmset)(struct tty_struct *tty, struct file$link22 *file, unsigned int set, unsigned int clear);
};
...
struct device$link4
{
  ...
  void *driver_data;
  // release
  void (*release)(struct device$link4 *dev);
};
...
struct file$link22
{
  ...
  // f_op
  struct file_operations$link26 *f_op;
  // f_count
  signed int f_count;
  // f_flags
  unsigned int f_flags;
  ...
  void *private_data;
  // f_mapping
  struct address_space$link28 *f_mapping;
};
...
struct file_operations$link13
{
  ...
  // ioctl
  signed int (*ioctl)(struct inode$link8 *, struct file$link16 *, unsigned int, unsigned long int);
  // unlocked_ioctl
  ...
  // open
  signed int (*open)(struct inode$link8 *, struct file$link16 *);
  // flush
  signed int (*flush)(struct file$link16 *);
  // release
  signed int (*release)(struct inode$link8 *, struct file$link16 *);
  // fsync
  signed int (*fsync)(struct file$link16 *, struct dentry$link14 *, signed int datasync);
  // fasync
  ...
  // sendfile
  signed int (*sendfile)(struct file$link16 *, signed long long int *, unsigned int, signed int (*)(struct anon$1 *, struct page *, unsigned long int, unsigned long int), void *);
  // sendpage
...
struct file_operations$link14
{
  ...
  // ioctl
  signed int (*ioctl)(struct inode$link5 *, struct file$link15 *, unsigned int, unsigned long int);
  // unlocked_ioctl
  ...
  // open
  signed int (*open)(struct inode$link5 *, struct file$link15 *);
  // flush
  signed int (*flush)(struct file$link15 *);
  // release
  signed int (*release)(struct inode$link5 *, struct file$link15 *);
  // fsync
  signed int (*fsync)(struct file$link15 *, struct dentry$link8 *, signed int datasync);
  // fasync
...
struct file_operations$link26
{
  ...
  struct module *owner;
  // llseek
  signed long long int (*llseek)(struct file$link22 *, signed long long int, signed int);
  // read
  signed int (*read)(struct file$link22 *, char *, unsigned int, signed long long int *);
  // write
  signed int (*write)(struct file$link22 *, const char *, unsigned int, signed long long int *);
  // readdir
  signed int (*readdir)(struct file$link22 *, void *, signed int (*)(void *, const char *, signed int, signed long long int, unsigned long int, unsigned int));
  // poll
  unsigned int (*poll)(struct file$link22 *, struct poll_table_struct *);
  // ioctl
  signed int (*ioctl)(struct inode$link21 *, struct file$link22 *, unsigned int, unsigned long int);
  // unlocked_ioctl
  signed long int (*unlocked_ioctl)(struct file$link22 *, unsigned int, unsigned long int);
  // compat_ioctl
  signed long int (*compat_ioctl)(struct file$link22 *, unsigned int, unsigned long int);
  // mmap
  signed int (*mmap)(struct file$link22 *, struct vm_area_struct *);
  // open
  signed int (*open)(struct inode$link21 *, struct file$link22 *);
  // flush
  signed int (*flush)(struct file$link22 *);
  // release
  signed int (*release)(struct inode$link21 *, struct file$link22 *);
  // fsync
  signed int (*fsync)(struct file$link22 *, struct dentry$link25 *, signed int datasync);
  // fasync
  signed int (*fasync)(signed int, struct file$link22 *, signed int);
  // lock
  signed int (*lock)(struct file$link22 *, signed int, struct file_lock *);
  // readv
  signed int (*readv)(struct file$link22 *, const struct iovec *, unsigned long int, signed long long int *);
  // writev
  signed int (*writev)(struct file$link22 *, const struct iovec *, unsigned long int, signed long long int *);
  // sendfile
  signed int (*sendfile)(struct file$link22 *, signed long long int *, unsigned int, signed int (*)(struct anon$1 *, struct page *, unsigned long int, unsigned long int), void *);
  // sendpage
  signed int (*sendpage)(struct file$link22 *, struct page *, signed int, unsigned int, signed long long int *, signed int);
  // get_unmapped_area
  unsigned long int (*get_unmapped_area)(struct file$link22 *, unsigned long int, unsigned long int, unsigned long int, unsigned long int);
  // check_flags
  signed int (*check_flags)(signed int);
  // dir_notify
  signed int (*dir_notify)(struct file$link22 *filp, unsigned long int arg);
  // flock
  signed int (*flock)(struct file$link22 *, signed int, struct file_lock *);
  // open_exec
...
struct file_operations$link4
{
  ...
  // fsync
  signed int (*fsync)(struct file$link7 *, struct dentry$link6 *, signed int datasync);
  // fasync
...
struct gendisk$link12
{
  ...
  signed int flags;
  // driverfs_dev
  struct device$link4 *driverfs_dev;
  // devfs_name
  char devfs_name[64l];
};
...
struct gendisk$link4
{
  ...
  // queue
  struct request_queue$link1 *queue;
  // private_data
  void *private_data;
  // flags
  signed int flags;
...
struct inode$link21
{
  ...
  unsigned short int i_mode;
  // i_bdev
  struct block_device$link20 *i_bdev;
  // i_rdev
  unsigned int i_rdev;
  // i_size
  signed long long int i_size;
  // i_cdev
  struct cdev$link27 *i_cdev;
};
...
struct miscdevice
{
  ...
  const char *name;
  // fops
  struct file_operations$link14 *fops;
};
...
struct request_queue$link0
{
  ...
  // make_request_fn
  signed int (*make_request_fn)(struct request_queue$link0 *, struct bio$link14 *);
  // unplug_fn
...
{
  // request_fn
  void (*request_fn)(struct request_queue$link1 *);
  // make_request_fn
  signed int (*make_request_fn)(struct request_queue$link1 *, struct bio$link7 *);
  // unplug_fn
  void (*unplug_fn)(struct request_queue$link1 *);
  // backing_dev_info
  struct backing_dev_info backing_dev_info;
  // queuedata
  void *queuedata;
...
// file generic_nvram.c line 150
char _ddv_module_license[4l];
// c::_ddv_module_license
// file generic_nvram.c line 150
char _ddv_module_license[4l] = { 71, 80, 76, 0 };
// c::_ddv_tmp_exit
// file generic_nvram.c line 149
void (*_ddv_tmp_exit)(void);
// c::_ddv_tmp_exit
// file generic_nvram.c line 149
void (*_ddv_tmp_exit)(void) = nvram_cleanup;
// c::_ddv_tmp_init
// file generic_nvram.c line 148
signed int (*_ddv_tmp_init)(void);
// c::_ddv_tmp_init
// file generic_nvram.c line 148
signed int (*_ddv_tmp_init)(void) = nvram_init;
// c::cdev_registered
...
struct request_queue$link1 fixed_request_queue[10l];
// c::genhd_registered
...
// c::nvram_dev
// file generic_nvram.c line 130
struct miscdevice nvram_dev;
// c::nvram_fops
// file generic_nvram.c line 122
struct file_operations$link14 nvram_fops;
// c::nvram_fops
// file generic_nvram.c line 122
struct file_operations$link14 nvram_fops = { .owner=((struct module *)NULL), .llseek=nvram_llseek, .read=read_nvram,
    .write=write_nvram, .readdir=((signed int (*)(struct file$link15 *, void *, signed int (*)(void *, const char *, signed int, signed long long int, unsigned long int, unsigned int)))NULL),
    .poll=((unsigned int (*)(struct file$link15 *, struct poll_table_struct *))NULL),
    .ioctl=nvram_ioctl,
    .unlocked_ioctl=((signed long int (*)(struct file$link15 *, unsigned int, unsigned long int))NULL), .compat_ioctl=((signed long int (*)(struct file$link15 *, unsigned int, unsigned long int))NULL),
    .mmap=((signed int (*)(struct file$link15 *, struct vm_area_struct *))NULL),
    .open=((signed int (*)(struct inode$link5 *, struct file$link15 *))NULL),
    .flush=((signed int (*)(struct file$link15 *))NULL),
    .release=((signed int (*)(struct inode$link5 *, struct file$link15 *))NULL),
    .fsync=((signed int (*)(struct file$link15 *, struct dentry$link8 *, signed int datasync))NULL),
    .fasync=((signed int (*)(signed int, struct file$link15 *, signed int))NULL),
    .lock=((signed int (*)(struct file$link15 *, signed int, struct file_lock *))NULL),
    .readv=((signed int (*)(struct file$link15 *, const struct iovec *, unsigned long int, signed long long int *))NULL),
    .writev=((signed int (*)(struct file$link15 *, const struct iovec *, unsigned long int, signed long long int *))NULL),
    .sendfile=((signed int (*)(struct file$link15 *, signed long long int *, unsigned int, signed int (*)(struct anon$1 *, struct page *, unsigned long int, unsigned long int), void *))NULL),
    .sendpage=((signed int (*)(struct file$link15 *, struct page *, signed int, unsigned int, signed long long int *, signed int))NULL),
    .get_unmapped_area=((unsigned long int (*)(struct file$link15 *, unsigned long int, unsigned long int, unsigned long int, unsigned long int))NULL),
    .check_flags=((signed int (*)(signed int))NULL),
    .dir_notify=((signed int (*)(struct file$link15 *filp, unsigned long int arg))NULL),
    .flock=((signed int (*)(struct file$link15 *, signed int, struct file_lock *))NULL),
    .open_exec=((signed int (*)(struct inode$link5 *))NULL) };
// c::nvram_dev
// file generic_nvram.c line 130
struct miscdevice nvram_dev = { .minor=144, .name="nvram", .fops=&nvram_fops };
// c::proc_root_driver
...
struct request_queue$link1 * blk_alloc_queue(unsigned int gfp_mask)
{
  ...
  if(!(return_value_nondet_int$1 == 0))
  {
    ...
    queue->request_fn = (void (*)(struct request_queue$link1 *))NULL;
    queue->make_request_fn = (signed int (*)(struct request_queue$link1 *, struct bio$link7 *))NULL;
    queue->__ddv_queue_alive = 1;
    return queue;
  }

  else
    return (struct request_queue$link1 *)NULL;
}
...
signed int nvram_init(void)
{
  printk("<6>Macintosh non-volatile memory driver v%s\n", (const void *)"1.1");
  signed int return_value_misc_register$1;
  return_value_misc_register$1=misc_register(&nvram_dev);
  return return_value_misc_register$1;
}
...
signed long long int nvram_llseek(struct file$link15 *file, signed long long int offset, signed int origin)
{
  ...
  switch(origin)
  {
    ...
    case 1:
      {
        offset = offset + file->f_pos;
        goto __CPROVER_DUMP_L3;
      }
    case 2:
      offset = offset + (signed long long int)8192;
    default:
      {
      ...
      __CPROVER_DUMP_L3:
        ...
        if(offset < 0l)
        {
          ...
          return (signed long long int)-22;
        }
...
void pci_unregister_driver(struct pci_driver$link3 *driver)
{
  registered_pci_driver.pci_driver = (struct pci_driver$link3 *)NULL;
...
signed int read_nvram(struct file$link15 *file, char *buf, unsigned int count, signed long long int *ppos)
{
  unsigned int i;
  char *p = buf;
  signed int return_value_access_ok$1;
  return_value_access_ok$1=access_ok(1, (const void *)buf, (unsigned long int)count);
  if(return_value_access_ok$1 == 0)
    return -14;
  ...
  i = (unsigned int)*ppos;
  signed int return_value_nvram_read_byte$2;
  signed int return_value___put_user$3;
  while(i < 8192u && count > 0u)
  {
    return_value_nvram_read_byte$2=nvram_read_byte(i);
    return_value___put_user$3=__put_user(return_value_nvram_read_byte$2, (void *)p);
    if(!(return_value___put_user$3 == 0))
      return -14;
  ...
  *ppos = (signed long long int)i;
  return (signed int)(p - buf);
}
...
signed int write_nvram(struct file$link15 *file, const char *buf, unsigned int count, signed long long int *ppos)
{
  ...
  char c;
  signed int return_value_access_ok$1;
  return_value_access_ok$1=access_ok(0, (const void *)buf, (unsigned long int)count);
  if(return_value_access_ok$1 == 0)
    return -14;
  ...
  while(i < 8192u && count > 0u)
  {
    signed int return_value___get_user$2;
    return_value___get_user$2=__get_user((signed int)c, (void *)p);
    if(!(return_value___get_user$2 == 0))
      return -14;
