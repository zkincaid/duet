...
struct __anonstruct_Arguments_42 {
   ...
   char *outputDir ;
   int bunchSize ;
   double (*dispEst)(GaborJet j1 , GaborJet j2 , double *tdx , double *tdy ) ;
};
#line 90 "src/csuEBGMGraphFit.c"
...
#line 1 "csuEBGMGraphFit.o"
#pragma merger("0","/tmp/cil-UcMe9WGc.i","-O3,-Wall")
...
#line 252
int quiet ;
#line 93 "src/csuCommonMatrix.h"
void freeMatrix(Matrix A ) ;
#line 95
Matrix makeZeroMatrix(int row_dim , int col_dim ) ;
#line 96 "src/csuCommonImage.h"
...
#line 121 "src/csuEBGMSimilarity.h"
...
#line 108 "src/csuEBGMGraphFit.c"
void usage(char const   *name ) 
{ 
  ...
  {
#line 109
  printf((char const   * __restrict  )"usage: %s [OPITIONS] modelImages.srt novelImage.srt wavelet_file image_dir model_graph_dir displace_estimator outputDir\n\n",
         name);
#line 110
  printf((char const   * __restrict  )"\n**************************** DISCRIPTION ****************************\n");
#line 111
  printf((char const   * __restrict  )"* csuGaborGraphFit                                                  *\n");
#line 112
  printf((char const   * __restrict  )"*                                                                   *\n");
#line 113
  printf((char const   * __restrict  )"* The purpose of this exicutable to to read a set of training images*\n");
#line 114
  printf((char const   * __restrict  )"* and their graph discription and build graph discriptions for      *\n");
#line 115
  printf((char const   * __restrict  )"* novel images.  This program performes different variations of the *\n");
#line 116
  printf((char const   * __restrict  )"* face bunch graph matching algorithm to locate points on a face.   *\n");
#line 117
  printf((char const   * __restrict  )"*                                                                   *\n");
#line 118
  printf((char const   * __restrict  )"*********************************************************************\n");
...
#line 121
  printf((char const   * __restrict  )"      model_images.srt  -   A list of images with user built graphs\n");
#line 122
  printf((char const   * __restrict  )"      novel_images.srt  -   A list of images to generate graphs\n");
#line 123
  printf((char const   * __restrict  )"      wavelet_file      -   A gabor jet discription file\n");
#line 124
  printf((char const   * __restrict  )"      image_dir         -   A directory containing images\n");
#line 125
  printf((char const   * __restrict  )"      model_graph_dir   -   A directory containing model graphs\n");
#line 126
  printf((char const   * __restrict  )"      displaceEstimator -   The name of the algorithm to use for displacement estimation\n");
#line 127
  printf((char const   * __restrict  )"      outputDir         -   A directory to store the new graphs discriptions\n");
#line 128
  printf((char const   * __restrict  )"\n");
#line 130
  exit(1);
...
#line 133 "src/csuEBGMGraphFit.c"
...
#line 135
  param_num = 0;
#line 139
  args->imageDir = (char *)((void *)0);
#line 140
  args->graphDir = (char *)((void *)0);
#line 141
  args->outputDir = (char *)((void *)0);
#line 142
  args->modelFile = (char *)((void *)0);
#line 143
  args->novelFile = (char *)((void *)0);
#line 144
  args->masksFile = (char *)((void *)0);
#line 146
  args->bunchSize = 70;
#line 148
  debuglevel = 0;
...
#line 152
  while (i < argc) {
#line 155
    tmp___10 = readOption(argc, argv, & i, "-help");
#line 155
    if (tmp___10) {
#line 155
...
#line 156
      tmp___9 = readOption(argc, argv, & i, "--help");
#line 156
      if (tmp___9) {
#line 156
        usage((char const   *)*(argv + 0));
...
#line 158
        tmp___8 = readOptionInt(argc, argv, & i, "-bunchSize", & args->bunchSize);
#line 158
        if (! tmp___8) {
#line 160
...
#line 161
            tmp___6 = readOption(argc, argv, & i, "-dcfree");
#line 161
            if (tmp___6) {
#line 161
              WiskottDCFree = 1.0;
...
#line 162
              tmp___5 = readOptionInt(argc, argv, & i, "-debuglevel", & debuglevel);
#line 162
              if (! tmp___5) {
#line 165
                tmp___4 = checkBadOption(argc, argv, & i);
#line 165
                if (! tmp___4) {
#line 168
                  if (param_num == 0) {
...
#line 188
                  if (param_num == 5) {
#line 189
                    tmp___3 = strcasecmp((char const   *)*(argv + i), "DEGridSample");
#line 189
                    if (tmp___3 == 0) {
#line 189
                      args->dispEst = & DEGridSample;
                    } else {
#line 190
                      tmp___2 = strcasecmp((char const   *)*(argv + i), "DEPredictiveStep");
#line 190
                      if (tmp___2 == 0) {
#line 190
                        args->dispEst = & DEPredictiveStep;
                      } else {
#line 191
                        tmp___1 = strcasecmp((char const   *)*(argv + i), "DEPredictiveIter");
#line 191
                        if (tmp___1 == 0) {
#line 191
                          args->dispEst = & DEPredictiveIter;
                        } else {
#line 192
                          tmp___0 = strcasecmp((char const   *)*(argv + i), "DEFixedLocalSearch");
#line 192
                          if (tmp___0 == 0) {
#line 192
                            args->dispEst = & DEFixedLocalSearch;
                          } else {
#line 193
                            tmp = strcasecmp((char const   *)*(argv + i), "DENarrowingLocalSearch");
#line 193
                            if (tmp == 0) {
#line 193
                              args->dispEst = & DENarrowingLocalSearch;
                            } else {
#line 194
                              clParseError(argc, argv, i, (char *)"Unknown Distance Estimator");
                            }
                          }
                        }
                      }
...
#line 208
    tttt = tmp___11;
#line 208
    tmp___12 = ctime((time_t const   *)(& tttt));
#line 208
    printf((char const   * __restrict  )"**DEBUG %d** \"%s\"\n             at [%s]<%s():line %u>\n             %s\n",
           1, "Debuging enabled", "src/csuEBGMGraphFit.c", "processCommand", 208,
           tmp___12);
#line 208
    fflush(stdout);
  }
...
#line 212 "src/csuEBGMGraphFit.c"
GraphDiscription extractModelJets(ImageList *modelImages , char *imageDir , char *graphDir ,
                                  JetMasks masks ) 
{ 
  ImageList *subject ;
  ImageList *replicate ;
...
#line 220
      tmp = makePath((char const   *)graphDir, (char const   *)replicate->filename);
#line 220
      tmp___0 = readGraphDiscription((char const   *)tmp);
#line 220
      gd = tmp___0;
#line 223
      tmp___1 = makePath((char const   *)imageDir, (char const   *)replicate->filename);
#line 223
...
#line 226
      if (count == 0) {
#line 228
        tmp___3 = makePath((char const   *)graphDir, (char const   *)replicate->filename);
#line 228
        mj = readGraphDiscription((char const   *)tmp___3);
      } else {
#line 231
        if (! (mj->numVert == gd->numVert)) {
#line 231
          __assert_fail("mj->numVert == gd->numVert", "src/csuEBGMGraphFit.c", 231U,
                        "extractModelJets");
        }
#line 232
        i = 0;
...
#line 240
      printf((char const   * __restrict  )"Extracting jets from model image #%03d.  <%s>  |",
             count, replicate->filename);
#line 240
      fflush(stdout);
#line 241
      i = 0;
...
#line 242
        fflush(stdout);
#line 243
        tmp___4 = extractJet((gd->verts + i)->x, (gd->verts + i)->y, model, masks);
#line 243
        addJetToBunch(*(mj->bunch + i), tmp___4);
#line 241
        i ++;
      }
#line 246
...
#line 254
  while (i < mj->numVert) {
#line 256
    (mj->verts + i)->x /= (double )count;
#line 257
    (mj->verts + i)->y /= (double )count;
#line 254
    i ++;
  }
#line 260
...
#line 263 "src/csuEBGMGraphFit.c"
GraphDiscription buildBunchGraph(GraphDiscription modelJets , double (*jetSim)(GaborJet j1 ,
                                                                               GaborJet j2 ) ,
                                 int bunchsize ) 
{ 
  int vert ;
...
#line 266
  if (! (bunchsize > 1)) {
#line 266
    __assert_fail("bunchsize > 1", "src/csuEBGMGraphFit.c", 266U, "buildBunchGraph");
  }
#line 267
  vert = 0;
#line 267
  while (vert < modelJets->numVert) {
#line 272
    tmp = makeJetBunch();
#line 272
    finalBunch = tmp;
...
#line 274
    if (quiet == 0) {
#line 274
      printf((char const   * __restrict  )"Selecting jets for point: %s", *(modelJets->vertLabels + vert));
    } else
#line 274
    if (debuglevel != 0) {
#line 274
...
#line 274
      printf((char const   * __restrict  )"    [%s]<%s():line %u> %s\n", "src/csuEBGMGraphFit.c",
             "buildBunchGraph", 274, tmp___1);
    }
#line 274
    fflush(stdout);
#line 276
...
#line 277
    if (! (bunchsize <= size)) {
#line 277
      __assert_fail("bunchsize <= size", "src/csuEBGMGraphFit.c", 277U, "buildBunchGraph");
    }
#line 278
    if (! (size > 0)) {
#line 278
      __assert_fail("size > 0", "src/csuEBGMGraphFit.c", 278U, "buildBunchGraph");
    }
#line 280
    dist = makeZeroMatrix(size, size);
#line 282
    maxsim = (*jetSim)(*((*(modelJets->bunch + vert))->jets + 0), *((*(modelJets->bunch + vert))->jets + 0));
#line 282
    smallest = maxsim;
#line 283
    i = 0;
...
#line 284
      while (j < size) {
#line 285
        *(*(dist->cols + j) + i) = (*jetSim)(*((*(modelJets->bunch + vert))->jets + i),
                                             *((*(modelJets->bunch + vert))->jets + j));
#line 286
        if (maxsim < *(*(dist->cols + j) + i)) {
#line 286
          maxsim = *(*(dist->cols + j) + i);
        } else {
#line 286
          maxsim = maxsim;
        }
#line 287
        if (smallest > *(*(dist->cols + j) + i)) {
#line 287
          smallest = *(*(dist->cols + j) + i);
        } else {
#line 287
          smallest = smallest;
        }
...
#line 296
        if (minjet < 0) {
#line 297
          minsim = *(*(dist->cols + j) + i);
#line 298
          minjet = i;
        } else
#line 296
        if (minsim > *(*(dist->cols + j) + i)) {
#line 297
          minsim = *(*(dist->cols + j) + i);
#line 298
          minjet = i;
...
#line 308
      *((*(modelJets->bunch + vert))->jets + minjet) = (GaborJet )((void *)0);
#line 309
      i = 0;
#line 309
      while (i < size) {
...
#line 311
        *(*(dist->cols + minjet) + i) = (double )2 * tmp___2;
#line 309
        i ++;
      }
#line 314
      if (finalBunch->size >= bunchsize) {
#line 314
        break;
      }
#line 316
...
#line 320
        while (i < size) {
#line 322
          if ((unsigned long )*((*(modelJets->bunch + vert))->jets + i) == (unsigned long )((void *)0)) {
#line 323
            if (locmax < *(*(dist->cols + j) + i)) {
#line 323
              locmax = *(*(dist->cols + j) + i);
            } else {
#line 323
              locmax = locmax;
            }
...
#line 341 "src/csuEBGMGraphFit.c"
void guessVertexLocation(int vert , int maxvert , GraphDiscription graphTemplate ,
                         GraphDiscription bunchGraph ) 
{ 
  double locx ;
  double locy ;
  double tw ;
...
#line 353
    if (i != vert) {
#line 355
      dx = - (bunchGraph->verts + i)->x + (bunchGraph->verts + vert)->x;
#line 356
      dy = - (bunchGraph->verts + i)->y + (bunchGraph->verts + vert)->y;
#line 358
...
#line 375 "src/csuEBGMGraphFit.c"
void LocatePoint(double *x , double *y , JetBunch bunch , Image novel , JetMasks masks ,
                 double (*dispEst)(GaborJet j1 , GaborJet j2 , double *tdx , double *tdy ) ) 
{ 
  int i ;
  int best ;
...
#line 378
  bestsim = - 1.0e300;
#line 380
  tmp = extractJet(*x, *y, novel, masks);
#line 380
  njet = tmp;
#line 383
  i = 0;
...
#line 404 "src/csuEBGMGraphFit.c"
...
#line 414 "src/csuEBGMGraphFit.c"
void locateNovelFeatures(ImageList *novelImages , GraphDiscription graphTemplate ,
                         GraphDiscription bunchGraph , JetMasks masks , char *imageDir ,
                         char *outputDir , double (*dispEst)(GaborJet j1 , GaborJet j2 ,
                                                             double *tdx , double *tdy ) ) 
{ 
  ImageList *subject ;
  ImageList *replicate ;
  int i ;
...
#line 419
    while ((unsigned long )replicate != (unsigned long )((void *)0)) {
#line 420
      tmp = makePath((char const   *)imageDir, (char const   *)replicate->filename);
#line 420
      tmp___0 = readRawImage((char const   *)tmp);
#line 420
      novel = tmp___0;
#line 421
      tmp___1 = malloc(sizeof(int ) * (unsigned long )bunchGraph->numVert);
#line 421
      verts = (int *)tmp___1;
#line 422
      printf((char const   * __restrict  )"Fitting graph for image: %s |", replicate->filename);
#line 422
      fflush(stdout);
#line 423
      i = 0;
#line 423
      while (i < bunchGraph->numVert) {
#line 424
        printf((char const   * __restrict  )"#");
#line 424
        fflush(stdout);
...
#line 430
        LocatePoint(& (graphTemplate->verts + i)->x, & (graphTemplate->verts + i)->y,
                    *(bunchGraph->bunch + i), novel, masks, dispEst);
#line 431
        *(verts + i) = i;
#line 423
        i ++;
...
#line 436
      freeImage(novel);
#line 437
      tmp___2 = makePath((char const   *)outputDir, (char const   *)replicate->filename);
#line 437
      saveGraphDiscription((char const   *)tmp___2, graphTemplate);
#line 419
      replicate = replicate->next_replicate;
    }
#line 418
...
#line 443 "src/csuEBGMGraphFit.c"
int main(int argc , char **argv ) 
{ 
  GraphDiscription modelJets ;
  GraphDiscription bunchGraph ;
  GraphDiscription graphTemplate ;
  ImageList *modelImages ;
  ImageList *novelImages ;
  JetMasks masks ;
  Arguments args ;
  time_t tmp ;
  char *tmp___0 ;
...
#line 454
  masks = readMasksFile((char const   *)args.masksFile);
#line 455
  modelImages = getImageNames(args.modelFile, (int *)((void *)0));
#line 456
  novelImages = getImageNames(args.novelFile, (int *)((void *)0));
#line 457
  tmp___0 = makePath((char const   *)args.graphDir, (char const   *)modelImages->filename);
#line 457
  graphTemplate = readGraphDiscription((char const   *)tmp___0);
#line 460
  modelJets = extractModelJets(modelImages, args.imageDir, args.graphDir, masks);
#line 464
  bunchGraph = modelJets;
#line 467
  locateNovelFeatures(novelImages, graphTemplate, bunchGraph, masks, args.imageDir,
                      args.outputDir, args.dispEst);
#line 469
  return (0);
}
}
