...
#line 1 "csuEBGMMasks.o"
#pragma merger("0","/tmp/cil-n3Vv_ZLk.i","-O3,-Wall")
...
{ 
  ...
  {
#line 100
  printf((char const   * __restrict  )"Usage: %s mask_file outputdir\n", name);
#line 101
  exit(1);
}
}
#line 105 "src/csuEBGMMasks.c"
...
#line 113
  while (i < argc) {
#line 116
    tmp___1 = readOption(argc, argv, & i, "-help");
#line 116
    if (tmp___1) {
#line 116
...
#line 117
      tmp___0 = readOption(argc, argv, & i, "--help");
#line 117
      if (tmp___0) {
#line 117
        usage((char const   *)*(argv + 0));
...
#line 140
    printf((char const   * __restrict  )"**DEBUG %d** \"%s\"\n             at [%s]<%s():line %u>\n             %s\n",
           1, "Debuging enabled", "src/csuEBGMMasks.c", "processCommand", 140, tmp___3);
#line 140
    fflush(stdout);
  }
#line 141
...
#line 150
  if (quiet == 0) {
#line 150
    printf((char const   * __restrict  )"Saving Masks to files");
  } else
#line 150
  if (debuglevel != 0) {
#line 150
...
#line 151
  while (y < masks->size) {
#line 153
    sprintf((char * __restrict  )(outname), (char const   * __restrict  )"%s/mask%03d.pgm",
            args->outputDir, y);
#line 154
