...
#line 1 "csuEBGMGrid.o"
#pragma merger("0","/tmp/cil-TUW3HLXm.i","-O3,-Wall")
...
{ 
  ...
  {
#line 117
  printf((char const   * __restrict  )"Usage: %s [OPTIONS] input_dir imagelist output_dir mask_file\n",
         name);
#line 118
  printf((char const   * __restrict  )"  Computes Gabor Jets at a regular interval and outputs the values in sfi format\n");
#line 119
  printf((char const   * __restrict  )"  OPTIONS:\n");
#line 120
  printf((char const   * __restrict  )"    -gridStart x y          - Choose start location for the grid.\n");
#line 121
  printf((char const   * __restrict  )"                              Defaults to %d, %d \n",
         4, 9);
#line 122
  printf((char const   * __restrict  )"    -gridSpace x y          - Choose x and y spacing for the grid.\n");
#line 123
  printf((char const   * __restrict  )"                              Defaults to %d, %d \n",
         5, 5);
#line 124
...
#line 133
  param_num = 0;
#line 135
  args->imageList = (char *)((void *)0);
#line 136
  args->maskFile = (char *)((void *)0);
#line 137
...
#line 152
  while (i < argc) {
#line 155
    tmp___5 = readOption(argc, argv, & i, "-help");
#line 155
    if (tmp___5) {
#line 155
...
#line 159
        tmp___3 = readOptionInt2(argc, argv, & i, "-gridStart", & args->gridStartX,
                                 & args->gridStartY);
#line 159
        if (! tmp___3) {
#line 160
          tmp___2 = readOptionInt2(argc, argv, & i, "-gridSpace", & args->gridSpaceX,
                                   & args->gridSpaceY);
#line 160
          if (! tmp___2) {
#line 163
            tmp___1 = readOption(argc, argv, & i, "-quiet");
#line 163
            if (tmp___1) {
#line 163
              quiet = 1;
...
#line 195
    printf((char const   * __restrict  )"**DEBUG %d** \"%s\"\n             at [%s]<%s():line %u>\n             %s\n",
           1, "Debuging enabled", "src/csuEBGMGrid.c", "processCommand", 195, tmp___7);
#line 195
    fflush(stdout);
  }
#line 196
...
#line 205
  if (quiet == 0) {
#line 205
    printf((char const   * __restrict  )"Creating gabor masks.");
  } else
#line 205
  if (debuglevel != 0) {
#line 205
...
#line 205
    printf((char const   * __restrict  )"    [%s]<%s():line %u> %s\n", "src/csuEBGMGrid.c",
           "convertImages", 205, tmp___0);
  }
#line 205
  fflush(stdout);
#line 206
  masks = readMasksFile((char const   *)args->maskFile);
#line 208
  if (args->saveMasks) {
#line 209
    y = 0;
#line 209
    while (y < masks->size) {
#line 211
      sprintf((char * __restrict  )(outname), (char const   * __restrict  )"mask%03d.pgm",
              y);
#line 212
      writePGMImage((Image const   )*(masks->masks + y), (char const   *)(outname),
                    0);
#line 209
      y ++;
    }
...
#line 217
  list = fopen((char const   * __restrict  )args->imageList, (char const   * __restrict  )"r");
#line 218
  if (! list) {
#line 219
...
#line 223
  while (1) {
#line 223
    tmp___3 = fscanf((FILE * __restrict  )list, (char const   * __restrict  )"%s",
                     imagename);
#line 223
    if (! (tmp___3 == 1)) {
#line 223
...
#line 227
    sprintf((char * __restrict  )(filename), (char const   * __restrict  )"%s/%s",
            args->inputDir, imagename);
#line 228
    im = readRawImage((char const   *)(filename));
#line 229
...
#line 229
    if (quiet == 0) {
#line 229
      printf((char const   * __restrict  )"Processing file: %s", filename);
    } else
#line 229
    if (debuglevel != 0) {
#line 229
...
#line 247
          if (i < grid->width) {
#line 248
            *(*(*(grid->data + i) + j) + 0) = convolvePoint((double )x, (double )y,
                                                            0, (Image const   )im,
                                                            (Image const   )*(masks->masks + j));
          }
#line 246
          j ++;
        }
...
#line 255
    sprintf((char * __restrict  )(filename), (char const   * __restrict  )"%s/%s",
            args->sfiDir, imagename);
#line 256
    writeRawImage((Image const   )grid, (char const   *)(filename));
#line 258
    freeImage(grid);
#line 259
    freeImage(im);
