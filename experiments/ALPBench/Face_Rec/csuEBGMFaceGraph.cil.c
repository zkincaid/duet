...
#line 89 "src/csuEBGMFaceGraph.c"
...
#line 1 "csuEBGMFaceGraph.o"
#pragma merger("0","/tmp/cil-Zpbzt8ao.i","-O3,-Wall")
...
#line 98 "src/csuEBGMFaceGraph.c"
void usage(char const   *name ) 
{ 
  ...
  {
#line 99
  printf((char const   * __restrict  )"Usage: %s image_list.srt image_dir training_graph_dir gabor_file output_graph_dir\n\n",
         name);
#line 101
  printf((char const   * __restrict  )"**************************** DISCRIPTION ****************************\n");
#line 102
  printf((char const   * __restrict  )"* csuGaborFaceGraph                                                 *\n");
#line 103
  printf((char const   * __restrict  )"*                                                                   *\n");
#line 104
  printf((char const   * __restrict  )"* The purpose of this exicutable is to read a set of model images   *\n");
#line 105
...
#line 112
  printf((char const   * __restrict  )"  image_list.srt   - image list that contains all images that need\n");
#line 113
  printf((char const   * __restrict  )"                     face graphs.\n");
#line 114
  printf((char const   * __restrict  )"  image_dir        - directory containing test imagry.\n");
#line 115
  printf((char const   * __restrict  )"  novel_graph_dir  - the directory that contains the graph\n");
#line 116
  printf((char const   * __restrict  )"                     generated by csuGaborGraphFit.\n");
#line 117
  printf((char const   * __restrict  )"  wavelet_file     - gabor wavelet discription file.\n");
#line 118
  printf((char const   * __restrict  )"  facegraph_dir    - output directory where face graphs are stored.\n");
#line 119
  printf((char const   * __restrict  )"\n");
#line 120
  exit(1);
...
#line 123 "src/csuEBGMFaceGraph.c"
...
#line 139
  while (i < argc) {
#line 142
    tmp___4 = readOption(argc, argv, & i, "-help");
#line 142
    if (tmp___4) {
#line 142
...
#line 143
      tmp___3 = readOption(argc, argv, & i, "--help");
#line 143
      if (tmp___3) {
#line 143
        usage((char const   *)*(argv + 0));
...
#line 146
        tmp___2 = readOption(argc, argv, & i, "-quiet");
#line 146
        if (tmp___2) {
#line 146
          quiet = 1;
...
#line 147
          tmp___1 = readOption(argc, argv, & i, "-dcfree");
#line 147
          if (tmp___1) {
#line 147
            WiskottDCFree = 1.0;
...
#line 148
            tmp___0 = readOptionInt(argc, argv, & i, "-debuglevel", & debuglevel);
#line 148
            if (! tmp___0) {
#line 151
              tmp = checkBadOption(argc, argv, & i);
#line 151
              if (! tmp) {
#line 154
                if (param_num == 0) {
...
#line 181
    printf((char const   * __restrict  )"**DEBUG %d** \"%s\"\n             at [%s]<%s():line %u>\n             %s\n",
           1, "Debuging enabled", "src/csuEBGMFaceGraph.c", "processCommand", 181,
           tmp___6);
#line 181
    fflush(stdout);
  }
...
#line 185 "src/csuEBGMFaceGraph.c"
...
#line 202
      imagenum ++;
#line 203
      printf((char const   * __restrict  )"Processing: %s (%5d of %5d) %5.2f%%   \n",
             replicate->filename, imagenum, numImage, ((double )imagenum * 100.0) / (double )numImage);
#line 203
      fflush(stdout);
#line 205
      tmp = makePath((char const   *)args.graphDir, (char const   *)replicate->filename);
#line 205
      gd = readGraphDiscription((char const   *)tmp);
#line 206
      tmp___0 = makePath((char const   *)args.imageDir, (char const   *)replicate->filename);
#line 206
      face = readRawImage((char const   *)tmp___0);
#line 207
...
#line 210
      while (i < gd->numVert) {
#line 211
        *(graph->jets + i) = extractJet((gd->verts + i)->x, (gd->verts + i)->y, face,
                                        masks);
#line 210
        i ++;
      }
...
#line 214
      while (i < gd->numEdge) {
#line 216
        x = 0.5 * ((gd->verts + (gd->edges + i)->vert1)->x + (gd->verts + (gd->edges + i)->vert1)->x);
#line 217
        y = 0.5 * ((gd->verts + (gd->edges + i)->vert1)->y + (gd->verts + (gd->edges + i)->vert1)->y);
#line 219
...
#line 222
      tmp___1 = makePath((char const   *)args.outputDir, (char const   *)replicate->filename);
#line 222
      saveFaceGraph(tmp___1, graph);
#line 223
      freeImage(face);
#line 224
