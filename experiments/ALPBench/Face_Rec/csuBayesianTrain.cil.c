...
#line 99 "src/csuBayesianTrain.c"
...
#line 1 "csuBayesianTrain.o"
#pragma merger("0","/tmp/cil-DCF8WpdY.i","-O3,-Wall")
...
void writeSubspace(Subspace *s , char *training_filename , char *imageList , int argc ,
                   char **argv ) ;
#line 124 "src/csuBayesianTrain.c"
void usage(char const   *name ) 
{ 
  ...
  {
#line 126
  printf((char const   * __restrict  )"Usage: %s [OPTIONS] training_images.srt training_output_prefix\n",
         name);
#line 127
  printf((char const   * __restrict  )"  Parameters\n");
#line 128
  printf((char const   * __restrict  )"    training_images.srt:   Input image names.\n");
#line 129
  printf((char const   * __restrict  )"    training_output_prefix Prefix which is used to save the subspaces\n");
#line 130
  printf((char const   * __restrict  )"  Options\n");
#line 131
  printf((char const   * __restrict  )"    -imDir <dir>:          Image directory.\n        DEFAULT = \".\"\n");
#line 133
  printf((char const   * __restrict  )"    -ni <n>:               Total number of interpersonal images.\n        DEFAULT = 100\n");
#line 135
  printf((char const   * __restrict  )"    -ne <n>:               Total number of extrapersonal images.\n        DEFAULT = 100\n");
#line 137
  printf((char const   * __restrict  )"    -distances <file>:     Sort images using this distance matrix.\n        DEFAULT = \"Random\"\n");
#line 139
  printf((char const   * __restrict  )"    -maxRank n             When sorting, take these many top-ranked images\n");
#line 140
  printf((char const   * __restrict  )"     -dropNVectors <int>: Drops the first N vectors which are normally lighting effects.\n        DEFAULT = 0\n");
#line 141
  printf((char const   * __restrict  )"     -cutOffMode <mode>:  Selects the method for eigen vector selection after PCA trianing\n");
#line 142
  printf((char const   * __restrict  )"                          and droping the first vectors.  DEFAULT = SIMPLE\n");
#line 143
  printf((char const   * __restrict  )"          NONE            Retain eigenvectors.\n");
#line 144
  printf((char const   * __restrict  )"          SIMPLE          Retain a percentage of the eigenvectors. \n");
#line 145
  printf((char const   * __restrict  )"                          Expects value between 0.0 and 100.0, DEFAULT PERCENT = %f \n",
         60.0);
#line 146
  printf((char const   * __restrict  )"          ENERGY          Retain  eigenvectors accounting for a percentage of the total energy.\n");
#line 147
  printf((char const   * __restrict  )"                          Expects value between 0.0 and 100.0, DEFAULT PERCENT = %f\n",
         90.0);
#line 148
  printf((char const   * __restrict  )"          STRETCH         Retains all eigenvectors greater than a percentage of the largest eigenvector.\n");
#line 149
  printf((char const   * __restrict  )"                          Expects value between 0.0 and 100.0, DEFAULT PERCENT = %f\n",
         1.0);
#line 150
  printf((char const   * __restrict  )"          CLASSES         Retains as many eigenvectors as there LDA Classes: use only with LDA.\n");
#line 151
  printf((char const   * __restrict  )"                          Ignores cutOff value and uses number of classes instead\n");
#line 152
  printf((char const   * __restrict  )"     -cutOff <percent>:   Percentage of eigen vectors to retain (see cutOffMode).\n        DEFAULT = (See cutoff mode)\n");
#line 153
  printf((char const   * __restrict  )"    -quiet:                Turn off all messages.\n        DEFAULT = messages on\n");
#line 155
  printf((char const   * __restrict  )"    -debuglevel <int>:     Level of debug information to display        (automatically sets quiet to no).\n        DEFAULT = 0\n");
#line 158
  exit(1);
}
}
#line 167 "src/csuBayesianTrain.c"
...
#line 181
  args->distanceMatrix = (char *)((void *)0);
#line 182
  args->maxRank = -1;
#line 184
  args->cutOffMode = 1;
...
#line 192
  while (i < argc) {
#line 195
    tmp___21 = readOption(argc, argv, & i, "-help");
#line 195
    if (tmp___21) {
#line 195
...
#line 196
      tmp___20 = readOption(argc, argv, & i, "--help");
#line 196
      if (tmp___20) {
#line 196
        usage((char const   *)*(argv + 0));
...
#line 199
        tmp___19 = readOptionString(argc, argv, & i, "-imDir", & args->imageDirectory);
#line 199
        if (! tmp___19) {
#line 200
          tmp___18 = readOptionString(argc, argv, & i, "-distances", & args->distanceMatrix);
#line 200
          if (! tmp___18) {
#line 203
            tmp___17 = readOptionInt(argc, argv, & i, "-ni", & args->nIntrapersonal);
#line 203
            if (! tmp___17) {
#line 204
              tmp___16 = readOptionInt(argc, argv, & i, "-ne", & args->nExtrapersonal);
#line 204
              if (! tmp___16) {
#line 207
                tmp___15 = readOptionInt(argc, argv, & i, "-maxRank", & args->maxRank);
#line 207
                if (! tmp___15) {
#line 210
                  tmp___14 = readOptionInt(argc, argv, & i, "-dropNVectors", & args->dropNVectors);
#line 210
                  if (! tmp___14) {
#line 212
                    tmp___13 = readOptionMatch(argc, argv, & i, "-cutOffMode", "NONE");
#line 212
                    if (tmp___13) {
#line 213
                      args->cutOffMode = 0;
...
#line 214
                      tmp___12 = readOptionMatch(argc, argv, & i, "-cutOffMode", "SIMPLE");
#line 214
                      if (tmp___12) {
#line 215
                        args->cutOffMode = 1;
...
#line 216
                        tmp___11 = readOptionMatch(argc, argv, & i, "-cutOffMode",
                                                   "ENERGY");
#line 216
                        if (tmp___11) {
#line 217
...
#line 218
                          tmp___10 = readOptionMatch(argc, argv, & i, "-cutOffMode",
                                                     "STRETCH");
#line 218
                          if (tmp___10) {
#line 219
...
#line 220
                            tmp___9 = readOptionMatch(argc, argv, & i, "-cutOffMode",
                                                      "CLASSES");
#line 220
                            if (tmp___9) {
#line 221
...
#line 223
                              tmp___8 = readOptionDouble(argc, argv, & i, "-cutOff",
                                                         & args->cutOff);
#line 223
                              if (tmp___8) {
#line 225
                                if (args->cutOff <= 1.0) {
#line 225
                                  if (args->cutOff >= 0.000001) {
#line 226
                                    printf((char const   * __restrict  )"WARNING: cutOff value is %f, expects percentage between 0.0 and 100.0",
                                           args->cutOff);
#line 228
                                    printf((char const   * __restrict  )"         will proceed assuming value is as desired.");
                                  }
                                }
#line 230
                                cutOffSet = 1;
...
#line 234
                                tmp___7 = readOption(argc, argv, & i, "-quiet");
#line 234
                                if (tmp___7) {
#line 234
                                  quiet = 1;
...
#line 235
                                  tmp___6 = readOptionInt(argc, argv, & i, "-debuglevel",
                                                          & debuglevel);
#line 235
                                  if (! tmp___6) {
#line 238
                                    tmp___5 = checkBadOption(argc, argv, & i);
#line 238
                                    if (! tmp___5) {
#line 241
                                      if (param_num == 0) {
...
#line 245
                                      if (param_num == 1) {
#line 246
                                        tmp___4 = __strdup((char const   *)*(argv + i));
#line 246
                                        args->trainingFilename = tmp___4;
#line 247
                                        param_num ++;
                                      }
                                    }
...
#line 257
    tttt = tmp___22;
#line 257
    tmp___23 = ctime((time_t const   *)(& tttt));
#line 257
    printf((char const   * __restrict  )"**DEBUG %d** \"%s\" %s=%d\n             at [%s]<%s():line %u>\n             %s\n",
           1, "Debuging enabled", "debuglevel", debuglevel, "src/csuBayesianTrain.c",
           "process_command", 257, tmp___23);
#line 257
    fflush(stdout);
  }
#line 258
...
#line 260
    printf((char const   * __restrict  )"Image directory:  %s\n", args->imageDirectory);
#line 261
    printf((char const   * __restrict  )"Image list:       %s\n", args->imageList);
#line 262
    printf((char const   * __restrict  )"nIntrapersonal:   %d\n", args->nIntrapersonal);
#line 263
    printf((char const   * __restrict  )"nExtrapersonal:   %d\n", args->nExtrapersonal);
#line 264
    printf((char const   * __restrict  )"distanceMatrix:   %s\n ", args->distanceMatrix);
  }
#line 266
  return;
}
}
#line 272 "src/csuBayesianTrain.c"
void makeDifferenceImages(char *imageDirectory , char *imageList , char *distanceMatrix ,
                          int maxRank , int reqNIntra , int reqNExtra , Matrix *intrapersonal ,
                          Matrix *extrapersonal ) 
{ 
  ImageList *imlist ;
  void *nameList ;
  char **nameArray ;
...
#line 293
      tmp___4 = __strdup((char const   *)replicate->filename);
#line 293
      subjName = tmp___4;
#line 294
      listAccumulate(& nameList, (void *)(& subjName), sizeof(char *));
#line 295
      listAccumulate(& subjList, (void *)(& subjId), sizeof(int ));
#line 296
      writeProgress((char *)"Reading subjects list", subjId, 0);
#line 292
...
#line 301
  tmp___5 = listToNullTerminatedArray(& nameList, sizeof(char *), (size_t *)((void *)0));
#line 301
  nameArray = (char **)tmp___5;
#line 302
  tmp___6 = listToNullTerminatedArray(& subjList, sizeof(int ), (size_t *)((void *)0));
#line 302
  subjArray = (int *)tmp___6;
#line 306
  tmp___7 = makePath((char const   *)imageDirectory, (char const   *)*(nameArray + 0));
#line 306
  numPixels = autoFileLength((char const   *)tmp___7);
#line 308
...
#line 312
  if (! ((unsigned long )sourceImages != (unsigned long )((void *)0))) {
#line 312
...
#line 312
    printf((char const   * __restrict  )"**DEBUG CHECK** Failed check (%s) \"%s\"\n             at [%s]<%s():line %u>\n             %s\n",
           "sourceImages != NULL", "Not enough memory to allocate matrix", "src/csuBayesianTrain.c",
           "makeDifferenceImages", 312, tmp___9);
#line 312
    fflush(stdout);
#line 312
    exit(1);
...
#line 313
  if (! ((unsigned long )intraImages != (unsigned long )((void *)0))) {
#line 313
    tmp___10 = time((time_t *)0);
#line 313
    tttt___0 = tmp___10;
#line 313
    tmp___11 = ctime((time_t const   *)(& tttt___0));
#line 313
    printf((char const   * __restrict  )"**DEBUG CHECK** Failed check (%s) \"%s\"\n             at [%s]<%s():line %u>\n             %s\n",
           "intraImages != NULL", "Not enough memory to allocate matrix", "src/csuBayesianTrain.c",
           "makeDifferenceImages", 313, tmp___11);
#line 313
    fflush(stdout);
#line 313
    exit(1);
...
#line 314
  if (! ((unsigned long )extraImages != (unsigned long )((void *)0))) {
#line 314
    tmp___12 = time((time_t *)0);
#line 314
    tttt___1 = tmp___12;
#line 314
    tmp___13 = ctime((time_t const   *)(& tttt___1));
#line 314
    printf((char const   * __restrict  )"**DEBUG CHECK** Failed check (%s) \"%s\"\n             at [%s]<%s():line %u>\n             %s\n",
           "extraImages != NULL", "Not enough memory to allocate matrix", "src/csuBayesianTrain.c",
           "makeDifferenceImages", 314, tmp___13);
#line 314
    fflush(stdout);
#line 314
    exit(1);
...
#line 318
  while (i < nImages) {
#line 319
    tmp___14 = makePath((char const   *)imageDirectory, (char const   *)*(nameArray + i));
#line 319
    readFile((char const   *)tmp___14, i, sourceImages);
#line 320
    writeProgress((char *)"Loading source images", i, nImages);
#line 318
    i ++;
  }
#line 325
...
#line 338
  tmp___15 = malloc((unsigned long )nImages * sizeof(int *));
#line 338
  sortedBySimilarityToProbe = (int **)tmp___15;
#line 339
  probeIdx = 0;
#line 339
  while (probeIdx < nImages) {
#line 340
    tmp___16 = malloc((unsigned long )nImages * sizeof(int ));
#line 340
    *(sortedBySimilarityToProbe + probeIdx) = (int *)tmp___16;
#line 341
    if ((unsigned long )*(sortedBySimilarityToProbe + probeIdx) == (unsigned long )((int *)0)) {
#line 343
      fprintf((FILE * __restrict  )stderr, (char const   * __restrict  )"Not enough memory to continue\n");
#line 344
      exit(1);
    }
#line 346
    sortSubjectsBySimilarityToProbe(*(nameArray + probeIdx), nameArray, distanceMatrix,
                                    *(sortedBySimilarityToProbe + probeIdx));
#line 347
    writeProgress((char *)"Sorting images", probeIdx, nImages);
#line 339
    probeIdx ++;
  }
#line 352
...
#line 365
        fprintf((FILE * __restrict  )stderr, (char const   * __restrict  )"WARNING: Unable to generate enough images. Try increasing maxRank or adding more subjects to the list.\n");
#line 366
        break;
      }
    }
...
#line 372
      if (0) {
#line 372
        __s1_len = __builtin_strlen((char const   *)*(nameArray + probeIdx));
#line 372
        __s2_len = __builtin_strlen((char const   *)*(nameArray + galleryIdx));
#line 372
        if (! ((size_t )((void const   *)(*(nameArray + probeIdx) + 1)) - (size_t )((void const   *)*(nameArray + probeIdx)) == 1UL)) {
#line 372
          goto _L___0;
        } else
#line 372
        if (__s1_len >= 4UL) {
          _L___0: /* CIL Label */ 
#line 372
          if (! ((size_t )((void const   *)(*(nameArray + galleryIdx) + 1)) - (size_t )((void const   *)*(nameArray + galleryIdx)) == 1UL)) {
#line 372
            tmp___23 = 1;
          } else
#line 372
...
#line 372
        if (tmp___23) {
#line 372
          tmp___18 = __builtin_strcmp((char const   *)*(nameArray + probeIdx), (char const   *)*(nameArray + galleryIdx));
#line 372
          tmp___22 = tmp___18;
        } else {
#line 372
          tmp___21 = __builtin_strcmp((char const   *)*(nameArray + probeIdx), (char const   *)*(nameArray + galleryIdx));
#line 372
          tmp___22 = tmp___21;
        }
      } else {
...
#line 380
        i = 0;
#line 380
        while (i < sourceImages->row_dim) {
#line 381
          *(*(intraImages->cols + nIntrapersonal) + i) = *(*(sourceImages->cols + probeIdx) + i) - *(*(sourceImages->cols + galleryIdx) + i);
#line 380
          i ++;
        }
#line 383
...
#line 389
      while (i < sourceImages->row_dim) {
#line 390
        *(*(extraImages->cols + nExtrapersonal) + i) = *(*(sourceImages->cols + probeIdx) + i) - *(*(sourceImages->cols + galleryIdx) + i);
#line 389
        i ++;
      }
#line 392
...
#line 396
    writeProgress((char *)"Computing difference images", nIntrapersonal + nExtrapersonal,
                  reqNIntra + reqNExtra);
  }
#line 399
  fprintf((FILE * __restrict  )stdout, (char const   * __restrict  )"Generated %d extrapersonal images\n",
          nExtrapersonal);
#line 400
  fprintf((FILE * __restrict  )stdout, (char const   * __restrict  )"Generated %d intrapersonal images\n",
          nIntrapersonal);
#line 404
  probeIdx = 0;
#line 404
  while (probeIdx < nImages) {
#line 405
    free((void *)*(sortedBySimilarityToProbe + probeIdx));
#line 404
    probeIdx ++;
  }
#line 406
  free((void *)sortedBySimilarityToProbe);
#line 408
...
#line 424 "src/csuBayesianTrain.c"
int main(int argc , char **argv ) 
{ 
  Arguments args ;
  Matrix intraImages ;
  Matrix extraImages ;
  Subspace intraSubspace ;
  Subspace extraSubspace ;
  char filename[256] ;
  time_t tttt ;
  time_t tmp ;
  char *tmp___0 ;
...
#line 433
  if (quiet == 0) {
#line 433
    printf((char const   * __restrict  )"Trains the Bayesian Interpersonal/Extrapersonal Classifier.");
  } else
#line 433
  if (debuglevel != 0) {
#line 433
...
#line 434
  fflush(stdout);
#line 438
  checkReadableDirectory((char const   *)args.imageDirectory, "%s is not a readable directory");
#line 439
  checkReadableFile((char const   *)args.imageList, "Cannot read subject replicates list %s");
#line 441
  makeDifferenceImages(args.imageDirectory, args.imageList, args.distanceMatrix, args.maxRank,
                       args.nIntrapersonal, args.nExtrapersonal, & intraImages, & extraImages);
#line 451
...
#line 451
  if (quiet == 0) {
#line 451
    printf((char const   * __restrict  )"Training intrapersonal subspace");
  } else
#line 451
  if (debuglevel != 0) {
#line 451
...
#line 451
  fflush(stdout);
#line 453
  subspaceTrain(& intraSubspace, intraImages, (ImageList *)((void *)0), args.nIntrapersonal,
                args.dropNVectors, (CutOffMode )args.cutOffMode, args.cutOff, 0, 0);
#line 455
...
#line 455
  if (quiet == 0) {
#line 455
    printf((char const   * __restrict  )"Training extrapersonal subspace");
  } else
#line 455
  if (debuglevel != 0) {
#line 455
...
#line 455
  fflush(stdout);
#line 457
  subspaceTrain(& extraSubspace, extraImages, (ImageList *)((void *)0), args.nExtrapersonal,
                args.dropNVectors, (CutOffMode )args.cutOffMode, args.cutOff, 0, 0);
#line 459
...
#line 459
  if (quiet == 0) {
#line 459
    printf((char const   * __restrict  )"Saving intrapersonal training file");
  } else
#line 459
  if (debuglevel != 0) {
#line 459
...
#line 459
  fflush(stdout);
#line 461
  sprintf((char * __restrict  )(filename), (char const   * __restrict  )"%s.intra",
          args.trainingFilename);
#line 462
...
#line 464
  if (quiet == 0) {
#line 464
    printf((char const   * __restrict  )"Saving extrapersonal training file");
  } else
#line 464
  if (debuglevel != 0) {
#line 464
...
#line 464
  fflush(stdout);
#line 466
  sprintf((char * __restrict  )(filename), (char const   * __restrict  )"%s.extra",
          args.trainingFilename);
#line 467
...
#line 469
  if (quiet == 0) {
#line 469
    printf((char const   * __restrict  )"Finished Training.");
  } else
#line 469
  if (debuglevel != 0) {
#line 469
