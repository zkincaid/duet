...
#line 103 "src/csuSubspaceTrain.c"
...
#line 128 "src/csuCommonMatrix.h"
...
#line 156 "src/csuCommonSubspace.h"
...
#line 1 "csuSubspaceTrain.o"
#pragma merger("0","/tmp/cil-KhOkMdzJ.i","-O3,-Wall")
...
void writeSubspace(Subspace *s , char *training_filename , char *imageList , int argc ,
                   char **argv ) ;
#line 123 "src/csuSubspaceTrain.c"
void usage(char const   *prog ) 
{ 
  ...
  {
#line 124
  printf((char const   * __restrict  )"Usage: %s [OPTIONS] training_images.[list/srt] training_output\n",
         prog);
#line 125
  printf((char const   * __restrict  )"  Parameters\n");
#line 126
  printf((char const   * __restrict  )"    training_images: image names file\n");
#line 127
  printf((char const   * __restrict  )"    trainName: training output file\n");
#line 128
  printf((char const   * __restrict  )"  Options\n");
#line 129
  printf((char const   * __restrict  )"    -lda:                enable lda training. (Must use srt file)\n        DEFAULT = PCA Only\n");
#line 130
  printf((char const   * __restrict  )"    -imDir <dir>:        image directory.\n        DEFAULT = \".\"\n");
#line 131
  printf((char const   * __restrict  )"    -vecLength <int>:    vector length.\n        DEFAULT = \"Auto\"\n");
#line 132
...
#line 145
  printf((char const   * __restrict  )"    -writeTextBasis:     Causes the program to print the basis vectors to text files.\n        DEFAULT = No\n");
#line 146
  printf((char const   * __restrict  )"    -writeTextValues:    Causes the program to print the basis values to text files.\n        DEFAULT = No\n");
#line 147
  printf((char const   * __restrict  )"    -writeTextInterm:    Causes the program to print intermediate matricies.\n        DEFAULT = No\n");
#line 148
  printf((char const   * __restrict  )"    -outputMatlabAscii:  Causes the program to print matricies in matlab format.\n        DEFAULT = Octave format\n");
#line 149
...
#line 170 "src/csuSubspaceTrain.c"
...
#line 189
  while (i < argc) {
#line 192
    tmp___34 = readOption(argc, argv, & i, "-help");
#line 192
    if (tmp___34) {
#line 192
...
#line 193
      tmp___33 = readOption(argc, argv, & i, "--help");
#line 193
      if (tmp___33) {
#line 193
        usage((char const   *)*(argv + 0));
...
#line 196
        tmp___32 = readOptionString(argc, argv, & i, "-imDir", & args->imageDirectory);
#line 196
        if (! tmp___32) {
#line 198
          tmp___31 = readOptionInt(argc, argv, & i, "-vecLength", & args->vecLength);
#line 198
          if (! tmp___31) {
#line 199
            tmp___30 = readOptionInt(argc, argv, & i, "-dropNVectors", & args->dropNVectors);
#line 199
            if (! tmp___30) {
#line 201
              tmp___29 = readOptionMatch(argc, argv, & i, "-cutOffMode", "NONE");
#line 201
              if (tmp___29) {
#line 202
                args->cutOffMode = 0;
...
#line 203
                tmp___28 = readOptionMatch(argc, argv, & i, "-cutOffMode", "SIMPLE");
#line 203
                if (tmp___28) {
#line 204
                  args->cutOffMode = 1;
...
#line 205
                  tmp___27 = readOptionMatch(argc, argv, & i, "-cutOffMode", "ENERGY");
#line 205
                  if (tmp___27) {
#line 206
                    args->cutOffMode = 2;
...
#line 207
                    tmp___26 = readOptionMatch(argc, argv, & i, "-cutOffMode", "STRETCH");
#line 207
                    if (tmp___26) {
#line 208
                      args->cutOffMode = 3;
...
#line 209
                      tmp___25 = readOptionMatch(argc, argv, & i, "-cutOffMode", "CLASSES");
#line 209
                      if (tmp___25) {
#line 210
                        args->cutOffMode = 4;
...
#line 212
                        tmp___24 = readOptionDouble(argc, argv, & i, "-cutOff", & args->cutOff);
#line 212
                        if (tmp___24) {
#line 214
                          if (args->cutOff <= 1.0) {
...
#line 222
                          tmp___23 = readOption(argc, argv, & i, "-lda");
#line 222
                          if (tmp___23) {
#line 222
                            args->uselda = 1;
...
#line 223
                            tmp___22 = readOption(argc, argv, & i, "-writeTextBasis");
#line 223
                            if (tmp___22) {
#line 223
                              args->writeTextBasis = 1;
                            } else {
#line 224
                              tmp___21 = readOption(argc, argv, & i, "-writeTextValues");
#line 224
                              if (tmp___21) {
#line 224
                                args->writeTextValues = 1;
                              } else {
#line 225
                                tmp___20 = readOption(argc, argv, & i, "-writeTextInterm");
#line 225
                                if (tmp___20) {
#line 225
                                  args->writeTextInterm = 1;
                                } else {
#line 226
                                  tmp___19 = readOption(argc, argv, & i, "-outputMatlabAscii");
#line 226
                                  if (tmp___19) {
#line 226
                                    asciiFormat = (MatrixSaveMode )1;
                                  } else {
#line 229
                                    tmp___18 = readOption(argc, argv, & i, "-quiet");
#line 229
                                    if (tmp___18) {
#line 229
                                      quiet = 1;
...
#line 230
                                      tmp___17 = readOptionInt(argc, argv, & i, "-debuglevel",
                                                               & debuglevel);
#line 230
                                      if (! tmp___17) {
#line 233
...
#line 238
                                          args->training_filename = tmp___16;
#line 239
                                          param_num ++;
                                        } else {
#line 241
...
#line 268
  if (! args->uselda) {
#line 268
    if (args->cutOffMode == 4) {
#line 269
      printf((char const   * __restrict  )"Warning: Cutoff Mode Classes meant for use with lda only.\n");
    }
  }
#line 273
  if (1 <= debuglevel) {
...
#line 273
    tttt = tmp___35;
#line 273
    tmp___36 = ctime((time_t const   *)(& tttt));
#line 273
    printf((char const   * __restrict  )"**DEBUG %d** \"%s\"\n             at [%s]<%s():line %u>\n             %s\n",
           1, "Debuging enabled", "src/csuSubspaceTrain.c", "process_command", 273,
           tmp___36);
#line 273
    fflush(stdout);
  }
...
#line 278
    printf((char const   * __restrict  )"Training file:   %s\n", args->training_filename);
#line 279
    printf((char const   * __restrict  )"vecLength:       %d\n", args->vecLength);
#line 280
    if (args->uselda) {
#line 280
      tmp___37 = "YES";
...
#line 280
    printf((char const   * __restrict  )"useLda:          %s\n", tmp___37);
#line 281
    printf((char const   * __restrict  )"cutOff:          %f\n", args->cutOff);
  }
#line 283
  return;
}
}
#line 289 "src/csuSubspaceTrain.c"
...
#line 300
  if (quiet == 0) {
#line 300
    printf((char const   * __restrict  )"From Training Imagery, Build a PCA or PCA+LDA Subspace.");
  } else
#line 300
  if (debuglevel != 0) {
#line 300
...
#line 308
  if (quiet == 0) {
#line 308
    printf((char const   * __restrict  )"Reading images from files in directory %s.",
           args.imageDirectory);
  } else
#line 308
  if (debuglevel != 0) {
...
#line 308
  fflush(stdout);
#line 310
  images = readImages(args.imageList, args.imageDirectory, & args.vecLength, & numImages,
                      & numSubjects, & srt);
#line 313
  subspaceTrain(& subspace, images, srt, numSubjects, args.dropNVectors, (CutOffMode )args.cutOffMode,
                args.cutOff, args.uselda, args.writeTextInterm);
#line 316
  if (args.writeTextBasis) {
#line 318
    saveMatrixAscii((char const   *)((void *)0), "subspace.basis", (Matrix const   )subspace.basis,
                    asciiFormat);
#line 319
    saveMatrixAscii((char const   *)((void *)0), "subspace.mean", (Matrix const   )subspace.mean,
                    asciiFormat);
#line 321
    saveMatrixAscii((char const   *)((void *)0), "subspace.values", (Matrix const   )subspace.values,
                    asciiFormat);
  }
#line 324
