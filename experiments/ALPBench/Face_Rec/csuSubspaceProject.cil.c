...
#line 109 "src/csuSubspaceProject.c"
struct distDirNode {
...
#line 116 "src/csuSubspaceProject.c"
struct __anonstruct_Arguments_34 {
   char *trainingFile ;
   char *imageNamesFile ;
   char *imageDirectory ;
...
#line 116 "src/csuSubspaceProject.c"
typedef struct __anonstruct_Arguments_34 Arguments;
#line 153 "/usr/include/x86_64-linux-gnu/bits/mathinline.h"
...
#line 1 "csuSubspaceProject.o"
#pragma merger("0","/tmp/cil-qptqHmds.i","-O3,-Wall")
...
#line 154 "/usr/include/x86_64-linux-gnu/bits/mathcalls.h"
...
#line 134 "src/csuCommonSubspace.h"
...
#line 150 "src/csuSubspaceProject.c"
void usage(char const   *prog ) 
{ 
  ...
  {
#line 151
  printf((char const   * __restrict  )"Usage: %s [OPTIONS] trianingFile imageNamesFile.[list/srt] [distanceDirectory distName]+\n",
         prog);
#line 152
  printf((char const   * __restrict  )"  Parameters:\n");
#line 153
  printf((char const   * __restrict  )"     trainingFile ....  Name of file containing subspace generated by training.\n");
#line 154
  printf((char const   * __restrict  )"     imageNamesFile...  Name of file containing test images: union of possible probe and gallery sets.\n");
#line 155
  printf((char const   * __restrict  )"  List of distance measures and corresponding distance directories: \n");
#line 156
  printf((char const   * __restrict  )"     distDirectory ...  Directory where distances files are to be written\n");
#line 157
  printf((char const   * __restrict  )"     distName ........  The distance measure to use, must be one of:\n");
#line 158
  printf((char const   * __restrict  )"        Euclidean ....  Standard Euclidean Distance, i.e. L2 norm.\n");
#line 159
  printf((char const   * __restrict  )"        Cityblock ....  Standard L1 norm.\n");
#line 160
  printf((char const   * __restrict  )"        Covariance ...  Sometimes called angle in FERET: dot product after unit normalization.\n");
#line 161
  printf((char const   * __restrict  )"        Correlation ..  Normalize images to mean zero and standard deviation one, then take dot product.\n");
#line 162
  printf((char const   * __restrict  )"        MahCosine ....  This measure is the cosine of the angle between the two feature vectors in Mahlinobis space.\n");
#line 163
  printf((char const   * __restrict  )"        MahL1 ........  L1 norm distance in Mahalanobis space.\n");
#line 164
  printf((char const   * __restrict  )"        MahL2 ........  L2 norm distance in Mahalanobis space.\n");
#line 165
  printf((char const   * __restrict  )"        YamborAngle ..  This is the same measure as \"MahAngle\" in \n                        version 4.0 and before.  It has been depricated \n                        because the measure is not properly formulated.  \n                        MahCosine has replaced it in newer versions. \n");
#line 169
  printf((char const   * __restrict  )"        YamborDist ...  This is the distance measure presented as \n                        \"Mahalinobis Distance\" in Wendy Yambor\'s \n                        Thesis.  It is included here for completness.\n");
#line 172
  printf((char const   * __restrict  )"        ldaSoft ......  For LDA only, a variant of L2 use by Wenyi Zhao that weights dimensions by lambda.\n");
#line 173
  printf((char const   * __restrict  )"    -imDir <dir>:       image directory. DEFAULT = \".\"\n");
#line 174
  printf((char const   * __restrict  )"    -debuglevel <int>:  Level of debug information to display. DEFAULT = 0\n");
#line 175
  printf((char const   * __restrict  )"    -quiet:             Turn off all messages. DEFAULT = messages on\n");
#line 177
  exit(1);
}
}
#line 180 "src/csuSubspaceProject.c"
...
#line 196
  tmp___10 = __strdup(".");
#line 196
  args->ind_name = tmp___10;
#line 197
  tmp___16 = __strdup(".");
#line 197
  args->of_name = tmp___16;
#line 198
  tmp___22 = __strdup(".");
#line 198
  args->of_dir = tmp___22;
#line 199
  tmp___28 = __strdup(".");
#line 199
  args->subspace_name = tmp___28;
#line 201
  i = 1;
#line 201
  while (i < argc) {
#line 204
    tmp___64 = readOption(argc, argv, & i, "-help");
#line 204
    if (tmp___64) {
#line 204
...
#line 205
      tmp___63 = readOption(argc, argv, & i, "--help");
#line 205
      if (tmp___63) {
#line 205
        usage((char const   *)*(argv + 0));
...
#line 208
        tmp___62 = readOptionString(argc, argv, & i, "-imDir", & args->imageDirectory);
#line 208
        if (! tmp___62) {
#line 211
          tmp___61 = readOption(argc, argv, & i, "-quiet");
#line 211
          if (tmp___61) {
#line 211
            quiet = 1;
...
#line 212
            tmp___60 = readOption(argc, argv, & i, "-lastphase");
#line 212
            if (tmp___60) {
#line 212
              args->lastphase = 1;
...
#line 213
              tmp___59 = readOptionString(argc, argv, & i, "-infile", & args->ind_name);
#line 213
              if (! tmp___59) {
#line 214
                tmp___58 = readOptionString(argc, argv, & i, "-outfile", & args->of_name);
#line 214
                if (! tmp___58) {
#line 215
                  tmp___57 = readOptionString(argc, argv, & i, "-outdir", & args->of_dir);
#line 215
                  if (! tmp___57) {
#line 216
                    tmp___56 = readOptionString(argc, argv, & i, "-subspace", & args->subspace_name);
#line 216
                    if (! tmp___56) {
#line 217
                      tmp___55 = readOptionInt(argc, argv, & i, "-debuglevel", & debuglevel);
#line 217
                      if (! tmp___55) {
#line 219
                        if (param_num == 0) {
#line 220
                          tmp___34 = __strdup((char const   *)*(argv + i));
#line 220
                          args->trainingFile = tmp___34;
#line 221
                          param_num ++;
                        } else
#line 222
                        if (param_num == 1) {
#line 223
                          tmp___40 = __strdup((char const   *)*(argv + i));
#line 223
                          args->imageNamesFile = tmp___40;
#line 224
                          param_num ++;
                        } else
#line 225
                        if (param_num > 1) {
#line 226
                          tmp___42 = malloc(sizeof(DistDirNode ));
#line 226
                          tmp___41 = (DistDirNode *)tmp___42;
#line 227
                          tmp___41->next = args->distList;
#line 228
                          tmp___48 = __strdup((char const   *)*(argv + i));
#line 228
                          tmp___41->distDirectory = tmp___48;
#line 229
                          i ++;
#line 230
                          tmp___54 = __strdup((char const   *)*(argv + i));
#line 230
                          tmp___41->distName = tmp___54;
#line 231
                          args->distList = tmp___41;
#line 232
                          param_num ++;
                        }
                      }
...
#line 242
  if (1 <= debuglevel) {
#line 242
    tmp___65 = time((time_t *)0);
#line 242
    tttt = tmp___65;
#line 242
    tmp___66 = ctime((time_t const   *)(& tttt));
#line 242
    printf((char const   * __restrict  )"**DEBUG %d** \"%s\" %s=%d\n             at [%s]<%s():line %u>\n             %s\n",
           1, "Debuging enabled", "debuglevel", debuglevel, "src/csuSubspaceProject.c",
           "process_command", 242, tmp___66);
#line 242
    fflush(stdout);
  }
#line 244
  tmp___67 = time((time_t *)0);
#line 244
  tttt___0 = tmp___67;
#line 244
  if (quiet == 0) {
#line 244
    printf((char const   * __restrict  )"bef print\n");
  } else
#line 244
  if (debuglevel != 0) {
#line 244
...
#line 244
  if (debuglevel > 0) {
#line 244
    tmp___68 = ctime((time_t const   *)(& tttt___0));
#line 244
    printf((char const   * __restrict  )"    [%s]<%s():line %u> %s\n", "src/csuSubspaceProject.c",
           "process_command", 244, tmp___68);
  }
#line 244
  fflush(stdout);
#line 247
  if (debuglevel > 0) {
#line 249
    printf((char const   * __restrict  )"***************** Program Parameters *********************\n");
#line 251
    tmp___69 = time((time_t *)0);
#line 251
    tttt___1 = tmp___69;
#line 251
    if (quiet == 0) {
#line 251
      printf((char const   * __restrict  )"aft 1st msg print\n");
    } else
#line 251
    if (debuglevel != 0) {
#line 251
...
#line 251
    if (debuglevel > 0) {
#line 251
      tmp___70 = ctime((time_t const   *)(& tttt___1));
#line 251
      printf((char const   * __restrict  )"    [%s]<%s():line %u> %s\n", "src/csuSubspaceProject.c",
             "process_command", 251, tmp___70);
    }
#line 251
    fflush(stdout);
#line 253
    printf((char const   * __restrict  )"imageNamesFile: %s\n", args->imageNamesFile);
#line 254
    printf((char const   * __restrict  )"imageDirectory: %s\n", args->imageDirectory);
  }
#line 257
...
#line 257
  if (quiet == 0) {
#line 257
    printf((char const   * __restrict  )"after all msgs\n");
  } else
#line 257
  if (debuglevel != 0) {
#line 257
...
#line 257
  if (debuglevel > 0) {
#line 257
    tmp___72 = ctime((time_t const   *)(& tttt___2));
#line 257
    printf((char const   * __restrict  )"    [%s]<%s():line %u> %s\n", "src/csuSubspaceProject.c",
           "process_command", 257, tmp___72);
  }
#line 257
  fflush(stdout);
#line 259
...
#line 279 "src/csuSubspaceProject.c"
double distanceCityBlock(Matrix const   ims , int i , int j ) 
{ 
  int k ;
  double sum ;
  double tmp ;
...
#line 282
  while (k < ims->row_dim) {
#line 283
    if (*(*(ims->cols + i) + k) - *(*(ims->cols + j) + k) < (double )0) {
#line 283
      tmp = - (*(*(ims->cols + i) + k) - *(*(ims->cols + j) + k));
    } else {
#line 283
      tmp = *(*(ims->cols + i) + k) - *(*(ims->cols + j) + k);
    }
...
#line 288 "src/csuSubspaceProject.c"
double distanceEuclidean(Matrix const   ims , int i , int j ) 
{ 
  int k ;
  double sum ;
  double tmp ;
...
#line 291
  while (k < ims->row_dim) {
#line 292
    sum += (*(*(ims->cols + i) + k) - *(*(ims->cols + j) + k)) * (*(*(ims->cols + i) + k) - *(*(ims->cols + j) + k));
#line 291
    k ++;
  }
#line 294
...
#line 306 "src/csuSubspaceProject.c"
double distanceCovariance(Matrix const   ims , int i , int j ) 
{ 
  int k ;
  double magi ;
  double magj ;
...
#line 310
  while (k < ims->row_dim) {
#line 311
    magi += *(*(ims->cols + i) + k) * *(*(ims->cols + i) + k);
#line 312
    magj += *(*(ims->cols + j) + k) * *(*(ims->cols + j) + k);
#line 313
    dot += *(*(ims->cols + i) + k) * *(*(ims->cols + j) + k);
#line 310
    k ++;
  }
#line 315
...
#line 315
  tmp___0 = sqrt(magj);
#line 315
  return (1.0 - dot / (tmp * tmp___0));
}
}
#line 327 "src/csuSubspaceProject.c"
double distanceCorrelation(Matrix const   ims , int i , int j ) 
{ 
  int k ;
  double n ;
  double mui ;
...
#line 340
  while ((double )k < n) {
#line 341
    stdi += (*(*(ims->cols + i) + k) - mui) * (*(*(ims->cols + i) + k) - mui);
#line 342
    stdj += (*(*(ims->cols + j) + k) - muj) * (*(*(ims->cols + j) + k) - muj);
#line 343
    dot += (*(*(ims->cols + i) + k) - mui) * (*(*(ims->cols + j) + k) - muj);
#line 340
    k ++;
  }
#line 345
...
#line 360 "src/csuSubspaceProject.c"
...
#line 365
  while (k < ims->row_dim) {
#line 366
    sum_i += *(*(ims->cols + i) + k) * *(*(ims->cols + i) + k);
#line 367
    sum_j += *(*(ims->cols + j) + k) * *(*(ims->cols + j) + k);
#line 365
    k ++;
  }
#line 369
...
#line 370
    tmp___0 = sqrt(sum_j);
#line 370
    tmp___1 = sqrt(*(*(values->cols + 0) + k));
#line 370
    sum -= ((*(*(ims->cols + i) + k) / tmp) * (*(*(ims->cols + j) + k) / tmp___0)) * ((double )1 / tmp___1);
#line 369
    k ++;
  }
#line 372
...
#line 536
double distanceMahCosine(Matrix ims , int i , int j , Matrix values , Matrix vi ,
                         Matrix vj , Matrix optVals___2 ) ;
#line 528 "src/csuSubspaceProject.c"
double distanceMahCosine(Matrix ims , int i , int j , Matrix values , Matrix vi ,
                         Matrix vj , Matrix optVals___2 ) 
{ 
  int k ;
...
#line 538
  vj_p = *(vj->cols + 0) + 0;
#line 539
  ims_i_p = *(ims->cols + i) + 0;
#line 539
  ims_j_p = *(ims->cols + j) + 0;
#line 540
  optval_p = *(optVals___2->cols + 0) + 0;
#line 541
  val_p = *(values->cols + 0) + 0;
#line 544
  k = 0;
#line 544
  while (k < vi->row_dim - 1) {
#line 547
    tmp = ims_i_p;
#line 547
    ims_i_p ++;
...
#line 592
    *tmp___13 = res_j___0;
#line 593
    sum_j += res_j___0 * res_j___0;
  }
#line 598
  tmp___14 = sqrt(sum_i);
#line 598
  scale_i = 1.0 / tmp___14;
#line 599
  tmp___15 = sqrt(sum_j);
#line 599
  scale_j = 1.0 / tmp___15;
#line 602
  vi_p = *(vi->cols + 0) + 0;
#line 603
  vj_p = *(vj->cols + 0) + 0;
...
#line 679
double distanceMahL2(Matrix const   ims , int i , int j , Matrix const   values ) ;
#line 679 "src/csuSubspaceProject.c"
static int first_call  =    1;
#line 680 "src/csuSubspaceProject.c"
static Matrix optVals  =    (Matrix )((void *)0);
#line 676 "src/csuSubspaceProject.c"
double distanceMahL2(Matrix const   ims , int i , int j , Matrix const   values ) 
{ 
  int k ;
  double sum ;
...
#line 685
    k = 0;
#line 685
    while (k < optVals->row_dim) {
#line 686
      *(*(optVals->cols + 0) + k) = 1.0 / *(*(values->cols + 0) + k);
#line 685
      k ++;
    }
  }
...
#line 690
  while (k < ims->row_dim) {
#line 691
    sum += ((*(*(ims->cols + i) + k) - *(*(ims->cols + j) + k)) * (*(*(ims->cols + i) + k) - *(*(ims->cols + j) + k))) * *(*(optVals->cols + 0) + k);
#line 690
    k ++;
  }
#line 694
...
#line 701
double distanceYamborDistance(Matrix const   ims , int i , int j , Matrix const   values ) ;
#line 701 "src/csuSubspaceProject.c"
static int first_call___0  =    1;
#line 702 "src/csuSubspaceProject.c"
static Matrix optVals___0  =    (Matrix )((void *)0);
#line 698 "src/csuSubspaceProject.c"
double distanceYamborDistance(Matrix const   ims , int i , int j , Matrix const   values ) 
{ 
  int k ;
  double sum ;
...
#line 705
    first_call___0 = 0;
#line 706
    optVals___0 = duplicateMatrix(values);
#line 707
    k = 0;
#line 707
    while (k < optVals___0->row_dim) {
#line 708
      *(*(optVals___0->cols + 0) + k) = 1.0 / *(*(values->cols + 0) + k);
#line 707
      k ++;
    }
  }
...
#line 712
  while (k < ims->row_dim) {
#line 713
    sum += (*(*(ims->cols + i) + k) * *(*(ims->cols + j) + k)) * *(*(optVals___0->cols + 0) + k);
#line 712
    k ++;
  }
#line 716
...
#line 724
double distanceMahL1(Matrix const   ims , int i , int j , Matrix const   values ) ;
#line 724 "src/csuSubspaceProject.c"
static int first_call___1  =    1;
#line 725 "src/csuSubspaceProject.c"
static Matrix optVals___1  =    (Matrix )((void *)0);
#line 721 "src/csuSubspaceProject.c"
double distanceMahL1(Matrix const   ims , int i , int j , Matrix const   values ) 
{ 
  int k ;
  double sum ;
...
#line 728
    first_call___1 = 0;
#line 729
    optVals___1 = duplicateMatrix(values);
#line 730
    k = 0;
#line 730
    while (k < optVals___1->row_dim) {
#line 731
      tmp = sqrt(*(*(values->cols + 0) + k));
#line 731
      *(*(optVals___1->cols + 0) + k) = 1.0 / tmp;
#line 730
      k ++;
    }
  }
...
#line 736
    if (*(*(ims->cols + i) + k) - *(*(ims->cols + j) + k) < (double )0) {
#line 736
      tmp___0 = - (*(*(ims->cols + i) + k) - *(*(ims->cols + j) + k));
    } else {
#line 736
      tmp___0 = *(*(ims->cols + i) + k) - *(*(ims->cols + j) + k);
    }
#line 736
    sum += tmp___0 * *(*(optVals___1->cols + 0) + k);
#line 735
    k ++;
  }
#line 738
...
#line 747 "src/csuSubspaceProject.c"
double distanceLDASoft(Matrix ims , int i , int j , Matrix values ) 
{ 
  int k ;
  double sum ;
  double tmp ;
...
#line 750
  while (k < ims->row_dim) {
#line 751
    tmp = pow(*(*(values->cols + 0) + k), 0.2);
#line 751
    sum += (tmp * (*(*(ims->cols + i) + k) - *(*(ims->cols + j) + k))) * (*(*(ims->cols + i) + k) - *(*(ims->cols + j) + k));
#line 750
    k ++;
  }
#line 753
...
#line 757 "src/csuSubspaceProject.c"
...
{ 
  ...
  {
#line 764
  tmp = malloc(sizeof(char *) * (unsigned long )numImages);
#line 764
  nameByIndex = (char **)tmp;
#line 765
  if (! nameByIndex) {
#line 765
    __assert_fail("nameByIndex", "src/csuSubspaceProject.c", 765U, "getNameByIndex");
  }
#line 766
  i = 0;
#line 766
...
#line 767
    *(nameByIndex + i) = (char *)tmp___0;
#line 768
    if (! *(nameByIndex + i)) {
#line 768
      __assert_fail("nameByIndex[i]", "src/csuSubspaceProject.c", 768U, "getNameByIndex");
    }
#line 766
    i ++;
  }
...
#line 775
    while (replicate) {
#line 776
      if (i != replicate->imageIndex) {
#line 777
        fprintf((FILE * __restrict  )stderr, (char const   * __restrict  )"Error: replicate indices off or out of bounds.\n");
#line 778
        exit(1);
      } else
#line 776
...
#line 780
      strcpy((char * __restrict  )*(nameByIndex + i), (char const   * __restrict  )replicate->filename);
#line 781
      i ++;
#line 775
...
#line 787 "src/csuSubspaceProject.c"
Matrix computeDistances(Matrix const   ims , Matrix const   values , int numImages ,
                        char *distName ) 
{ 
  int i ;
  int j ;
  ...
  {
#line 789
  tmp = makeMatrix(numImages, numImages);
#line 789
  distances = tmp;
#line 791
  if (0) {
#line 791
    __s1_len___10 = __builtin_strlen((char const   *)distName);
#line 791
    __s2_len___10 = __builtin_strlen("Euclidean");
#line 791
    if (! ((size_t )((void const   *)(distName + 1)) - (size_t )((void const   *)distName) == 1UL)) {
#line 791
      goto _L___24;
    } else
#line 791
    if (__s1_len___10 >= 4UL) {
      _L___24: /* CIL Label */ 
#line 791
      if (! ((size_t )((void const   *)("Euclidean" + 1)) - (size_t )((void const   *)"Euclidean") == 1UL)) {
#line 791
        tmp___87 = 1;
      } else
#line 791
...
#line 791
    if (tmp___87) {
#line 791
      tmp___82 = __builtin_strcmp((char const   *)distName, "Euclidean");
#line 791
      tmp___86 = tmp___82;
    } else {
#line 791
      tmp___85 = __builtin_strcmp((char const   *)distName, "Euclidean");
#line 791
      tmp___86 = tmp___85;
    }
  } else {
...
#line 793
      while (j < numImages) {
#line 794
        *(*(distances->cols + j) + i) = distanceEuclidean(ims, i, j);
#line 793
        j ++;
      }
#line 792
...
#line 797
    if (0) {
#line 797
      __s1_len___8 = __builtin_strlen((char const   *)distName);
#line 797
      __s2_len___8 = __builtin_strlen("Cityblock");
#line 797
      if (! ((size_t )((void const   *)(distName + 1)) - (size_t )((void const   *)distName) == 1UL)) {
#line 797
        goto _L___19;
...
#line 797
      if (__s1_len___8 >= 4UL) {
        _L___19: /* CIL Label */ 
#line 797
        if (! ((size_t )((void const   *)("Cityblock" + 1)) - (size_t )((void const   *)"Cityblock") == 1UL)) {
#line 797
          tmp___73 = 1;
        } else
#line 797
...
#line 797
      if (tmp___73) {
#line 797
        tmp___68 = __builtin_strcmp((char const   *)distName, "Cityblock");
#line 797
        tmp___72 = tmp___68;
      } else {
#line 797
        tmp___71 = __builtin_strcmp((char const   *)distName, "Cityblock");
#line 797
        tmp___72 = tmp___71;
      }
    } else {
...
#line 797
      if (0) {
#line 797
        __s1_len___9 = __builtin_strlen((char const   *)distName);
#line 797
        __s2_len___9 = __builtin_strlen("CityBlock");
#line 797
        if (! ((size_t )((void const   *)(distName + 1)) - (size_t )((void const   *)distName) == 1UL)) {
#line 797
          goto _L___21;
...
#line 797
        if (tmp___80) {
#line 797
          tmp___75 = __builtin_strcmp((char const   *)distName, "CityBlock");
#line 797
          tmp___79 = tmp___75;
        } else {
#line 797
          tmp___78 = __builtin_strcmp((char const   *)distName, "CityBlock");
#line 797
          tmp___79 = tmp___78;
        }
      } else {
...
#line 799
          while (j < numImages) {
#line 800
            *(*(distances->cols + j) + i) = distanceCityBlock(ims, i, j);
#line 799
            j ++;
          }
#line 798
...
#line 803
        if (0) {
#line 803
          __s1_len___7 = __builtin_strlen((char const   *)distName);
#line 803
          __s2_len___7 = __builtin_strlen("Covariance");
#line 803
          if (! ((size_t )((void const   *)(distName + 1)) - (size_t )((void const   *)distName) == 1UL)) {
#line 803
            goto _L___17;
...
#line 803
          if (__s1_len___7 >= 4UL) {
            _L___17: /* CIL Label */ 
#line 803
            if (! ((size_t )((void const   *)("Covariance" + 1)) - (size_t )((void const   *)"Covariance") == 1UL)) {
#line 803
              tmp___66 = 1;
            } else
#line 803
...
#line 803
          if (tmp___66) {
#line 803
            tmp___61 = __builtin_strcmp((char const   *)distName, "Covariance");
#line 803
            tmp___65 = tmp___61;
          } else {
#line 803
            tmp___64 = __builtin_strcmp((char const   *)distName, "Covariance");
#line 803
            tmp___65 = tmp___64;
          }
        } else {
...
#line 805
            while (j < numImages) {
#line 806
              *(*(distances->cols + j) + i) = distanceCovariance(ims, i, j);
#line 805
              j ++;
            }
#line 804
...
#line 809
          if (0) {
#line 809
            __s1_len___6 = __builtin_strlen((char const   *)distName);
#line 809
            __s2_len___6 = __builtin_strlen("Correlation");
#line 809
            if (! ((size_t )((void const   *)(distName + 1)) - (size_t )((void const   *)distName) == 1UL)) {
#line 809
              goto _L___15;
...
#line 809
            if (__s1_len___6 >= 4UL) {
              _L___15: /* CIL Label */ 
#line 809
              if (! ((size_t )((void const   *)("Correlation" + 1)) - (size_t )((void const   *)"Correlation") == 1UL)) {
#line 809
                tmp___59 = 1;
              } else
#line 809
...
#line 809
            if (tmp___59) {
#line 809
              tmp___54 = __builtin_strcmp((char const   *)distName, "Correlation");
#line 809
              tmp___58 = tmp___54;
            } else {
#line 809
              tmp___57 = __builtin_strcmp((char const   *)distName, "Correlation");
#line 809
              tmp___58 = tmp___57;
            }
          } else {
...
#line 811
              while (j < numImages) {
#line 812
                *(*(distances->cols + j) + i) = distanceCorrelation(ims, i, j);
#line 811
                j ++;
              }
#line 810
...
#line 815
            if (0) {
#line 815
              __s1_len___5 = __builtin_strlen((char const   *)distName);
#line 815
              __s2_len___5 = __builtin_strlen("YamborAngle");
#line 815
              if (! ((size_t )((void const   *)(distName + 1)) - (size_t )((void const   *)distName) == 1UL)) {
#line 815
                goto _L___13;
...
#line 815
              if (__s1_len___5 >= 4UL) {
                _L___13: /* CIL Label */ 
#line 815
                if (! ((size_t )((void const   *)("YamborAngle" + 1)) - (size_t )((void const   *)"YamborAngle") == 1UL)) {
#line 815
                  tmp___52 = 1;
                } else
#line 815
...
#line 815
              if (tmp___52) {
#line 815
                tmp___47 = __builtin_strcmp((char const   *)distName, "YamborAngle");
#line 815
                tmp___51 = tmp___47;
              } else {
#line 815
                tmp___50 = __builtin_strcmp((char const   *)distName, "YamborAngle");
#line 815
                tmp___51 = tmp___50;
              }
            } else {
...
#line 817
                while (j < numImages) {
#line 818
                  *(*(distances->cols + j) + i) = distanceYamborAngle((Matrix )ims,
                                                                      i, j, (Matrix )values);
#line 817
                  j ++;
                }
...
#line 821
              if (0) {
#line 821
                __s1_len___4 = __builtin_strlen((char const   *)distName);
#line 821
                __s2_len___4 = __builtin_strlen("MahCosine");
#line 821
                if (! ((size_t )((void const   *)(distName + 1)) - (size_t )((void const   *)distName) == 1UL)) {
#line 821
                  goto _L___11;
...
#line 821
                if (__s1_len___4 >= 4UL) {
                  _L___11: /* CIL Label */ 
#line 821
                  if (! ((size_t )((void const   *)("MahCosine" + 1)) - (size_t )((void const   *)"MahCosine") == 1UL)) {
#line 821
                    tmp___45 = 1;
                  } else
#line 821
...
#line 821
                if (tmp___45) {
#line 821
                  tmp___40 = __builtin_strcmp((char const   *)distName, "MahCosine");
#line 821
                  tmp___44 = tmp___40;
                } else {
#line 821
                  tmp___43 = __builtin_strcmp((char const   *)distName, "MahCosine");
#line 821
                  tmp___44 = tmp___43;
                }
              } else {
...
#line 821
              if (tmp___44 == 0) {
#line 822
                tmp___0 = makeMatrix(ims->row_dim, 1);
#line 822
                vi = tmp___0;
#line 823
                tmp___1 = makeMatrix(ims->row_dim, 1);
#line 823
                vj = tmp___1;
#line 824
                tmp___2 = duplicateMatrix(values);
#line 824
                optVals___2 = tmp___2;
#line 825
                i = 0;
#line 825
                while (i < optVals___2->row_dim) {
#line 826
                  tmp___3 = sqrt(*(*(values->cols + 0) + i));
#line 826
                  *(*(optVals___2->cols + 0) + i) = 1.0 / tmp___3;
#line 825
                  i ++;
                }
#line 828
...
#line 828
                while (i < numImages) {
#line 829
                  writeProgress((char *)"Computing distances for MahCosine", i, numImages);
#line 830
                  j = 0;
#line 830
                  while (j < numImages) {
#line 831
                    *(*(distances->cols + j) + i) = distanceMahCosine((Matrix )ims,
                                                                      i, j, (Matrix )values,
                                                                      vi, vj, optVals___2);
#line 830
                    j ++;
...
#line 834
                if (0) {
#line 834
                  __s1_len___3 = __builtin_strlen((char const   *)distName);
#line 834
                  __s2_len___3 = __builtin_strlen("MahL1");
#line 834
                  if (! ((size_t )((void const   *)(distName + 1)) - (size_t )((void const   *)distName) == 1UL)) {
#line 834
                    goto _L___9;
...
#line 834
                  if (__s1_len___3 >= 4UL) {
                    _L___9: /* CIL Label */ 
#line 834
                    if (! ((size_t )((void const   *)("MahL1" + 1)) - (size_t )((void const   *)"MahL1") == 1UL)) {
#line 834
                      tmp___38 = 1;
                    } else
#line 834
...
#line 834
                  if (tmp___38) {
#line 834
                    tmp___33 = __builtin_strcmp((char const   *)distName, "MahL1");
#line 834
                    tmp___37 = tmp___33;
                  } else {
#line 834
                    tmp___36 = __builtin_strcmp((char const   *)distName, "MahL1");
#line 834
                    tmp___37 = tmp___36;
                  }
                } else {
...
#line 835
                  while (i < numImages) {
#line 836
                    writeProgress((char *)"Computing distances for MahL1", i, numImages);
#line 837
                    j = 0;
#line 837
                    while (j < numImages) {
#line 838
                      *(*(distances->cols + j) + i) = distanceMahL1(ims, i, j, values);
#line 837
                      j ++;
                    }
#line 835
...
#line 841
                  if (0) {
#line 841
                    __s1_len___2 = __builtin_strlen((char const   *)distName);
#line 841
                    __s2_len___2 = __builtin_strlen("MahL2");
#line 841
                    if (! ((size_t )((void const   *)(distName + 1)) - (size_t )((void const   *)distName) == 1UL)) {
#line 841
                      goto _L___7;
...
#line 841
                    if (__s1_len___2 >= 4UL) {
                      _L___7: /* CIL Label */ 
#line 841
                      if (! ((size_t )((void const   *)("MahL2" + 1)) - (size_t )((void const   *)"MahL2") == 1UL)) {
#line 841
                        tmp___31 = 1;
                      } else
#line 841
...
#line 841
                    if (tmp___31) {
#line 841
                      tmp___26 = __builtin_strcmp((char const   *)distName, "MahL2");
#line 841
                      tmp___30 = tmp___26;
                    } else {
#line 841
                      tmp___29 = __builtin_strcmp((char const   *)distName, "MahL2");
#line 841
                      tmp___30 = tmp___29;
                    }
                  } else {
...
#line 842
                    while (i < numImages) {
#line 843
                      writeProgress((char *)"Computing distances for MahL2", i, numImages);
#line 844
                      j = 0;
#line 844
                      while (j < numImages) {
#line 845
                        *(*(distances->cols + j) + i) = distanceMahL2(ims, i, j, values);
#line 844
                        j ++;
                      }
#line 842
...
#line 848
                    if (0) {
#line 848
                      __s1_len___1 = __builtin_strlen((char const   *)distName);
#line 848
                      __s2_len___1 = __builtin_strlen("YamborDistance");
#line 848
                      if (! ((size_t )((void const   *)(distName + 1)) - (size_t )((void const   *)distName) == 1UL)) {
#line 848
                        goto _L___5;
...
#line 848
                      if (__s1_len___1 >= 4UL) {
                        _L___5: /* CIL Label */ 
#line 848
                        if (! ((size_t )((void const   *)("YamborDistance" + 1)) - (size_t )((void const   *)"YamborDistance") == 1UL)) {
#line 848
                          tmp___24 = 1;
                        } else
#line 848
...
#line 848
                      if (tmp___24) {
#line 848
                        tmp___19 = __builtin_strcmp((char const   *)distName, "YamborDistance");
#line 848
                        tmp___23 = tmp___19;
                      } else {
#line 848
                        tmp___22 = __builtin_strcmp((char const   *)distName, "YamborDistance");
#line 848
                        tmp___23 = tmp___22;
                      }
                    } else {
...
#line 849
                      while (i < numImages) {
#line 850
                        writeProgress((char *)"Computing distances for Windy", i,
                                      numImages);
#line 851
                        j = 0;
#line 851
                        while (j < numImages) {
#line 852
                          *(*(distances->cols + j) + i) = distanceYamborDistance(ims,
                                                                                 i,
                                                                                 j,
                                                                                 values);
#line 851
...
#line 855
                      if (0) {
#line 855
                        __s1_len = __builtin_strlen((char const   *)distName);
#line 855
                        __s2_len = __builtin_strlen("ldaSoft");
#line 855
                        if (! ((size_t )((void const   *)(distName + 1)) - (size_t )((void const   *)distName) == 1UL)) {
#line 855
                          goto _L___0;
...
#line 855
                        if (__s1_len >= 4UL) {
                          _L___0: /* CIL Label */ 
#line 855
                          if (! ((size_t )((void const   *)("ldaSoft" + 1)) - (size_t )((void const   *)"ldaSoft") == 1UL)) {
#line 855
                            tmp___10 = 1;
                          } else
#line 855
...
#line 855
                        if (tmp___10) {
#line 855
                          tmp___5 = __builtin_strcmp((char const   *)distName, "ldaSoft");
#line 855
                          tmp___9 = tmp___5;
                        } else {
#line 855
                          tmp___8 = __builtin_strcmp((char const   *)distName, "ldaSoft");
#line 855
                          tmp___9 = tmp___8;
                        }
                      } else {
...
#line 855
                        if (0) {
#line 855
                          __s1_len___0 = __builtin_strlen((char const   *)distName);
#line 855
                          __s2_len___0 = __builtin_strlen("LDASoft");
#line 855
                          if (! ((size_t )((void const   *)(distName + 1)) - (size_t )((void const   *)distName) == 1UL)) {
#line 855
                            goto _L___2;
...
#line 855
                          if (tmp___17) {
#line 855
                            tmp___12 = __builtin_strcmp((char const   *)distName,
                                                        "LDASoft");
#line 855
                            tmp___16 = tmp___12;
                          } else {
#line 855
                            tmp___15 = __builtin_strcmp((char const   *)distName,
                                                        "LDASoft");
#line 855
                            tmp___16 = tmp___15;
                          }
...
#line 855
                          tmp___15 = __builtin_strcmp((char const   *)distName, "LDASoft");
#line 855
                          tmp___16 = tmp___15;
                        }
#line 855
...
#line 857
                            while (j < numImages) {
#line 858
                              *(*(distances->cols + j) + i) = distanceLDASoft((Matrix )ims,
                                                                              i, j,
                                                                              (Matrix )values);
#line 857
                              j ++;
...
#line 862
                          fprintf((FILE * __restrict  )stderr, (char const   * __restrict  )"Error: The distance measure %s is not implemented! \n",
                                  distName);
#line 863
                          exit(1);
                        }
...
#line 936 "src/csuSubspaceProject.c"
Matrix computeOneDistances(Matrix const   ims , Matrix const   values , int numImages ,
                           char *distName ) 
{ 
  Matrix distances ;
  Matrix tmp ;
...
#line 1026
    if (tmp___84) {
#line 1026
      tmp___79 = __builtin_strcmp((char const   *)distName, "Euclidean");
#line 1026
      tmp___83 = tmp___79;
    } else {
#line 1026
...
#line 1027
    while (j < numImages) {
#line 1028
      *(*(distances->cols + 0) + j) = distanceEuclidean(ims, numImages, j);
#line 1027
      j ++;
    }
  } else {
...
#line 1030
      if (tmp___70) {
#line 1030
        tmp___65 = __builtin_strcmp((char const   *)distName, "Cityblock");
#line 1030
        tmp___69 = tmp___65;
      } else {
#line 1030
...
#line 1030
        if (tmp___77) {
#line 1030
          tmp___72 = __builtin_strcmp((char const   *)distName, "CityBlock");
#line 1030
          tmp___76 = tmp___72;
        } else {
#line 1030
...
#line 1031
        while (j < numImages) {
#line 1032
          *(*(distances->cols + 0) + j) = distanceCityBlock(ims, numImages, j);
#line 1031
          j ++;
        }
      } else {
...
#line 1034
          if (tmp___63) {
#line 1034
            tmp___58 = __builtin_strcmp((char const   *)distName, "Covariance");
#line 1034
            tmp___62 = tmp___58;
          } else {
#line 1034
...
#line 1035
          while (j < numImages) {
#line 1036
            *(*(distances->cols + 0) + j) = distanceCovariance(ims, numImages, j);
#line 1035
            j ++;
          }
        } else {
...
#line 1038
            if (tmp___56) {
#line 1038
              tmp___51 = __builtin_strcmp((char const   *)distName, "Correlation");
#line 1038
              tmp___55 = tmp___51;
            } else {
#line 1038
...
#line 1039
            while (j < numImages) {
#line 1040
              *(*(distances->cols + 0) + j) = distanceCorrelation(ims, numImages,
                                                                  j);
#line 1039
              j ++;
            }
...
#line 1042
              if (tmp___49) {
#line 1042
                tmp___44 = __builtin_strcmp((char const   *)distName, "YamborAngle");
#line 1042
                tmp___48 = tmp___44;
              } else {
#line 1042
...
#line 1043
              while (j < numImages) {
#line 1044
                *(*(distances->cols + 0) + j) = distanceYamborAngle((Matrix )ims,
                                                                    numImages, j,
                                                                    (Matrix )values);
#line 1043
                j ++;
...
#line 1046
                if (tmp___42) {
#line 1046
                  tmp___37 = __builtin_strcmp((char const   *)distName, "MahCosine");
#line 1046
                  tmp___41 = tmp___37;
                } else {
#line 1046
...
#line 1046
              if (tmp___41 == 0) {
#line 1047
                optVals___2 = duplicateMatrix(values);
#line 1048
...
#line 1050
                j = 0;
#line 1050
                while (j < optVals___2->row_dim) {
#line 1051
                  tmp___0 = sqrt(*(*(values->cols + 0) + j));
#line 1051
                  *(*(optVals___2->cols + 0) + j) = 1.0 / tmp___0;
#line 1050
                  j ++;
                }
#line 1053
...
#line 1053
                while (j < numImages) {
#line 1054
                  *(*(distances->cols + 0) + j) = distanceMahCosine((Matrix )ims,
                                                                    numImages, j,
                                                                    (Matrix )values,
                                                                    vi, vj, optVals___2);
#line 1053
...
#line 1057
                  if (tmp___35) {
#line 1057
                    tmp___30 = __builtin_strcmp((char const   *)distName, "MahL1");
#line 1057
                    tmp___34 = tmp___30;
                  } else {
#line 1057
...
#line 1058
                  while (j < numImages) {
#line 1059
                    *(*(distances->cols + 0) + j) = distanceMahL1(ims, numImages,
                                                                  j, values);
#line 1058
                    j ++;
                  }
...
#line 1061
                    if (tmp___28) {
#line 1061
                      tmp___23 = __builtin_strcmp((char const   *)distName, "MahL2");
#line 1061
                      tmp___27 = tmp___23;
                    } else {
#line 1061
...
#line 1062
                    while (j < numImages) {
#line 1063
                      *(*(distances->cols + 0) + j) = distanceMahL2(ims, numImages,
                                                                    j, values);
#line 1062
                      j ++;
                    }
...
#line 1065
                      if (tmp___21) {
#line 1065
                        tmp___16 = __builtin_strcmp((char const   *)distName, "YamborDistance");
#line 1065
                        tmp___20 = tmp___16;
                      } else {
#line 1065
...
#line 1066
                      while (j < numImages) {
#line 1067
                        *(*(distances->cols + 0) + j) = distanceYamborDistance(ims,
                                                                               numImages,
                                                                               j,
                                                                               values);
#line 1066
...
#line 1069
                        if (tmp___7) {
#line 1069
                          tmp___2 = __builtin_strcmp((char const   *)distName, "ldaSoft");
#line 1069
                          tmp___6 = tmp___2;
                        } else {
#line 1069
...
#line 1069
                          if (tmp___14) {
#line 1069
                            tmp___9 = __builtin_strcmp((char const   *)distName, "LDASoft");
#line 1069
                            tmp___13 = tmp___9;
                          } else {
#line 1069
...
#line 1069
                          tmp___12 = __builtin_strcmp((char const   *)distName, "LDASoft");
#line 1069
                          tmp___13 = tmp___12;
                        }
#line 1069
...
#line 1070
                          while (j < numImages) {
#line 1071
                            *(*(distances->cols + 0) + j) = distanceLDASoft((Matrix )ims,
                                                                            numImages,
                                                                            j, (Matrix )values);
#line 1070
                            j ++;
...
#line 1081 "src/csuSubspaceProject.c"
void writeDistancesForImage(char *distDirectory , char *filename , Matrix const   distances ,
                            int col , char **names ) 
{ 
  char name[2048] ;
  FILE *file ;
  ...
  {
#line 1087
  sprintf((char * __restrict  )(name), (char const   * __restrict  )"%s/%s", distDirectory,
          filename);
#line 1088
  file = fopen((char const   * __restrict  )(name), (char const   * __restrict  )"w");
#line 1089
  if (! file) {
#line 1090
...
#line 1093
  i = 0;
#line 1093
  while (i < distances->row_dim) {
#line 1094
    fprintf((FILE * __restrict  )file, (char const   * __restrict  )"%s\t%.16e\n",
            *(names + i), *(*(distances->cols + col) + i));
#line 1093
    i ++;
  }
#line 1096
...
#line 1099 "src/csuSubspaceProject.c"
...
{ 
  ...
  {
#line 1100
  tmp = fwrite((void const   * __restrict  )m, sizeof(matrix ), (size_t )1, (FILE * __restrict  )fd);
#line 1100
  if (! tmp) {
#line 1101
    __assert_fail("0&&\"write error\"", "src/csuSubspaceProject.c", 1101U, "writeMatrix");
  }
#line 1102
  printf((char const   * __restrict  )"wrote matrix of size %d\n", sizeof(matrix ));
#line 1103
  tmp___0 = fwrite((void const   * __restrict  )m->data, sizeof(double ), (size_t )(m->row_dim * m->col_dim),
                   (FILE * __restrict  )fd);
#line 1103
  if (! tmp___0) {
#line 1104
    __assert_fail("0&&\"write error\"", "src/csuSubspaceProject.c", 1104U, "writeMatrix");
  }
#line 1105
  printf((char const   * __restrict  )"wrote matrix of size %d\n", (sizeof(double ) * (unsigned long )m->row_dim) * (unsigned long )m->col_dim);
#line 1107
  return;
}
}
#line 1109 "src/csuSubspaceProject.c"
...
#line 1110
  ret = (Matrix )tmp;
#line 1112
  fread((void * __restrict  )ret, sizeof(matrix ), (size_t )1, (FILE * __restrict  )fd);
#line 1113
  ret = makeMatrix(ret->row_dim, ret->col_dim);
#line 1114
  fread((void * __restrict  )ret->data, sizeof(double ), (size_t )(ret->row_dim * ret->col_dim),
        (FILE * __restrict  )fd);
#line 1116
  return (ret);
}
}
#line 1138 "src/csuSubspaceProject.c"
...
#line 1155
  if (quiet == 0) {
#line 1155
    printf((char const   * __restrict  )"Project Test Images int Subspace and Compute Pairwise Distances.");
  } else
#line 1155
  if (debuglevel != 0) {
#line 1155
...
#line 1156
  if (quiet == 0) {
#line 1156
    printf((char const   * __restrict  )"Version 5.0, released Apr 30, 2003.");
  } else
#line 1156
  if (debuglevel != 0) {
#line 1156
...
#line 1161
  if (! args.lastphase) {
#line 1163
    readSubspace(& subspace, (char const   *)args.trainingFile, quiet);
#line 1164
...
#line 1164
    if (quiet == 0) {
#line 1164
      printf((char const   * __restrict  )"Reading image data from directory %s and projecting onto the new basis.",
             args.imageDirectory);
    } else
#line 1164
    if (debuglevel != 0) {
...
#line 1164
    fflush(stdout);
#line 1165
    subspims = readAndProjectImages(& subspace, args.imageNamesFile, args.imageDirectory,
                                    & numImages, & srt);
#line 1167
    sfile = fopen((char const   * __restrict  )"subspace.dat", (char const   * __restrict  )"w");
#line 1168
    fwrite((void const   * __restrict  )(& subspace), sizeof(subspace), (size_t )1,
           (FILE * __restrict  )sfile);
#line 1169
...
#line 1178
    sprintf((char * __restrict  )(subspace_file), (char const   * __restrict  )"%s/subspace.dat",
            args.subspace_name);
#line 1179
    sfile = fopen((char const   * __restrict  )(subspace_file), (char const   * __restrict  )"r");
#line 1181
    fread((void * __restrict  )(& subspace), sizeof(subspace), (size_t )1, (FILE * __restrict  )sfile);
#line 1182
...
#line 1204
    if (ind) {
#line 1206
      tmp___5 = makeMatrix(subspace.numPixels, 1);
#line 1206
      vector = tmp___5;
#line 1210
      sprintf((char * __restrict  )(img_file_name), (char const   * __restrict  )"%s/%s",
              args.imageDirectory, args.ind_name);
#line 1211
      readFile((char const   *)(img_file_name), 0, vector);
#line 1216
...
#line 1224
        *(*(subspims->cols + numImages) + j) = *(*(smallVector->cols + 0) + j);
#line 1223
        j ++;
      }
    }
...
#line 1231
    ddn = args.distList;
#line 1231
    while ((unsigned long )ddn != (unsigned long )((void *)0)) {
#line 1232
      if (! ind) {
#line 1233
...
#line 1233
        if (quiet == 0) {
#line 1233
          printf((char const   * __restrict  )"Computing distances with distance measure %s.",
                 ddn->distName);
        } else
#line 1233
        if (debuglevel != 0) {
...
#line 1233
        fflush(stdout);
#line 1235
        distances = computeDistances((Matrix const   )subspims, (Matrix const   )subspace.values,
                                     numImages, ddn->distName);
#line 1238
...
#line 1238
        if (quiet == 0) {
#line 1238
          printf((char const   * __restrict  )"Writing distance files for %d test images to directory %s",
...
#line 1240
        while (i < numImages) {
#line 1241
          writeProgress((char *)"Writing distance files", i, numImages);
#line 1242
          writeDistancesForImage(ddn->distDirectory, *(nameByIndex + i), (Matrix const   )distances,
                                 i, nameByIndex);
#line 1240
          i ++;
        }
...
#line 1249
        distances = computeOneDistances((Matrix const   )subspims, (Matrix const   )subspace.values,
                                        numImages, ddn->distName);
#line 1252
        printf((char const   * __restrict  )"writing to %s/%s\n", args.of_dir, args.of_name);
#line 1253
        writeDistancesForImage(args.of_dir, args.of_name, (Matrix const   )distances,
                               0, nameByIndex);
      }
#line 1231
      ddn = ddn->next;
...
#line 131 "src/csuCommonCommandLine.h"
