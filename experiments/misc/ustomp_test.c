...
#line 1 "cil-83srkhCI.o"
#pragma merger("0","/tmp/cil-Q6hecmEu.i","-O2,-fno-builtin,-std=gnu99,-fPIC,-Wall,-pedantic,-O2,-fno-builtin,-std=gnu99,-pthread")
...
#line 46 "test.c"
uint64_t recved_msg  =    (uint64_t )0;
#line 48 "test.c"
pid_t pid  ;
#line 50 "test.c"
...
#line 71
  ...
  case 256: 
#line 73
  msg.body = (char *)e.arg1;
#line 74
  msg.body_length = (size_t )((long )e.arg2);
#line 75
  msg.headers = (RBtree *)e.arg3;
#line 76
  recved_msg ++;
#line 77
...
#line 83
  ...
  case 536870912: 
#line 85
  printf((char const   * __restrict  )"[stomp] received %ld bytes\n", (long )e.arg2);
#line 86
  break;
  }
#line 90
...
#line 97 "test.c"
int ustomp_connection_test(ustomp_connection *conn ) 
{ 
  int tries ;
  int state ;
  char const   *tmp___0 ;
...
#line 113
  puts("test says: this is taking too long. I\'m outta here.\n");
#line 114
  puts("couldn\'t open connection");
#line 115
  return (1);
}
}
#line 118 "test.c"
static clock_t ustomp_send_time(ustomp_connection *conn , char *message , int size ) 
{ 
  clock_t div___0 ;
  clock_t tmp___0 ;
  clock_t tmp___1 ;
...
#line 119
  div___0 = tmp___0;
#line 120
  ustomp_send_frame_message_v(conn, (char const   *)message, (size_t )size, "foo",
                              "bar", (void *)0);
#line 121
  tmp___1 = clock();
#line 121
  return (tmp___1 - div___0);
}
}
#line 124 "test.c"
int ustomp_spam_test(ustomp_connection *conn ) 
{ 
  RBtree *headers ;
  char topic[80] ;
  int i ;
  int size ;
  char *message ;
  unsigned long __lengthofmessage ;
  void *tmp___0 ;
  clock_t tmp___1 ;

  {
#line 127
  snprintf((char * __restrict  )(topic), (size_t )80, (char const   * __restrict  )"/topic/Test_pid_%d_ustomp_message_test_spam",
           pid);
#line 128
  size = 253;
#line 130
  __lengthofmessage = (unsigned long )size;
#line 130
  tmp___0 = __builtin_alloca(sizeof(*message) * __lengthofmessage);
#line 130
...
#line 133
  ustomp_subscribe(conn, (char const   *)(topic));
#line 134
  sleep(2U);
#line 135
  memset((void *)message, 254, (size_t )(size - 3));
#line 136
  *(message + (size - 3)) = (char )'\n';
#line 137
  *(message + (size - 2)) = (char )'\000';
#line 138
  *(message + (size - 1)) = (char )'\n';
#line 139
  i = 0;
...
#line 143
  sleep(1U);
#line 144
  ustomp_send_frame_unsubscribe(conn, headers);
#line 145
...
#line 149 "test.c"
int ustomp_spam_n_test(ustomp_connection *conn ) 
{ 
  RBtree *headers ;
  char topic[80] ;
  int i ;
  ...
  {
#line 152
  snprintf((char * __restrict  )(topic), (size_t )80, (char const   * __restrict  )"/topic/Test_pid_%d_ustomp_message_test_n_spam",
           pid);
#line 153
  size = 4093;
#line 155
...
#line 176 "test.c"
int ustomp_message_test(ustomp_connection *conn , int size ) 
{ 
  RBtree *headers ;
  char topic[80] ;
  char *message ;
  ...
  {
#line 179
  snprintf((char * __restrict  )(topic), (size_t )80, (char const   * __restrict  )"/topic/Test_pid_%d_ustomp_message_test%d",
           pid, size);
#line 180
...
#line 184
  sleep(4U);
#line 185
  memset((void *)message, 65 + size % 3, (size_t )(size - 2));
#line 186
  *(message + (size - 2)) = (char )'\000';
#line 187
  *(message + (size - 1)) = (char )'\n';
...
#line 189
  pthread_mutex_lock(& mutex);
#line 190
  pthread_cond_wait((pthread_cond_t * __restrict  )(& con), (pthread_mutex_t * __restrict  )(& mutex));
#line 191
  pthread_mutex_unlock(& mutex);
#line 192
  ustomp_send_frame_unsubscribe(conn, headers);
#line 193
  dictDestroy(& headers, 0);
#line 194
  free((void *)message);
#line 195
  return (0);
...
{ 
  ...
  {
#line 201
  tmp___0 = pthread_cond_init((pthread_cond_t * __restrict  )(& con), (pthread_condattr_t const   * __restrict  )((void *)0));
#line 201
  if (tmp___0) {
#line 202
    return (-2);
...
#line 201
    tmp___1 = pthread_mutex_init(& mutex, (pthread_mutexattr_t const   *)0);
#line 201
    if (tmp___1) {
#line 202
      return (-2);
...
#line 205
  conn = ustomp_init("localhost", 6163U);
#line 205
  if ((unsigned long )conn == (unsigned long )((void *)0)) {
#line 206
    tmp___2 = ustomp_strerr();
#line 206
...
#line 211
    ustomp_connection_test(conn);
#line 213
    ustomp_spam_test(conn);
#line 214
    ustomp_spam_n_test(conn);
#line 215
    sleep(5U);
#line 217
...
#line 225
    printf((char const   * __restrict  )"number of msgs: %lu\n", recved_msg);
#line 226
    printf((char const   * __restrict  )"number of false MACs: %lu\n", mac_wrong);
#line 228
    sleep(5U);
#line 229
    puts("disconnecting.");
