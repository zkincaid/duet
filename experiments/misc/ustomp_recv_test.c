...
#line 1 "cil-EtwjqMk8.o"
#pragma merger("0","/tmp/cil-CpBMbWuW.i","-O2,-fno-builtin,-std=gnu99,-fPIC,-Wall,-pedantic,-O2,-fno-builtin,-std=gnu99,-pthread")
...
#line 72
  recved_msg ++;
#line 73
  printf((char const   * __restrict  )"[stomp] received message (%ld bytes):", (long )e.arg2);
#line 74
  puts((char const   *)msg.body);
#line 75
...
#line 95 "recv_test.c"
static int ustomp_connection_test(ustomp_connection *conn , char const   *topic ) 
{ 
  int tries ;
  int state ;
  char const   *tmp___0 ;
