...
(declare-fun |required(ezcsp__lt(v(v,0),7))| () Bool)
...
(declare-fun |required(ezcsp__lt(v(v,3),7))| () Bool)
...
(declare-fun |required(ezcsp__lt(v(v,2),7))| () Bool)
...
(declare-fun |required(ezcsp__lt(v(v,1),7))| () Bool)
...
(assert (or (not |occurs(accelerate,0)|) |required(ezcsp__lt(v(v,0),7))|))
(assert (or (not |occurs(accelerate,0)|) |occurs(accelerate,0)|))
(assert (or (not |occurs(accelerate,1)|) |required(ezcsp__lt(v(v,1),7))|))
(assert (or (not |occurs(accelerate,1)|) |occurs(accelerate,1)|))
(assert (or (not |occurs(accelerate,2)|) |required(ezcsp__lt(v(v,2),7))|))
(assert (or (not |occurs(accelerate,3)|) |required(ezcsp__lt(v(v,3),7))|))
...
(assert (or (not |required(ezcsp__lt(v(v,0),7))|) |occurs(accelerate,0)|))
(assert (or (not |required(ezcsp__lt(v(v,1),7))|) |occurs(accelerate,1)|))
(assert (or (not |required(ezcsp__lt(v(v,2),7))|) |occurs(accelerate,2)|))
(assert (or (not |required(ezcsp__lt(v(v,3),7))|) |occurs(accelerate,3)|))
...
(assert (=> |required(ezcsp__lt(v(v,0),7))| (< |v(v,0)|  7)))
...
(assert (=> |required(ezcsp__lt(v(v,3),7))| (< |v(v,3)|  7)))
...
(assert (=> |required(ezcsp__lt(v(v,2),7))| (< |v(v,2)|  7)))
...
(assert (=> |required(ezcsp__lt(v(v,1),7))| (< |v(v,1)|  7)))
