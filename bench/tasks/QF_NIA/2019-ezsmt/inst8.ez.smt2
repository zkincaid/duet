...
(declare-fun |required(ezcsp__lt(v(v,0),8))| () Bool)
...
(declare-fun |required(ezcsp__lt(v(v,1),8))| () Bool)
...
(declare-fun |required(ezcsp__lt(v(v,3),8))| () Bool)
...
(declare-fun |uplimit(8)| () Bool)
(declare-fun |required(ezcsp__lt(v(v,2),8))| () Bool)
...
(assert (or (not |occurs(accelerate,0)|) |required(ezcsp__lt(v(v,0),8))|))
(assert (or (not |occurs(accelerate,0)|) |occurs(accelerate,0)|))
(assert (or (not |occurs(accelerate,1)|) |required(ezcsp__lt(v(v,1),8))|))
(assert (or (not |occurs(accelerate,1)|) |occurs(accelerate,1)|))
(assert (or (not |occurs(accelerate,2)|) |required(ezcsp__lt(v(v,2),8))|))
(assert (or (not |occurs(accelerate,3)|) |required(ezcsp__lt(v(v,3),8))|))
...
(assert (or (not |required(ezcsp__lt(v(v,0),8))|) |occurs(accelerate,0)|))
(assert (or (not |required(ezcsp__lt(v(v,1),8))|) |occurs(accelerate,1)|))
(assert (or (not |required(ezcsp__lt(v(v,2),8))|) |occurs(accelerate,2)|))
(assert (or (not |required(ezcsp__lt(v(v,3),8))|) |occurs(accelerate,3)|))
...
(assert (=> |required(ezcsp__lt(v(v,0),8))| (< |v(v,0)|  8)))
...
(assert (=> |required(ezcsp__lt(v(v,1),8))| (< |v(v,1)|  8)))
...
(assert (=> |required(ezcsp__lt(v(v,3),8))| (< |v(v,3)|  8)))
...
(assert (=> |required(ezcsp__lt(v(v,2),8))| (< |v(v,2)|  8)))
