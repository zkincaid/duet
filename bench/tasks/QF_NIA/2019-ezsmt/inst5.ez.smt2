...
(declare-fun |required(ezcsp__lt(v(v,3),5))| () Bool)
...
(declare-fun |required(ezcsp__lt(v(v,0),5))| () Bool)
...
(declare-fun |required(ezcsp__lt(v(v,1),5))| () Bool)
...
(assert (or (not |occurs(accelerate,0)|) |required(ezcsp__lt(v(v,0),5))|))
(assert (or (not |occurs(accelerate,0)|) |occurs(accelerate,0)|))
(assert (or (not |occurs(accelerate,1)|) |required(ezcsp__lt(v(v,1),5))|))
(assert (or (not |occurs(accelerate,1)|) |occurs(accelerate,1)|))
(assert (or (not |occurs(accelerate,2)|) |required(ezcsp__lt(v(v,2),5))|))
(assert (or (not |occurs(accelerate,3)|) |required(ezcsp__lt(v(v,3),5))|))
...
(assert (or (not |required(ezcsp__lt(v(v,0),5))|) |occurs(accelerate,0)|))
(assert (or (not |required(ezcsp__lt(v(v,1),5))|) |occurs(accelerate,1)|))
(assert (or (not |required(ezcsp__lt(v(v,2),5))|) |occurs(accelerate,2)|))
(assert (or (not |required(ezcsp__lt(v(v,3),5))|) |occurs(accelerate,3)|))
...
(assert (=> |required(ezcsp__lt(v(v,3),5))| (< |v(v,3)|  5)))
...
(assert (=> |required(ezcsp__lt(v(v,2),5))| (< |v(v,2)|  5)))
...
(assert (=> |required(ezcsp__lt(v(v,0),5))| (< |v(v,0)|  5)))
...
(assert (=> |required(ezcsp__lt(v(v,1),5))| (< |v(v,1)|  5)))
