...
(declare-fun |required(ezcsp__lt(v(v,0),3))| () Bool)
...
(declare-fun |required(ezcsp__lt(v(v,2),3))| () Bool)
(declare-fun |required(ezcsp__lt(v(v,3),3))| () Bool)
...
(declare-fun |required(ezcsp__lt(v(v,1),3))| () Bool)
...
(assert (or (not |occurs(accelerate,0)|) |required(ezcsp__lt(v(v,0),3))|))
(assert (or (not |occurs(accelerate,0)|) |occurs(accelerate,0)|))
(assert (or (not |occurs(accelerate,1)|) |required(ezcsp__lt(v(v,1),3))|))
(assert (or (not |occurs(accelerate,1)|) |occurs(accelerate,1)|))
(assert (or (not |occurs(accelerate,2)|) |required(ezcsp__lt(v(v,2),3))|))
(assert (or (not |occurs(accelerate,3)|) |required(ezcsp__lt(v(v,3),3))|))
...
(assert (or (not |required(ezcsp__lt(v(v,0),3))|) |occurs(accelerate,0)|))
(assert (or (not |required(ezcsp__lt(v(v,1),3))|) |occurs(accelerate,1)|))
(assert (or (not |required(ezcsp__lt(v(v,2),3))|) |occurs(accelerate,2)|))
(assert (or (not |required(ezcsp__lt(v(v,3),3))|) |occurs(accelerate,3)|))
...
(assert (=> |required(ezcsp__lt(v(v,0),3))| (< |v(v,0)|  3)))
...
(assert (=> |required(ezcsp__lt(v(v,2),3))| (< |v(v,2)|  3)))
(assert (=> |required(ezcsp__lt(v(v,3),3))| (< |v(v,3)|  3)))
...
(assert (=> |required(ezcsp__lt(v(v,1),3))| (< |v(v,1)|  3)))
