...
(declare-fun |required(ezcsp__lt(v(v,3),6))| () Bool)
...
(declare-fun |required(ezcsp__lt(v(v,1),6))| () Bool)
...
(declare-fun |required(ezcsp__lt(v(v,2),6))| () Bool)
...
(declare-fun |required(ezcsp__lt(v(v,0),6))| () Bool)
...
(assert (or (not |occurs(accelerate,0)|) |required(ezcsp__lt(v(v,0),6))|))
(assert (or (not |occurs(accelerate,0)|) |occurs(accelerate,0)|))
(assert (or (not |occurs(accelerate,1)|) |required(ezcsp__lt(v(v,1),6))|))
(assert (or (not |occurs(accelerate,1)|) |occurs(accelerate,1)|))
(assert (or (not |occurs(accelerate,2)|) |required(ezcsp__lt(v(v,2),6))|))
(assert (or (not |occurs(accelerate,3)|) |required(ezcsp__lt(v(v,3),6))|))
...
(assert (or (not |required(ezcsp__lt(v(v,0),6))|) |occurs(accelerate,0)|))
(assert (or (not |required(ezcsp__lt(v(v,1),6))|) |occurs(accelerate,1)|))
(assert (or (not |required(ezcsp__lt(v(v,2),6))|) |occurs(accelerate,2)|))
(assert (or (not |required(ezcsp__lt(v(v,3),6))|) |occurs(accelerate,3)|))
...
(assert (=> |required(ezcsp__lt(v(v,3),6))| (< |v(v,3)|  6)))
...
(assert (=> |required(ezcsp__lt(v(v,1),6))| (< |v(v,1)|  6)))
...
(assert (=> |required(ezcsp__lt(v(v,2),6))| (< |v(v,2)|  6)))
...
(assert (=> |required(ezcsp__lt(v(v,0),6))| (< |v(v,0)|  6)))
