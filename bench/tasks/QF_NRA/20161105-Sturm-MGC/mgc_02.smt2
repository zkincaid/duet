...
and (and (and (and (= (+ (* gamma0 theta) (- (* theta vv1 (* vv3 vv3))) (- (* 
theta vv1))) 0) (= (+ (* gamma0 mu) (* lambda1 vv1) (- vv2)) 0)) (= (+ (* 2 
alpha gamma0) (- (* 2 alpha vv1 (* vv3 vv3))) (- (* 2 alpha vv1)) (* delta vv2) 
(- (* delta vv3))) 0)) (< (+ (- (* 2 delta lambda1 theta vv1 vv3)) (- (* delta 
theta (* vv3 vv3))) (- (* delta theta))) 0) (= (+ (* 16 (* alpha alpha) (* vv1 
vv1) (* vv3 vv3)) (* 4 alpha delta theta vv1 (* vv3 vv3 vv3)) (* 4 alpha delta 
theta vv1 vv3) (* 8 alpha delta vv1 vv3) (* 8 alpha theta vv1 (* vv3 vv3 vv3)) 
(* 8 alpha theta vv1 vv3) (* 4 alpha vv1 vv3) (* (* delta delta) theta (* vv3 
vv3)) (* (* delta delta) theta) (* delta delta) (- (* 2 delta lambda1 theta vv1 
vv3)) (* delta (* theta theta) (* vv3 vv3 vv3 vv3)) (* 2 delta (* theta theta) 
(* vv3 vv3)) (* delta (* theta theta)) (* 2 delta theta (* vv3 vv3)) (* 2 delta 
theta) delta (* (* theta theta) (* vv3 vv3 vv3 vv3)) (* 2 (* theta theta) (* vv3
 vv3)) (* theta theta) (* theta (* vv3 vv3)) theta) 0)) (< (- theta) 0)) (< (- 
