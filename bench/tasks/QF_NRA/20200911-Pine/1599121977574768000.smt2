...
(declare-fun v () Real)
(assert
 (let ((?x124 (+ (* (* (/ 1.0 100.0) u!) v!) (+ (* (* (/ 9.0 100.0) v!) v!) (* (- (/ 1.0 25.0)) u!)))))
 (let ((?x127 (* (/ 1.0 50.0) v!)))
 (let (($x149 (and (<= (- 1.0) u!) (>= 1.0 u!) (<= (- (/ 33.0 10.0)) v!) (>= 3.0 v!))))
 (let (($x134 (and $x149 (>= (/ 89.0 100.0) (+ ?x127 (+ (* (* 1.0 u!) u!) ?x124))) )))
 (let (($x157 (and (= u! (+ u (* (/ 1.0 100.0) v))) (= v! (+ v (* (/ 1.0 100.0) (- (* (- (/ 1.0 2.0)) v) (* (/ 981.0 100.0) u))))))))
 (let ((?x271 (+ (* (* (/ 1.0 100.0) u) v) (+ (* (* (/ 9.0 100.0) v) v) (* (- (/ 1.0 25.0)) u)))))
 (let ((?x22 (* (/ 1.0 50.0) v)))
 (let (($x277 (>= 3.0 v)))
 (let (($x144 (and (and (<= (- 1.0) u) (>= 1.0 u) (<= (- (/ 33.0 10.0)) v) $x277) (>= (/ 89.0 100.0) (+ ?x22 (+ (* (* 1.0 u) u) ?x271))) )))
 (and $x144 $x157 (not $x134))))))))))))
(check-sat)
(exit)
