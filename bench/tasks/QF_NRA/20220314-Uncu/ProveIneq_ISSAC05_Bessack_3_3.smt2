...
Application: 
CAD calls of SUMCracker-ProveInequality to prove Bessack Inequality with (a,b)=(3,3) in
...
(declare-fun V3 () Real)
(declare-fun V4 () Real)
(assert (and (< 0 V1) (< 0 V2) (< 0 V3) (< 0 (+ V2 V3)) (<= V4 (* V3 V3 V3 V3 V3 V3)) (< (* (+ V2 V3) (+ V2 V3) (+ V2 V3) (+ V2 V3) (+ V2 V3) (+ V2 V3)) (+ (* V2 V2 V2 V2 V2 V2) (* (* (* V2 V2 V2 V2 V2) V3) 3) (* (* (* V2 V2 V2 V2) (* V3 V3)) 3) (* (* V2 V2 V2) (* V3 V3 V3)) V4))))
(check-sat)
(exit)
