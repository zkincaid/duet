...
(declare-fun V3 () Real)
(declare-fun V4 () Real)
(assert (and (< 0 V1) (< 0 V2) (< 0 V3) (< 0 (+ V2 V3)) (<= V4 (* V3 V3 V3 V3 V3 V3 V3 V3)) (< (* (+ V2 V3) (+ V2 V3) (+ V2 V3) (+ V2 V3) (+ V2 V3) (+ V2 V3) (+ V2 V3) (+ V2 V3)) (+ (* V2 V2 V2 V2 V2 V2 V2 V2) (* (* (* V2 V2 V2 V2 V2 V2 V2) V3) 3) (* (* (* V2 V2 V2 V2 V2 V2) (* V3 V3)) 3) (* (* V2 V2 V2 V2 V2) (* V3 V3 V3)) V4))))
(check-sat)
(exit)
