#pragma merger("0","/tmp/cil-30nxUl8N.i","")
# 1 "./linear-algebra/kernels/2mm/2mm.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "./linear-algebra/kernels/2mm/2mm.c" 2
...
# 10 "./linear-algebra/kernels/2mm/2mm.c" 2
...
# 11 "./linear-algebra/kernels/2mm/2mm.c" 2
...
# 12 "./linear-algebra/kernels/2mm/2mm.c" 2
...
# 15 "./linear-algebra/kernels/2mm/2mm.c" 2



# 1 "./linear-algebra/kernels/2mm/2mm.h" 1
# 19 "./linear-algebra/kernels/2mm/2mm.c" 2
   ...
   double D[1024 + 0][1024 + 0])
{
  ...
  for (i = 0; i < ni; i++)
    for (j = 0; j < nl; j++) {
 fprintf (
# 60 "./linear-algebra/kernels/2mm/2mm.c" 3 4
         stderr
# 60 "./linear-algebra/kernels/2mm/2mm.c"
               , "%0.2lf ", D[i][j]);
 if ((i * ni + j) % 20 == 0) fprintf (
# 61 "./linear-algebra/kernels/2mm/2mm.c" 3 4
                                     stderr
# 61 "./linear-algebra/kernels/2mm/2mm.c"
                                           , "\n");
    }
  fprintf (
# 63 "./linear-algebra/kernels/2mm/2mm.c" 3 4
          stderr
# 63 "./linear-algebra/kernels/2mm/2mm.c"
                , "\n");
}
