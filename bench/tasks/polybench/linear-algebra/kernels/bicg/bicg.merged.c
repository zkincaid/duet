#pragma merger("0","/tmp/cil-Rn8xsiiF.i","")
# 1 "./linear-algebra/kernels/bicg/bicg.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "./linear-algebra/kernels/bicg/bicg.c" 2
...
# 10 "./linear-algebra/kernels/bicg/bicg.c" 2
...
# 11 "./linear-algebra/kernels/bicg/bicg.c" 2
...
# 12 "./linear-algebra/kernels/bicg/bicg.c" 2
...
# 15 "./linear-algebra/kernels/bicg/bicg.c" 2



# 1 "./linear-algebra/kernels/bicg/bicg.h" 1
# 19 "./linear-algebra/kernels/bicg/bicg.c" 2
   ...
   double p[4000 + 0])
{
  ...
  for (i = 0; i < ny; i++)
    p[i] = i * 
# 31 "./linear-algebra/kernels/bicg/bicg.c" 3 4
              3.14159265358979323846
# 31 "./linear-algebra/kernels/bicg/bicg.c"
                  ;
  for (i = 0; i < nx; i++) {
    r[i] = i * 
# 33 "./linear-algebra/kernels/bicg/bicg.c" 3 4
              3.14159265358979323846
# 33 "./linear-algebra/kernels/bicg/bicg.c"
                  ;
    for (j = 0; j < ny; j++)
...

{
  ...
  for (i = 0; i < ny; i++) {
    fprintf (
# 51 "./linear-algebra/kernels/bicg/bicg.c" 3 4
            stderr
# 51 "./linear-algebra/kernels/bicg/bicg.c"
                  , "%0.2lf ", s[i]);
    if (i % 20 == 0) fprintf (
# 52 "./linear-algebra/kernels/bicg/bicg.c" 3 4
                             stderr
# 52 "./linear-algebra/kernels/bicg/bicg.c"
                                   , "\n");
  }
  for (i = 0; i < nx; i++) {
    fprintf (
# 55 "./linear-algebra/kernels/bicg/bicg.c" 3 4
            stderr
# 55 "./linear-algebra/kernels/bicg/bicg.c"
                  , "%0.2lf ", q[i]);
    if (i % 20 == 0) fprintf (
# 56 "./linear-algebra/kernels/bicg/bicg.c" 3 4
                             stderr
# 56 "./linear-algebra/kernels/bicg/bicg.c"
                                   , "\n");
  }
  fprintf (
# 58 "./linear-algebra/kernels/bicg/bicg.c" 3 4
          stderr
# 58 "./linear-algebra/kernels/bicg/bicg.c"
                , "\n");
}
