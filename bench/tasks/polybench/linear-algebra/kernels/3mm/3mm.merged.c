#pragma merger("0","/tmp/cil-nFHRtQQa.i","")
# 1 "./linear-algebra/kernels/3mm/3mm.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "./linear-algebra/kernels/3mm/3mm.c" 2
...
# 10 "./linear-algebra/kernels/3mm/3mm.c" 2
...
# 11 "./linear-algebra/kernels/3mm/3mm.c" 2
...
# 12 "./linear-algebra/kernels/3mm/3mm.c" 2
...
# 15 "./linear-algebra/kernels/3mm/3mm.c" 2



# 1 "./linear-algebra/kernels/3mm/3mm.h" 1
# 19 "./linear-algebra/kernels/3mm/3mm.c" 2
   ...
   double G[1024 + 0][1024 + 0])
{
  ...
  for (i = 0; i < ni; i++)
    for (j = 0; j < nl; j++) {
 fprintf (
# 56 "./linear-algebra/kernels/3mm/3mm.c" 3 4
         stderr
# 56 "./linear-algebra/kernels/3mm/3mm.c"
               , "%0.2lf ", G[i][j]);
 if ((i * ni + j) % 20 == 0) fprintf (
# 57 "./linear-algebra/kernels/3mm/3mm.c" 3 4
                                     stderr
# 57 "./linear-algebra/kernels/3mm/3mm.c"
                                           , "\n");
    }
  fprintf (
# 59 "./linear-algebra/kernels/3mm/3mm.c" 3 4
          stderr
# 59 "./linear-algebra/kernels/3mm/3mm.c"
                , "\n");
}
