#pragma merger("0","/tmp/cil-d3slLkrY.i","")
# 1 "./linear-algebra/kernels/doitgen/doitgen.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "./linear-algebra/kernels/doitgen/doitgen.c" 2
...
# 10 "./linear-algebra/kernels/doitgen/doitgen.c" 2
...
# 11 "./linear-algebra/kernels/doitgen/doitgen.c" 2
...
# 12 "./linear-algebra/kernels/doitgen/doitgen.c" 2
...
# 15 "./linear-algebra/kernels/doitgen/doitgen.c" 2



# 1 "./linear-algebra/kernels/doitgen/doitgen.h" 1
# 19 "./linear-algebra/kernels/doitgen/doitgen.c" 2
   ...
   double A[128 + 0][128 + 0][128 + 0])
{
  ...
  for (i = 0; i < nr; i++)
    for (j = 0; j < nq; j++)
      for (k = 0; k < np; k++) {
 fprintf (
# 50 "./linear-algebra/kernels/doitgen/doitgen.c" 3 4
         stderr
# 50 "./linear-algebra/kernels/doitgen/doitgen.c"
               , "%0.2lf ", A[i][j][k]);
 if (i % 20 == 0) fprintf (
# 51 "./linear-algebra/kernels/doitgen/doitgen.c" 3 4
                          stderr
# 51 "./linear-algebra/kernels/doitgen/doitgen.c"
                                , "\n");
      }
  fprintf (
# 53 "./linear-algebra/kernels/doitgen/doitgen.c" 3 4
          stderr
# 53 "./linear-algebra/kernels/doitgen/doitgen.c"
                , "\n");
}
