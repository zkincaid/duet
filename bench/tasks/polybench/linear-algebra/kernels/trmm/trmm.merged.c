#pragma merger("0","/tmp/cil-w3zMUoaP.i","")
# 1 "./linear-algebra/kernels/trmm/trmm.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "./linear-algebra/kernels/trmm/trmm.c" 2
...
# 10 "./linear-algebra/kernels/trmm/trmm.c" 2
...
# 11 "./linear-algebra/kernels/trmm/trmm.c" 2
...
# 12 "./linear-algebra/kernels/trmm/trmm.c" 2
...
# 15 "./linear-algebra/kernels/trmm/trmm.c" 2



# 1 "./linear-algebra/kernels/trmm/trmm.h" 1
# 19 "./linear-algebra/kernels/trmm/trmm.c" 2
   ...
   double B[1024 + 0][1024 + 0])
{
  ...
  for (i = 0; i < ni; i++)
    for (j = 0; j < ni; j++) {
 fprintf (
# 49 "./linear-algebra/kernels/trmm/trmm.c" 3 4
         stderr
# 49 "./linear-algebra/kernels/trmm/trmm.c"
               , "%0.2lf ", B[i][j]);
 if ((i * ni + j) % 20 == 0) fprintf (
# 50 "./linear-algebra/kernels/trmm/trmm.c" 3 4
                                     stderr
# 50 "./linear-algebra/kernels/trmm/trmm.c"
                                           , "\n");
    }
  fprintf (
# 52 "./linear-algebra/kernels/trmm/trmm.c" 3 4
          stderr
# 52 "./linear-algebra/kernels/trmm/trmm.c"
                , "\n");
}
