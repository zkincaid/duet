#pragma merger("0","/tmp/cil-SAg83QqY.i","")
# 1 "./linear-algebra/kernels/symm/symm.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "./linear-algebra/kernels/symm/symm.c" 2
...
# 10 "./linear-algebra/kernels/symm/symm.c" 2
...
# 11 "./linear-algebra/kernels/symm/symm.c" 2
...
# 12 "./linear-algebra/kernels/symm/symm.c" 2
...
# 15 "./linear-algebra/kernels/symm/symm.c" 2



# 1 "./linear-algebra/kernels/symm/symm.h" 1
# 19 "./linear-algebra/kernels/symm/symm.c" 2
   ...
   double C[1024 + 0][1024 + 0])
{
  ...
  for (i = 0; i < ni; i++)
    for (j = 0; j < nj; j++) {
 fprintf (
# 55 "./linear-algebra/kernels/symm/symm.c" 3 4
         stderr
# 55 "./linear-algebra/kernels/symm/symm.c"
               , "%0.2lf ", C[i][j]);
 if ((i * ni + j) % 20 == 0) fprintf (
# 56 "./linear-algebra/kernels/symm/symm.c" 3 4
                                     stderr
# 56 "./linear-algebra/kernels/symm/symm.c"
                                           , "\n");
    }
  fprintf (
# 58 "./linear-algebra/kernels/symm/symm.c" 3 4
          stderr
# 58 "./linear-algebra/kernels/symm/symm.c"
                , "\n");
}
