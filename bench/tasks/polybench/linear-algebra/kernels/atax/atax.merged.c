#pragma merger("0","/tmp/cil-ztV3BVhf.i","")
# 1 "./linear-algebra/kernels/atax/atax.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "./linear-algebra/kernels/atax/atax.c" 2
...
# 10 "./linear-algebra/kernels/atax/atax.c" 2
...
# 11 "./linear-algebra/kernels/atax/atax.c" 2
...
# 12 "./linear-algebra/kernels/atax/atax.c" 2
...
# 15 "./linear-algebra/kernels/atax/atax.c" 2



# 1 "./linear-algebra/kernels/atax/atax.h" 1
# 19 "./linear-algebra/kernels/atax/atax.c" 2
   ...
   double x[4000 + 0])
{
  ...
  for (i = 0; i < ny; i++)
      x[i] = i * 
# 30 "./linear-algebra/kernels/atax/atax.c" 3 4
                3.14159265358979323846
# 30 "./linear-algebra/kernels/atax/atax.c"
                    ;
  for (i = 0; i < nx; i++)
    for (j = 0; j < ny; j++)
...

{
  ...
  for (i = 0; i < nx; i++) {
    fprintf (
# 47 "./linear-algebra/kernels/atax/atax.c" 3 4
            stderr
# 47 "./linear-algebra/kernels/atax/atax.c"
                  , "%0.2lf ", y[i]);
    if (i % 20 == 0) fprintf (
# 48 "./linear-algebra/kernels/atax/atax.c" 3 4
                             stderr
# 48 "./linear-algebra/kernels/atax/atax.c"
                                   , "\n");
  }
  fprintf (
# 50 "./linear-algebra/kernels/atax/atax.c" 3 4
          stderr
# 50 "./linear-algebra/kernels/atax/atax.c"
                , "\n");
}
