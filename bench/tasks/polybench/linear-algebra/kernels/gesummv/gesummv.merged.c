#pragma merger("0","/tmp/cil-xjmPqM5w.i","")
# 1 "./linear-algebra/kernels/gesummv/gesummv.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "./linear-algebra/kernels/gesummv/gesummv.c" 2
...
# 10 "./linear-algebra/kernels/gesummv/gesummv.c" 2
...
# 11 "./linear-algebra/kernels/gesummv/gesummv.c" 2
...
# 12 "./linear-algebra/kernels/gesummv/gesummv.c" 2
...
# 15 "./linear-algebra/kernels/gesummv/gesummv.c" 2



# 1 "./linear-algebra/kernels/gesummv/gesummv.h" 1
# 19 "./linear-algebra/kernels/gesummv/gesummv.c" 2
...

{
  ...
  for (i = 0; i < n; i++) {
    fprintf (
# 55 "./linear-algebra/kernels/gesummv/gesummv.c" 3 4
            stderr
# 55 "./linear-algebra/kernels/gesummv/gesummv.c"
                  , "%0.2lf ", y[i]);
    if (i % 20 == 0) fprintf (
# 56 "./linear-algebra/kernels/gesummv/gesummv.c" 3 4
                             stderr
# 56 "./linear-algebra/kernels/gesummv/gesummv.c"
                                   , "\n");
  }
}
