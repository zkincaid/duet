#pragma merger("0","/tmp/cil-C5RcyRdU.i","")
# 1 "./linear-algebra/kernels/syrk/syrk.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "./linear-algebra/kernels/syrk/syrk.c" 2
...
# 10 "./linear-algebra/kernels/syrk/syrk.c" 2
...
# 11 "./linear-algebra/kernels/syrk/syrk.c" 2
...
# 12 "./linear-algebra/kernels/syrk/syrk.c" 2
...
# 15 "./linear-algebra/kernels/syrk/syrk.c" 2



# 1 "./linear-algebra/kernels/syrk/syrk.h" 1
# 19 "./linear-algebra/kernels/syrk/syrk.c" 2
   ...
   double C[1024 + 0][1024 + 0])
{
  ...
  for (i = 0; i < ni; i++)
    for (j = 0; j < ni; j++) {
 fprintf (
# 52 "./linear-algebra/kernels/syrk/syrk.c" 3 4
         stderr
# 52 "./linear-algebra/kernels/syrk/syrk.c"
               , "%0.2lf ", C[i][j]);
 if ((i * ni + j) % 20 == 0) fprintf (
# 53 "./linear-algebra/kernels/syrk/syrk.c" 3 4
                                     stderr
# 53 "./linear-algebra/kernels/syrk/syrk.c"
                                           , "\n");
    }
  fprintf (
# 55 "./linear-algebra/kernels/syrk/syrk.c" 3 4
          stderr
# 55 "./linear-algebra/kernels/syrk/syrk.c"
                , "\n");
}
