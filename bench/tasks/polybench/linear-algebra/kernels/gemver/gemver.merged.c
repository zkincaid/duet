#pragma merger("0","/tmp/cil-SsL821Oi.i","")
# 1 "./linear-algebra/kernels/gemver/gemver.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "./linear-algebra/kernels/gemver/gemver.c" 2
...
# 10 "./linear-algebra/kernels/gemver/gemver.c" 2
...
# 11 "./linear-algebra/kernels/gemver/gemver.c" 2
...
# 12 "./linear-algebra/kernels/gemver/gemver.c" 2
...
# 15 "./linear-algebra/kernels/gemver/gemver.c" 2



# 1 "./linear-algebra/kernels/gemver/gemver.h" 1
# 19 "./linear-algebra/kernels/gemver/gemver.c" 2
   ...
   double w[4000 + 0])
{
  ...
  for (i = 0; i < n; i++) {
    fprintf (
# 66 "./linear-algebra/kernels/gemver/gemver.c" 3 4
            stderr
# 66 "./linear-algebra/kernels/gemver/gemver.c"
                  , "%0.2lf ", w[i]);
    if (i % 20 == 0) fprintf (
# 67 "./linear-algebra/kernels/gemver/gemver.c" 3 4
                             stderr
# 67 "./linear-algebra/kernels/gemver/gemver.c"
                                   , "\n");
  }
}
