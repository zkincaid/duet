#pragma merger("0","/tmp/cil-rWraRjai.i","")
# 1 "./linear-algebra/kernels/mvt/mvt.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "./linear-algebra/kernels/mvt/mvt.c" 2
...
# 10 "./linear-algebra/kernels/mvt/mvt.c" 2
...
# 11 "./linear-algebra/kernels/mvt/mvt.c" 2
...
# 12 "./linear-algebra/kernels/mvt/mvt.c" 2
...
# 15 "./linear-algebra/kernels/mvt/mvt.c" 2



# 1 "./linear-algebra/kernels/mvt/mvt.h" 1
# 19 "./linear-algebra/kernels/mvt/mvt.c" 2
...

{
  ...
  for (i = 0; i < n; i++) {
    fprintf (
# 55 "./linear-algebra/kernels/mvt/mvt.c" 3 4
            stderr
# 55 "./linear-algebra/kernels/mvt/mvt.c"
                  , "%0.2lf ", x1[i]);
    fprintf (
# 56 "./linear-algebra/kernels/mvt/mvt.c" 3 4
            stderr
# 56 "./linear-algebra/kernels/mvt/mvt.c"
                  , "%0.2lf ", x2[i]);
    if (i % 20 == 0) fprintf (
# 57 "./linear-algebra/kernels/mvt/mvt.c" 3 4
                             stderr
# 57 "./linear-algebra/kernels/mvt/mvt.c"
                                   , "\n");
  }
}
