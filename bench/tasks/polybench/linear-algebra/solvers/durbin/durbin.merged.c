#pragma merger("0","/tmp/cil-Xxx7VaJa.i","")
# 1 "./linear-algebra/solvers/durbin/durbin.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "./linear-algebra/solvers/durbin/durbin.c" 2
...
# 10 "./linear-algebra/solvers/durbin/durbin.c" 2
...
# 11 "./linear-algebra/solvers/durbin/durbin.c" 2
...
# 12 "./linear-algebra/solvers/durbin/durbin.c" 2
...
# 15 "./linear-algebra/solvers/durbin/durbin.c" 2



# 1 "./linear-algebra/solvers/durbin/durbin.h" 1
# 19 "./linear-algebra/solvers/durbin/durbin.c" 2
...

{
  ...
  for (i = 0; i < n; i++) {
    fprintf (
# 55 "./linear-algebra/solvers/durbin/durbin.c" 3 4
            stderr
# 55 "./linear-algebra/solvers/durbin/durbin.c"
                  , "%0.2lf ", out[i]);
    if (i % 20 == 0) fprintf (
# 56 "./linear-algebra/solvers/durbin/durbin.c" 3 4
                             stderr
# 56 "./linear-algebra/solvers/durbin/durbin.c"
                                   , "\n");
  }
}
