#pragma merger("0","/tmp/cil-TOKFgFU2.i","")
# 1 "./linear-algebra/solvers/lu/lu.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "./linear-algebra/solvers/lu/lu.c" 2
...
# 10 "./linear-algebra/solvers/lu/lu.c" 2
...
# 11 "./linear-algebra/solvers/lu/lu.c" 2
...
# 12 "./linear-algebra/solvers/lu/lu.c" 2
...
# 15 "./linear-algebra/solvers/lu/lu.c" 2



# 1 "./linear-algebra/solvers/lu/lu.h" 1
# 19 "./linear-algebra/solvers/lu/lu.c" 2
...

{
  ...
  for (i = 0; i < n; i++)
    for (j = 0; j < n; j++) {
      fprintf (
# 45 "./linear-algebra/solvers/lu/lu.c" 3 4
              stderr
# 45 "./linear-algebra/solvers/lu/lu.c"
                    , "%0.2lf ", A[i][j]);
      if ((i * n + j) % 20 == 0) fprintf (
# 46 "./linear-algebra/solvers/lu/lu.c" 3 4
                                         stderr
# 46 "./linear-algebra/solvers/lu/lu.c"
                                               , "\n");
    }
  fprintf (
# 48 "./linear-algebra/solvers/lu/lu.c" 3 4
          stderr
# 48 "./linear-algebra/solvers/lu/lu.c"
                , "\n");
}
