#pragma merger("0","/tmp/cil-NIm6AbBT.i","")
# 1 "./stencils/adi/adi.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 15 "./stencils/adi/adi.c" 2



# 1 "./stencils/adi/adi.h" 1
# 19 "./stencils/adi/adi.c" 2
...

{
  ...
  for (i = 0; i < n; i++)
    for (j = 0; j < n; j++) {
      fprintf(
# 51 "./stencils/adi/adi.c" 3 4
             stderr
# 51 "./stencils/adi/adi.c"
                   , "%0.2lf ", X[i][j]);
      if ((i * 1024 + j) % 20 == 0) fprintf(
# 52 "./stencils/adi/adi.c" 3 4
                                        stderr
# 52 "./stencils/adi/adi.c"
                                              , "\n");
    }
  fprintf(
# 54 "./stencils/adi/adi.c" 3 4
         stderr
# 54 "./stencils/adi/adi.c"
               , "\n");
}
