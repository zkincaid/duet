#pragma merger("0","/tmp/cil-gFl8sdQr.i","")
# 1 "./stencils/fdtd-apml/fdtd-apml.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "./stencils/fdtd-apml/fdtd-apml.c" 2
...
# 10 "./stencils/fdtd-apml/fdtd-apml.c" 2
...
# 11 "./stencils/fdtd-apml/fdtd-apml.c" 2
...
# 12 "./stencils/fdtd-apml/fdtd-apml.c" 2
...
# 15 "./stencils/fdtd-apml/fdtd-apml.c" 2



# 1 "./stencils/fdtd-apml/fdtd-apml.h" 1
# 19 "./stencils/fdtd-apml/fdtd-apml.c" 2
   ...
   double Hz[256 +1 + 0][256 +1 + 0][256 +1 + 0])
{
  ...
  for (i = 0; i <= cz; i++)
    for (j = 0; j <= cym; j++)
      for (k = 0; k <= cxm; k++) {
 fprintf(
# 90 "./stencils/fdtd-apml/fdtd-apml.c" 3 4
        stderr
# 90 "./stencils/fdtd-apml/fdtd-apml.c"
              , "%0.2lf ", Bza[i][j][k]);
 fprintf(
# 91 "./stencils/fdtd-apml/fdtd-apml.c" 3 4
        stderr
# 91 "./stencils/fdtd-apml/fdtd-apml.c"
              , "%0.2lf ", Ex[i][j][k]);
 fprintf(
# 92 "./stencils/fdtd-apml/fdtd-apml.c" 3 4
        stderr
# 92 "./stencils/fdtd-apml/fdtd-apml.c"
              , "%0.2lf ", Ey[i][j][k]);
 fprintf(
# 93 "./stencils/fdtd-apml/fdtd-apml.c" 3 4
        stderr
# 93 "./stencils/fdtd-apml/fdtd-apml.c"
              , "%0.2lf ", Hz[i][j][k]);
 if ((i * cxm + j) % 20 == 0) fprintf(
# 94 "./stencils/fdtd-apml/fdtd-apml.c" 3 4
                                     stderr
# 94 "./stencils/fdtd-apml/fdtd-apml.c"
                                           , "\n");
      }
  fprintf(
# 96 "./stencils/fdtd-apml/fdtd-apml.c" 3 4
         stderr
# 96 "./stencils/fdtd-apml/fdtd-apml.c"
               , "\n");
}
