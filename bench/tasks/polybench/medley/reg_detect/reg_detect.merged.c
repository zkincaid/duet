#pragma merger("0","/tmp/cil-8oL3jI4S.i","")
# 1 "./medley/reg_detect/reg_detect.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "./medley/reg_detect/reg_detect.c" 2
...
# 10 "./medley/reg_detect/reg_detect.c" 2
...
# 11 "./medley/reg_detect/reg_detect.c" 2
...
# 12 "./medley/reg_detect/reg_detect.c" 2
...
# 15 "./medley/reg_detect/reg_detect.c" 2



# 1 "./medley/reg_detect/reg_detect.h" 1
# 19 "./medley/reg_detect/reg_detect.c" 2
   ...
   int path[6 + 0][6 + 0])
{
  ...
  for (i = 0; i < maxgrid; i++)
    for (j = 0; j < maxgrid; j++) {
      fprintf (
# 49 "./medley/reg_detect/reg_detect.c" 3 4
              stderr
# 49 "./medley/reg_detect/reg_detect.c"
                    , "%d ", path[i][j]);
      if ((i * maxgrid + j) % 20 == 0) fprintf (
# 50 "./medley/reg_detect/reg_detect.c" 3 4
                                               stderr
# 50 "./medley/reg_detect/reg_detect.c"
                                                     , "\n");
    }
  fprintf (
# 52 "./medley/reg_detect/reg_detect.c" 3 4
          stderr
# 52 "./medley/reg_detect/reg_detect.c"
                , "\n");
}
