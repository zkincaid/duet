       ...
       | Some implicant ->
          ...
          logf ~level:`trace
            ...
            (Polynomial.Rewrite.pp
               (PolynomialUtil.PrettyPrint.pp_numeric_dim "x"))
            initial_ideal
            (PolynomialUtil.PrettyPrint.pp_poly_list
               (PolynomialUtil.PrettyPrint.pp_numeric_dim "x"))
            geqs;
          ...
          logf
            ...
            (PolynomialConeCpClosure.pp_polylattice
               (PolynomialUtil.PrettyPrint.pp_numeric_dim "x")) lattice
            (PolynomialUtil.PrettyPrint.pp_poly_list
               (PolynomialUtil.PrettyPrint.pp_numeric_dim "x"))
            is_ints;
          ...
          (*
          logf
            "weakSolver: lattice: initially generated by @[%a@]"
          ...
          logf
            ...
            (SrkUtil.pp_print_list
               (Polynomial.QQXs.pp (PolynomialUtil.PrettyPrintDim.pp_numeric "x")))
            is_ints;
           *)

          (*
          logf
            "weakSolver: lattice: @[%a@]"
            (PolynomialConeCpClosure.pp_polylattice
