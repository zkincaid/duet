...
val to_mfa : 'a context -> 'a formula -> qfp * bool * 'a t
 ...
 * types in general *)
val mfa_to_lia : 'a context -> (qfp * 'a formula) -> Symbol.Set.t -> 
  Symbol.Set.t -> bool -> 'a t

val get_array_syms : 'a context -> 'a formula -> bool -> Symbol.Set.t *
                                                         Symbol.Set.t
