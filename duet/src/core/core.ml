...
module Show_varinfo = Show.Defaults(struct
  type a = varinfo
...
module Show_bexpr = Show.Defaults(struct
  type a = bexpr
  let format = format_bexpr
end)
module Show_expr = Show.Defaults(struct
  type a = expr
  let format = format_expr
end)
module Show_var = Show.Defaults(struct
  type a = var
  let format = Var.format
end)
module Show_ap = Show.Defaults(struct
  type a = ap
