...
external iter_functions : goto_program -> unit = "wrapper_iter_functions"
external iter_symbol : goto_program -> unit = "wrapper_iter_symbol"
external iter_instr : goto_function -> unit = "wrapper_iter_instr"
...
let iter_functions f gp =
  Callback.register "__iter_functions_handler" f;
  iter_functions gp

let iter_instr f gf =
  Callback.register "__iter_instr_handler" f;
  iter_instr gf

let iter_symbol f gf =
  Callback.register "__iter_symbol_handler" f;
  iter_symbol gf
